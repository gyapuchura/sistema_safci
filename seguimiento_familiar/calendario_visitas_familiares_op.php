...
$sql.=" AND seguimiento_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idusuario='$idusuario_op_ss' ORDER BY visita_cf.fecha_visita ";
...
?>
			...
			title: '<?php echo $row[1]." ".$row[2]." ".$row[3];?> - <?php echo $row[4];?> ',
					...
					url: 'valida_visita_calendario_op.php?idcarpeta_familiar=<?php echo $row[0];?>',
					className: '<?php
 if ($row[6]=='1') {
   echo "info";
 }
		    ...
		    <tr>
		      ...
		      <td width="618" style="color: #365DCE"><h2 class="text-info" style="text-align: center">CALENDARIO VISITAS FAMILIARES - SAFCI</h2>
                ...
                <?php
                    ...
                    $sqlus.=" WHERE usuarios.idnombre=nombre.idnombre AND usuarios.idusuario='$idusuario_op_ss' ";
