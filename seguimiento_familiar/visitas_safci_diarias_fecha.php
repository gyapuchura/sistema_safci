...
<html>
	<head>
		...
		<title>MEDI-SAFCI VISITAS FAMILIARES POR FECHAS</title>
...
$(function () {
 ...
 <?php
$numero = 0;
$sql = " SELECT fecha_visita FROM visita_cf WHERE fecha_visita BETWEEN '$inicio' AND '$finalizacion' GROUP BY fecha_visita ORDER BY fecha_visita ";
...
<h4 style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">INFORME DE VISITAS POR RIESGO PERSONAL DEL <?php echo $f_inicio;?> AL <?php echo $f_finalizacion;?></h4>
<table width="900" border="0" align="center">
  ...
  ?>
    ...
    $sql_cf.=" AND carpeta_familiar.estado='CONSOLIDADO' AND seguimiento_cf.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY seguimiento_cf.idcarpeta_familiar ";
    $result_cf = mysqli_query($link,$sql_cf);
    ...
    <tr>
      <td width="600"><span style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">N° DE INTEGRANTES CON SEGUIMIENTO PLANIFICADO =
          <?php 
    $sql_seg =" SELECT count(idseguimiento_cf) FROM seguimiento_cf WHERE fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
    ...
    echo $seguimientos_int;?>
      ...
      <td width="446">
        <span style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">N° MUNICIPIOS =
          <?php 
            $sql_mun =" SELECT carpeta_familiar.idmunicipio FROM seguimiento_cf, carpeta_familiar WHERE seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND seguimiento_cf.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY carpeta_familiar.idmunicipio ";
    ...
    <tr>
      <td><span style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">N° TOTAL DE VISITAS PLANIFICADAS =
          <?php 
    $sql_pr =" SELECT count(idvisita_cf) FROM visita_cf WHERE fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
    ...
    echo $programadas?>
      ...
      <td>
          ...
          <?php 
            $sql_es =" SELECT carpeta_familiar.idestablecimiento_salud FROM seguimiento_cf, carpeta_familiar WHERE seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND seguimiento_cf.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY carpeta_familiar.idestablecimiento_salud ";
    ...
    <tr>
      <td><span style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">N° TOTAL DE VISITAS REALIZADAS =
          <?php 
    $sql_re =" SELECT count(idvisita_cf) FROM visita_cf WHERE idestado_visita_cf='3' AND fecha_visita BETWEEN '$inicio' AND '$finalizacion' ";
    ...
    echo $realizadas;?>
      ...
      <td>
          ...
          <?php 
            $sql_med =" SELECT carpeta_familiar.idusuario FROM seguimiento_cf, carpeta_familiar WHERE seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND seguimiento_cf.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY carpeta_familiar.idusuario ";
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" WHERE visita_cf.idestado_visita_cf=estado_visita_cf.idestado_visita_cf AND fecha_visita BETWEEN '$inicio' AND '$finalizacion' ORDER BY visita_cf.idvisita_cf DESC LIMIT 500 ";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
