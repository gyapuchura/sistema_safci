...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <a href="comportamiento_familiar.php"><h6 class="text-info"><- VOLVER</h6></a>
                    <hr>             
                    <h4 class="text-info">SEGUIMIENTO FAMILIAR:</h4>
                    <h4 class="text-primary">FAMILIA : <?php echo $row_cf[8];?></h4>
                    <h4 class="text-info"><?php echo $row_cf[1]; ?></h4>
                    <hr> 
                    </div>
...
<form name="MODIFICA_CARPETA" action="guarda_datos_cf_mod.php" method="post"> 
                       
            <hr>
            <div class="text-center">                                     
                <h4 class="text-primary">ACTUALIZAR DATOS DE LA CARPETA FAMILIAR:</h4>                    
            </div>
            <hr> 
            <div class="form-group row">
                    <div class="col-sm-3">
                    <h6 class="text-primary">ACTUALIZAR ÁREA DE INFLUENCIA:</h6>
                    </div>
                    <div class="col-sm-9">
