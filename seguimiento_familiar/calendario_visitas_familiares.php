...
$sql.=" visita_cf.fecha_visita, visita_cf.idestado_visita_cf FROM nombre, seguimiento_cf, integrante_cf, visita_cf  ";
...
?>
			...
			title: '<?php echo $row[1]." ".$row[2]." ".$row[3];?> - <?php echo $row[4];?> ',
					...
					url: 'valida_visita_calendario.php?idcarpeta_familiar=<?php echo $row[0];?>',
					className: '<?php
 if ($row[6]=='1') {
   echo "info";
 }
