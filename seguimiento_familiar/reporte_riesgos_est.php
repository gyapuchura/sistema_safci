...
$sql_d = " SELECT idestablecimiento_salud, establecimiento_salud FROM establecimiento_salud WHERE idestablecimiento_salud ='$idestablecimiento_salud'";
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VISITAS FAMILIARES POR RIÉSGO PERSONAL - ESTABLECIMIENTO DE SALUD : <?php echo $row_d[1];?>'
        },
        subtitle: {
...
$sql_a.=" AND seguimiento_cf.idriesgo_personal_vf='$row3[0]' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
