...
$sql_d = " SELECT iddepartamento, departamento FROM departamento ORDER BY iddepartamento ";
...
<html>
	<head>
		...
		<title>RIESGO PERSONAL - DEPARTAMENTO</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VISITAS FAMILIARES POR RIÉSGO PERSONAL - DEPARTAMENTO DE <?php echo $row_d[1];?>'
        },
        subtitle: {
...
$sql_a.=" AND seguimiento_cf.idriesgo_personal_vf='$row3[0]' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
    ...
    <tr>
        ...
        <td width="110" style="color: #2D56CF; font-family: Arial; font-size: 12px; text-align: center;">N° VISITAS NO REALIZADAS (TOTAL)</td>
            ...
            while ($field = mysqli_fetch_field($result)){
                ...
                $sql_int.=" AND carpeta_familiar.iddepartamento='$iddepartamento' AND seguimiento_cf.idriesgo_personal_vf='$row[0]' GROUP BY seguimiento_cf.idintegrante_cf ";
                ...
                $sql_vf.=" AND carpeta_familiar.iddepartamento='$iddepartamento' AND seguimiento_cf.idriesgo_personal_vf='$row[0]'  ";
                ...
                $sql_vfr.=" AND carpeta_familiar.iddepartamento='$iddepartamento' AND seguimiento_cf.idriesgo_personal_vf='$row[0]' AND visita_cf.idestado_visita_cf='3' ";
		    ...
		    <tr>
              ...
              <td style="font-size: 12px; font-family: Arial; text-align: center;">
              <a href="visitas_safci_rp_r.php?idriesgo_personal_vf=<?php echo $row[0];?>&iddepartamento=<?php echo $iddepartamento;?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1200,height=1000,scrollbars=YES'); return false;">
