...
$sql_est =" SELECT idmunicipio, municipio FROM municipios ";
$sql_est.=" WHERE idmunicipio='$idmunicipio' ";
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VISITAS PLANIFICADAS - <?php echo mb_strtoupper($row_rp[1]);?> - <?php echo "MUNICIPIO : ".$row_est[1];?> '
        },
        legend: {
            layout: 'vertical',
            align: 'left',
