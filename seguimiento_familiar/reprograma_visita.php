        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-info">REPROGRAMAR VISITA FAMILIAR</h3>
                </div>
                <div class="row">
                  </br>
                </div>

          <form name="REPROGRAMA" action="guarda_reprogramacion_vf.php" method="post">

                 <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-info">DATOS DE LA VISITA FAMILIAR POR RIÉSGO PERSONAL</h6>
                    </div>
                    
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-sm-4">
                        <h6 class="text-info">NOMBRE DE INTEGRANTE DE LA FAMILIA : </h6>
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                        <h6 class="text-info">NÚMERO DE VISITA : </h6>
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                        <h6 class="text-info">FECHA DE VISITA A REPROGRAMNAR:</h6>
                        </div>
                        <div class="col-sm-8">
                      <input type="date" class="form-control" name="fecha_visita" value="<?php echo $row[5];?>">
                        </div>
                    </div>
                                        <div class="form-group row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-8">                     
                            ...
                            GUARDAR LA REPROGRAMACIÓN DE VISITA
                            </button> 
                            </form>  
                        </div>
