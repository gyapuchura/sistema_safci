...
?>
    <div class="table-responsive">
        ...
        $sql.=" AND carpeta_familiar.idmunicipio=municipios.idmunicipio AND carpeta_familiar.idusuario='$idusuario_op' AND carpeta_familiar.idestablecimiento_salud=establecimiento_salud.idestablecimiento_salud ";
        ...
        <div class="form-group row"> 
            <div class="col-sm-6">
                <a class="btn btn-info btn-icon-split" href="valida_visitas_operativo.php?idusuario_op=<?php echo $idusuario_op;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1400,height=900,scrollbars=YES,top=50,left=200'); return false;">
                <span class="icon text-white-50">
                    <i class="fas fa-book"></i>
                </span>
                <span class="text">CALENDARIO DE VISITAS FAMILIARES MÉDICO OPERATIVO</span></a>
            </div>
            <div class="col-sm-6">
                   <a href="visitas_safci_diarias_op.php?idusuario_op=<?php echo $idusuario_op;?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1200,height=1000,scrollbars=YES'); return false;">
