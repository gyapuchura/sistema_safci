...
<head>
    ...
    <title>PRESENCIA PROGRAMA SAFCI - MUNICIPIO</title>
...
<body>
<h3 class="text-center">VISITAS FAMILIARES MUNICIPIO DE <?php echo $row1[3];?></h3>
...
$sql2.= " AND carpeta_familiar.idmunicipio='$idmunicipio' GROUP BY carpeta_familiar.idestablecimiento_salud ORDER BY carpeta_familiar.idestablecimiento_salud  ";
