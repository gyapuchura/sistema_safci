...
<head>
    ...
    <title>PRESENCIA PROGRAMA SAFCI - DEPARTAMENTAL</title>
...
<body>
<h3 class="text-center">VISITAS FAMILIARES DEPARTAMENTO DE <?php echo $row1[3];?></h3>
...
$sql2.= " AND carpeta_familiar.iddepartamento='$iddepartamento' GROUP BY carpeta_familiar.idestablecimiento_salud ORDER BY carpeta_familiar.idestablecimiento_salud  ";
