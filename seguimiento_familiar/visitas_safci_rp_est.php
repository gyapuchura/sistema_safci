...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VISITAS PLANIFICADAS - <?php echo mb_strtoupper($row_rp[1]);?> - <?php echo "ESTABLECIMIENTO : ".$row_est[1];?> '
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
<h4 style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">VISITAS PLANIFICADAS - <?php echo mb_strtoupper($row_rp[1]);?> AL <?php echo $f_emision;?></h4>
