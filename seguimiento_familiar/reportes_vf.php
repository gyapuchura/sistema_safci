            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                        <a class="btn btn-info btn-icon-split" href="visitas_safci_diarias.php" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1200,height=1000,scrollbars=YES,top=50,left=200'); return false;">
                        <span class="icon text-white-50">
                            <i class="fas fa-book"></i>
                        </span>
