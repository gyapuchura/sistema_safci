        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">SEGUIMIENTO AL COMPORTAMIENTO FAMILIAR </h1>
                    <p class="mb-4">En esta sección se puede realizar el seguimiento al Comportamiento Familiar de sus Áreas de Influencia.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">SEGUIMIENTO AL COMPORTAMIENTO FAMILIAR - SAFCI</h6>
                        </div>
                        <div class="card-body">
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><a href="../carpetas_familiares/imprime_carpeta_familiar.php?idcarpeta_familiar=<?php echo $row[0];?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1280,height=800,top=50, left=200, scrollbars=YES'); return false;">
                                        ...
                                        <td>
                                                   ...
                                                   <form name="FORM_P" action="valida_seguimiento_familiar.php" method="post">
                                                   <input name="idcarpeta_familiar" type="hidden" value="<?php echo $row[0];?>">
                                                   <button type="submit" class="btn btn-primary btn-user btn-block">SEGUIMIENTO</br> FAMILIAR</button></form>
