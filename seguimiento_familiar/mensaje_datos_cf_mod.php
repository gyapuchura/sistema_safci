...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>                     
                    <h4 class="text-success">LOS DATOS DE LA CARPETA FAMILIAR </h4>
                    ...
                    <h4 class="text-success">HAN SIDO ACTUALIZADOS !!!</h4>
                    </br>
                    <a href="mostrar_cf_datos.php"><h6>IR AL SEGUIMIENTO DE LA CARPETA FAMILIAR -></h6></a>
                    </div>
