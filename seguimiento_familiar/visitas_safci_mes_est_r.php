...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VISITAS REALIZADAS EN EL MES - <?php echo "ESTABLECIMIENTO : ".$row_est[1];?> '
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
<h4 style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">INFORME MENSUAL DE VISITAS REALIZADAS POR RIESGO PERSONAL AL <?php echo $f_emision;?></h4>
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" AND visita_cf.idestado_visita_cf=estado_visita_cf.idestado_visita_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND visita_cf.idestado_visita_cf='3' ORDER BY visita_cf.idvisita_cf DESC ";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
