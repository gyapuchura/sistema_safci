...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>             
                    <h4 class="text-success">EL REGISTRO DE PLANIFICACIÓN FUE GUARDADO CORRECTAMENTE !!!</h4>
                    <h4 class="text-success">CARPETA FAMILIAR : <?php echo $row_cf[1]; ?></h4>
                    <h4 class="text-success">FAMILIA : <?php echo $row_cf[2];?></h4>
                    <hr> 
                    </div>
...
<div class="form-group row">  
<div class="col-sm-4"><a href="planificador_visitas.php"><h6 class="text-info"><- VOLVER</h6></a></div> 
