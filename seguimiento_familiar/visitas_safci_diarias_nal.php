...
<html>
	<head>
		...
		<title>MEDI-SAFCI VISITAS FAMILIARES - NACIONAL</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VISITAS POR RIÉSGO PERSONAL - NIVEL NACIONAL '
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
$sql.= " GROUP BY visita_cf.fecha_visita ORDER BY visita_cf.fecha_visita ";
...
$sql7.= " AND visita_cf.idestado_visita_cf='1' ";
...
$sql7 = " SELECT visita_cf.idvisita_cf, visita_cf.fecha_visita FROM visita_cf, seguimiento_cf, carpeta_familiar WHERE visita_cf.idseguimiento_cf=seguimiento_cf.idseguimiento_cf ";
$sql7.= " AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.fecha_visita='$row[0]' ";
$sql7.= " AND visita_cf.idestado_visita_cf='2' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_num_rows($result7);
...
$sql7 = " SELECT visita_cf.idvisita_cf, visita_cf.fecha_visita FROM visita_cf, seguimiento_cf, carpeta_familiar WHERE visita_cf.idseguimiento_cf=seguimiento_cf.idseguimiento_cf ";
$sql7.= " AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.fecha_visita='$row[0]' ";
$sql7.= " AND visita_cf.idestado_visita_cf='3' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_num_rows($result7);
...
<table width="900" border="0" align="center">
  ...
  ?>
    ...
    $sql_seg.=" AND carpeta_familiar.estado='CONSOLIDADO' ";
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    <tr>
        ...
        <td width="101" style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">VISITAS POR DEPARTAMENTO</td>
    </tr>
    <?php
    $numero=1; 
    ...
    while ($field = mysqli_fetch_field($result)){
        ...
        $sql_mun.=" AND carpeta_familiar.iddepartamento='$row[0]' GROUP BY seguimiento_cf.idcarpeta_familiar ";
