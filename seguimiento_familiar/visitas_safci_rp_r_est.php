...
$idriesgo_personal_vf = $_GET['idriesgo_personal_vf'];

$sql_dep =" SELECT idestablecimiento_salud, establecimiento_salud FROM establecimiento_salud ";
$sql_dep.=" WHERE idestablecimiento_salud='$idestablecimiento_salud' ";
$result_dep = mysqli_query($link,$sql_dep);
$row_dep = mysqli_fetch_array($result_dep);

$sql_rp =" SELECT idriesgo_personal_vf, riesgo_personal_vf FROM riesgo_personal_vf ";
$sql_rp.=" WHERE idriesgo_personal_vf='$idriesgo_personal_vf' ";
$result_rp = mysqli_query($link,$sql_rp);
$row_rp = mysqli_fetch_array($result_rp);
...
<html>
	<head>
		...
		<title>MEDI-SAFCI VISITAS FAMILIARES - RIESGO PERSONAL</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VISITAS PLANIFICADAS - <?php echo mb_strtoupper($row_rp[1]);?> - <?php echo "ESTABLECIMIENTO DE SALUD : ".$row_dep[1];?> '
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
$sql.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' GROUP BY visita_cf.fecha_visita ORDER BY visita_cf.fecha_visita ";
...
$sql7.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.idestado_visita_cf='1' ";
...
$sql7 = " SELECT visita_cf.idvisita_cf, visita_cf.fecha_visita FROM visita_cf, seguimiento_cf, carpeta_familiar WHERE visita_cf.idseguimiento_cf=seguimiento_cf.idseguimiento_cf ";
$sql7.= " AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.fecha_visita='$row[0]' ";
$sql7.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.idestado_visita_cf='2' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_num_rows($result7);
...
$sql7 = " SELECT visita_cf.idvisita_cf, visita_cf.fecha_visita FROM visita_cf, seguimiento_cf, carpeta_familiar WHERE visita_cf.idseguimiento_cf=seguimiento_cf.idseguimiento_cf ";
$sql7.= " AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.fecha_visita='$row[0]' ";
$sql7.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.idestado_visita_cf='3' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_num_rows($result7);
...
<h4 style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;"><?php echo mb_strtoupper($row_rp[1]);?> AL <?php echo $f_emision;?></h4>
<table width="900" border="0" align="center">
  <tbody>
    ...
    $sql_cf.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' GROUP BY seguimiento_cf.idcarpeta_familiar ";
    ...
    $sql_seg.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' ";
    ...
    $sql_pr.=" AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.fecha_visita  ";
    ...
    $sql_re.=" AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.idestado_visita_cf='3' AND visita_cf.fecha_visita ";
...
<table width="1000" border="1" align="center" cellspacing="0">
		  <tbody>
		    <tr>
              ...
              <td width="200" style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">FECHA DE LA VISITA:</td>
    ...
    $sql.=" WHERE visita_cf.idseguimiento_cf=seguimiento_cf.idseguimiento_cf AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.idestado_visita_cf='3' ";
    $sql.=" AND visita_cf.idestado_visita_cf=estado_visita_cf.idestado_visita_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' ORDER BY visita_cf.idvisita_cf DESC LIMIT 1000";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
