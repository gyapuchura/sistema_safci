...
<head>
    ...
    <title>VISITAS PLANIFICADAS SAFCI - NIVEL NACIONAL</title>
...
<script>
        ...
        let Visita = L.icon({
        iconUrl: "../sala_situacional/marcadores/familia_azul.png",
        iconSize: [25, 25],
        iconAnchor: [15, 40],
