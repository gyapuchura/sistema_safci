...
$sql.=" AND seguimiento_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND visita_cf.idusuario='$idusuario_ss' ORDER BY visita_cf.fecha_visita ";
...
?>
			...
			title: '<?php echo $row[1]." ".$row[2]." ".$row[3];?> - <?php echo $row[4];?> ',
					...
					url: 'valida_visita_calendario_rpr.php?idcarpeta_familiar=<?php echo $row[0];?>&idvisita_cf=<?php echo $row[7];?>',
					className: '<?php
 if ($row[6]=='1') {
   echo "info";
 }
		...
		<table width="900" border="0" align="center" cellspacing="0">
		  <tbody>
		    <tr>
		      ...
		      <td width="618" style="color: #2C9FAF"><h2 class="text-info" style="text-align: center">REPROGRAMACIÓN DE VISITAS</h2>
                ...
                <?php
                    ...
                    $sqlus.=" WHERE usuarios.idnombre=nombre.idnombre AND usuarios.idusuario='$idusuario_ss' ";
                    $resultus = mysqli_query($link,$sqlus);
                    $rowus = mysqli_fetch_array($resultus);?>
                </span>
              <h2 style="text-align: center"><?php echo "MÉDICO : ".$rowus[0];?> <?php echo $rowus[1];?> <?php echo $rowus[2];?></H2></td>
		      <td width="124">&nbsp;</td>
	        </tr>
	      </tbody>
</table>
