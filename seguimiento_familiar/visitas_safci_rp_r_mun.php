...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VISITAS PLANIFICADAS - <?php echo mb_strtoupper($row_rp[1]);?> - <?php echo "MUNICIPIO : ".$row_mun[1];?> '
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
$sql.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' GROUP BY visita_cf.fecha_visita ORDER BY visita_cf.fecha_visita ";
...
$sql7.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.idestado_visita_cf='1' ";
...
$sql7 = " SELECT visita_cf.idvisita_cf, visita_cf.fecha_visita FROM visita_cf, seguimiento_cf, carpeta_familiar WHERE visita_cf.idseguimiento_cf=seguimiento_cf.idseguimiento_cf ";
$sql7.= " AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.fecha_visita='$row[0]' ";
$sql7.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.idestado_visita_cf='2' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_num_rows($result7);
...
$sql7 = " SELECT visita_cf.idvisita_cf, visita_cf.fecha_visita FROM visita_cf, seguimiento_cf, carpeta_familiar WHERE visita_cf.idseguimiento_cf=seguimiento_cf.idseguimiento_cf ";
$sql7.= " AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.fecha_visita='$row[0]' ";
$sql7.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.idestado_visita_cf='3' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_num_rows($result7);
...
<table width="900" border="0" align="center">
  <tbody>
    ...
    $sql_cf.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' GROUP BY seguimiento_cf.idcarpeta_familiar ";
    ...
    $sql_seg.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' ";
    ...
    $sql_pr.=" AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.fecha_visita  ";
    ...
    $sql_re.=" AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' AND visita_cf.idestado_visita_cf='3' AND visita_cf.fecha_visita ";
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" AND visita_cf.idestado_visita_cf=estado_visita_cf.idestado_visita_cf AND carpeta_familiar.idmunicipio='$idmunicipio' AND seguimiento_cf.idriesgo_personal_vf='$idriesgo_personal_vf' ORDER BY visita_cf.idvisita_cf DESC LIMIT 1000";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
