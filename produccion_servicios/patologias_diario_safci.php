...
$(function () {
 ...
 <?php
$numero = 0;
$sql = "  SELECT atencion_psafci.fecha_registro FROM atencion_psafci, diagnostico_psafci, usuarios, personal, dato_laboral ";
$sql.= "  WHERE diagnostico_psafci.idatencion_psafci=atencion_psafci.idatencion_psafci AND diagnostico_psafci.idusuario=usuarios.idusuario  ";
$sql.= "  AND personal.idusuario=usuarios.idusuario AND personal.iddato_laboral=dato_laboral.iddato_laboral  AND dato_laboral.idcargo_organigrama != '54' ";
$sql.= "  AND diagnostico_psafci.idpatologia='$idpatologia' GROUP BY atencion_psafci.fecha_registro ORDER BY atencion_psafci.fecha_registro  ";
...
<?php
$sql7 = " SELECT diagnostico_psafci.iddiagnostico_psafci  FROM diagnostico_psafci, atencion_psafci, usuarios, personal, dato_laboral ";
...
$sql7.= " AND diagnostico_psafci.idusuario=usuarios.idusuario AND dato_laboral.idusuario=usuarios.idusuario  ";
$sql7.= " AND personal.idusuario=usuarios.idusuario AND personal.iddato_laboral=dato_laboral.iddato_laboral ";
$sql7.= " AND dato_laboral.idcargo_organigrama !='54' AND diagnostico_psafci.idpatologia='$idpatologia' AND atencion_psafci.idtipo_consulta = '1' ";
...
$sql7.= " AND diagnostico_psafci.idusuario=usuarios.idusuario AND dato_laboral.idusuario=usuarios.idusuario  ";
$sql7.= " AND personal.idusuario=usuarios.idusuario AND personal.iddato_laboral=dato_laboral.iddato_laboral ";
$sql7.= " AND dato_laboral.idcargo_organigrama != '54' AND diagnostico_psafci.idpatologia='$idpatologia' AND atencion_psafci.idtipo_consulta = '2' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_num_rows($result7);
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.="  FROM atencion_psafci, nombre, tipo_consulta, tipo_atencion, departamento, municipios, establecimiento_salud, diagnostico_psafci, usuarios, personal, dato_laboral  ";
    ...
    $sql.="  AND atencion_psafci.idtipo_atencion=tipo_atencion.idtipo_atencion AND diagnostico_psafci.idusuario=usuarios.idusuario ";
    $sql.="  AND personal.idusuario=usuarios.idusuario AND personal.iddato_laboral=dato_laboral.iddato_laboral AND dato_laboral.idcargo_organigrama != '54' ";
    $sql.=" AND diagnostico_psafci.idpatologia='$idpatologia' ORDER BY atencion_psafci.idatencion_psafci DESC ";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
