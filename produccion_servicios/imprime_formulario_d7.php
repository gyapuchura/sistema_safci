  ...
  <tbody>
    <tr>
      <td colspan="3"><table width="902" border="1" cellspacing="0">
        <tbody>
          <tr>
            <td colspan="12" style="text-align: center; font-family: Arial;"><strong style="font-family: Arial; font-size: 14px;">FORMULARIO D7 REFERERENCIA</strong></td>
            </tr>
          <tr>
          ...
          <tr>
            <td style="font-size: 12px; font-family: Arial;">F.C.:</td>
            <td width="55" style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">F.R.:</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">P.A.:</td>
            <td style="font-size: 12px; font-family: Arial;">  ... /...mmHg</td>
            <td style="font-size: 12px; font-family: Arial;">T°:</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">PESO:</td>
            <td width="51" style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td width="55" style="font-size: 12px; font-family: Arial;">TALLA:</td>
            <td width="54" style="font-size: 12px; font-family: Arial;">  .....cm</td>
          </tr>
          <tr>
            <td style="font-size: 12px; font-family: Arial;">GLASCOW:</td>
            <td colspan="3" style="font-size: 12px; font-family: Arial;">  ........./15</td>
            <td style="font-size: 12px; font-family: Arial;">SPO2:</td>
            <td style="font-size: 12px; font-family: Arial;">.... %</td>
            <td style="font-size: 12px; font-family: Arial;">IMC:</td>
          ...
          <tr>
            <td colspan="2" style="font-size: 12px; font-family: Arial;">ESTUVO INTERNADO:</td>
            <td style="font-size: 12px; font-family: Arial;">SI</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">NO</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td colspan="3" style="font-size: 12px; font-family: Arial;">DIAS DE INTERNACIÓN:</td>
            <td colspan="3" style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            </tr>
          <tr>
            <td colspan="12" style="font-size: 12px; font-family: Arial;"><p>(Descripcion Cualitativa)</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p></td>
            </tr>
          <tr>
            ...
            <td bgcolor="#466CAD" style="text-align: center; font-size: 12px; font-family: Arial; color: #FFFFFF;"><strong>SI</strong></td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td bgcolor="#466CAD" style="font-family: Arial; font-size: 12px; text-align: center; color: #FFFFFF;">NO</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
          </tr>
          <tr>
            <td style="font-size: 12px; font-family: Arial;">HALLAZGOS LLAMATIVOS</td>
            <td style="font-size: 12px; font-family: Arial;">RX:</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">LABORATORIO:</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">ECOGRAFIA:</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">TOMOGRAFÍA:</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">OTROS ESPECIFIQUE:</td>
            <td colspan="2">&nbsp;</td>
            </tr>
          <tr>
          ...
          <tr>
            <td style="font-size: 12px; font-family: Arial;">a)</td>
            <td colspan="5" style="font-size: 12px; font-family: Arial;">&nbsp;</td>
          ...
          <tr>
            <td style="font-size: 12px; font-family: Arial;">b)</td>
            <td colspan="5" style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">CIE-10</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
          ...
          <tr>
            <td style="font-size: 12px; font-family: Arial;">c)</td>
            <td colspan="5" style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">CIE-10</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            <td style="font-size: 12px; font-family: Arial;">&nbsp;</td>
          ...
          <tr>
            <td colspan="12" style="font-size: 12px; font-family: Arial;">&nbsp;</td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="font-size: 12px; font-family: Arial;">Público</td>
            <td style="font-size: 12px; font-family: Arial;">Seguridad Social</td>
            <td style="font-size: 12px; font-family: Arial;">Privado</td>
            <td style="font-size: 12px; font-family: Arial;">Otro</td>
          </tr>
          <tr>
