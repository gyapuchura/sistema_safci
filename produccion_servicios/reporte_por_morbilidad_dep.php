...
$sql.= " AND patologia.cie NOT LIKE '%Z%' AND atencion_psafci.iddepartamento = '$iddepartamento' GROUP BY diagnostico_psafci.idpatologia  ";
...
$sql3.= " AND patologia.cie NOT LIKE '%Z%' AND atencion_psafci.iddepartamento = '$iddepartamento' GROUP BY diagnostico_psafci.idpatologia  ";
...
<h4 align="center" style="font-family: Arial;">TOTAL DE DIAGNÓSTICOS POR MORBILIDAD DEPARTAMENTO = 
                ...
                $sql_dgto.= " AND patologia.cie NOT LIKE '%Z%' AND atencion_psafci.iddepartamento='$iddepartamento' ";
