...
<html>
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'REPORTE DIAGNÓSTICOS POR MORBILIDAD PSAFCI - <?php echo $row_dep[1];?>'
        },
        subtitle: {
...
$sql.= " AND patologia.cie NOT LIKE '%Z%' AND atencion_psafci.iddepartamento = '$iddepartamento' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY diagnostico_psafci.idpatologia  ";
...
$sql3.= " AND patologia.cie NOT LIKE '%Z%' AND atencion_psafci.iddepartamento = '$iddepartamento' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY diagnostico_psafci.idpatologia  ";
...
<h4 align="center" style="font-family: Arial;">TOTAL DE DIAGNÓSTICOS POR MORBILIDAD DEPARTAMENTO = 
                <?php
