...
<!-- BEGIN aqui va el comntenido de la pagina ---->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                    <a href="../referencia_safci/referencias_diarias_fechas.php?inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1200,height=1000, right=400, scrollbars=YES'); return false;">
                    <h6 class="text-info"><i class="far fa-chart-bar"></i>MOSTRAR REPORTE</h6></a>
                    </div>
                </div> 
