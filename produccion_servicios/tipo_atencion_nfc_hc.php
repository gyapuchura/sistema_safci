...
<!---------------------------------------------> 
   ...
   <form name="ATENCIONMORB" id="form-morbilidad-ncf" action="guarda_atencion_pmorbilidad_historia.php" method="post" class="needs-validation" novalidate>
   
   <input type="hidden" name="idnombre_integrante" value="<?php echo $idnombre_paciente_ss;?>">
   <input type="hidden" name="idestablecimiento_salud" value="<?php echo $idestablecimiento_salud_ss;?>">
   <input type="hidden" name="edad" value="<?php echo $edad_ss;?>">
   <input type="hidden" name="idnacion" value="<?php echo $idnacion_ss;?>">
...
<form name="ATENCIONSANO" id="form-preventiva-ncf" action="guarda_atencion_psano_historia.php" method="post" class="needs-validation" novalidate>  
...
<form name="TELECONSULTA" id="form-teleconsulta-ncf" action="guarda_teleconsulta_historia.php" method="post" class="needs-validation" novalidate>  
...
<form name="TELEMETRIA" id="form-telemetria-ncf" action="guarda_telemetria_historia.php" method="post" class="needs-validation" novalidate>  
   ...
   <input type="hidden" name="idtipo_atencion" value="<?php echo $idtipo_atencion;?>">   
    ...
    <div class="form-group row">  
        <div class="col-sm-4">
        <h6 class="text-info">TIPO DE TELEMETRÍA:</h6>
        <?php
        $sql_i =" SELECT idrepeticion, repeticion FROM repeticion ";
        $result_i = mysqli_query($link,$sql_i);
        if ($row_i = mysqli_fetch_array($result_i)){
