...
<head>
    ...
    <title>PRODUCCION PERSONAL MUNICIPIO</title>
</head>
<body>
...
</br>MUNICIPIO : <?php echo $row_mun[1];?></br></br>
    ...
    <tr>
      <td colspan="3"><table width="900" border="1" cellspacing="0">
        ...
        <?php
            ...
            $sql.= " AND establecimiento_salud.idmunicipio='$idmunicipio' AND usuarios.condicion='ACTIVO' AND dato_laboral.idestablecimiento_salud !='4196' ORDER BY establecimiento_salud.establecimiento_salud  ";
        ...
        ?>
          <tr>
            ...
            <a href="produccion_operativo_prev_fechas.php?idusuario=<?php echo $row[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1200,height=920,scrollbars=YES,top=50,left=200'); return false;"><?php echo $row_c[1];?></a>
