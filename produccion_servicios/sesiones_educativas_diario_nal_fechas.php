...
$(function () {
 ...
 <?php
$numero = 0;
$sql = " SELECT fecha_sesion FROM sesion_educativa WHERE idcharla_psafci='$idcharla_psafci' AND fecha_sesion BETWEEN '$inicio' AND '$finalizacion' GROUP BY fecha_sesion ORDER BY fecha_sesion ";
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" AND sesion_educativa.idcharla_psafci='$idcharla_psafci' AND sesion_educativa.fecha_sesion BETWEEN '$inicio' AND '$finalizacion' ORDER BY sesion_educativa.idsesion_educativa DESC  ";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
