    ...
    <tr>
      <td colspan="3"><table width="900" border="1" cellspacing="0">
        ...
        <?php
            ...
            $sql.= "  AND dato_laboral.iddepartamento=departamento.iddepartamento AND dato_laboral.idestablecimiento_salud !='4196' AND usuarios.condicion='ACTIVO' GROUP BY personal.idusuario ORDER BY municipios.municipio   ";
