...
$sql.= " AND diagnostico_psafci.idpatologia='$idpatologia' AND atencion_psafci.idmunicipio='$idmunicipio' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY atencion_psafci.fecha_registro ORDER BY atencion_psafci.fecha_registro ";
...
$sql7.= " AND diagnostico_psafci.idpatologia='$idpatologia' AND atencion_psafci.idmunicipio='$idmunicipio' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' AND atencion_psafci.idtipo_consulta = '1' ";
...
$sql7 = " SELECT diagnostico_psafci.iddiagnostico_psafci  FROM diagnostico_psafci, atencion_psafci ";
$sql7.= " WHERE diagnostico_psafci.idatencion_psafci=atencion_psafci.idatencion_psafci AND diagnostico_psafci.fecha_registro='$row[0]'  ";
$sql7.= " AND diagnostico_psafci.idpatologia='$idpatologia' AND atencion_psafci.idmunicipio='$idmunicipio' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' AND atencion_psafci.idtipo_consulta = '2' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_num_rows($result7);
