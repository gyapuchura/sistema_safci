        ...
        <div class="form-group row"> 
           ...
           <div class="form-group row"> 
            ...
            <div class="form-group row"> 
                ...
                <div class="col-sm-3">
                    <h6 class="text-info">TELÉFONO CELULAR DEL PACIENTE/FAMILIAR:</h6>
   ...
   <div class="form-group row"> 
    ...
    ?>
            ...
            <div class="form-group row">                           
                ...
                $sql1.=" WHERE examen_teleconsulta.idexamen_complementario=examen_complementario.idexamen_complementario AND examen_teleconsulta.idatencion_psafci='$idatencion_psafci_ss' ";
                $result1 = mysqli_query($link,$sql1);
                if ($row1 = mysqli_fetch_array($result1)){
                mysqli_field_seek($result1,0);
                while ($field1 = mysqli_fetch_field($result1)){
                ...
                ?>
                    ...
                    <input type="checkbox" name="idexamen_complementario[<?php echo $numero1;?>]" value="<?php echo $row1[0];?>" checked disabled> <?php echo $row1[1];?>  
                    </h6>
                    </div> 
                <?php
                $numero1=$numero1+1;
...
<!---------------------------------------------------------------->
<!------------- EXAMEN CLINICO PREVENTIVO - BEGIN ---------------->
<!---------------------------------------------------------------->
            ...
            <hr> 
            <?php               
            $sql_p =" SELECT idevaluacion_preventiva, idatencion_psafci, idsigno_vital_psafci, idnombre, indice_abdomen_talla, indice_cintura_cadera, indice_tobillo_brazo,  ";
            $sql_p.=" idclasificacion_imc, idriesgo_cintura_cadera, idinterpretacion_tobillo_brazo, idclasificacion_presion_arterial, idriesgo_cintura, fecha_registro, hora_registro, idusuario ";
            $sql_p.=" FROM evaluacion_preventiva WHERE idatencion_psafci='$idatencion_psafci_ss' ";
            $result_p = mysqli_query($link,$sql_p);
            $row_p = mysqli_fetch_array($result_p); 
            ?>

            <?php
                $sql_sv =" SELECT idsigno_vital_psafci, idatencion_psafci, peso, talla, perimetro_abdominal, circunferencia_cadera, presion_arterial, presion_arterial_d,  ";
                $sql_sv.=" presion_arterial_tobillo, presion_arterial_tobillo_d FROM signo_vital_psafci WHERE idatencion_psafci='$idatencion_psafci_ss' ";
                $result_sv = mysqli_query($link,$sql_sv);
                if ($row_sv = mysqli_fetch_array($result_sv)){
                mysqli_field_seek($result_sv,0);           
                while ($field_sv = mysqli_fetch_field($result_sv)){
            ...
            ?>
                <div class="form-group row">                               
                    <div class="col-sm-3">
                    <h6 class="text-info">PESO</br>[kg]:</h6>
                        <input type="text" class="form-control" value="<?php echo $row_sv[2];?>"            
                         name="peso" disabled>                
                    </div>
                    <div class="col-sm-3">
                    <h6 class="text-info">TALLA</br>[Centrimetros.]:</h6>
                    ...
                    <h6 class="text-info">I.M.C.:</h6>
                    <?php
                        $imc_i = $row_sv[2]*10000/$row_sv[3]**2;  //** Estatura en centimetros */
                        $imc = number_format($imc_i, 6, '.', '');
                    ?>
                        <input type="text" class="form-control" value="<?php echo $imc;?>"  
                         name="imc" disabled>                
                    </div>
                    <div class="col-sm-3"></br>
                    <h6 class="text-info">ÍNDICE ABDOMEN-TALLA </br></h6>
                        <input type="text" class="form-control" value="<?php 
                        $indice_at = number_format($row_p[4], 4, '.', ''); 
                        echo $indice_at;?>" name="peso" disabled>                
                    </div>
                </div>

                <div class="form-group row">  
                    <div class="col-sm-3">
                    <h6 class="text-info">PERÍMETRO ABDOMINAL</br>[Centrimetros]:</h6>
                        <input type="text" class="form-control" value="<?php echo $row_sv[4];?>"            
                         name="perimetro_abdominal" disabled>                
                    </div>
                    <div class="col-sm-3">
                    <h6 class="text-info">CIRCUNFERENCIA CADERA</br>[Centrimetros.]:</h6>
                        <input type="text" class="form-control" value="<?php echo $row_sv[5];?>"  
                         name="circunferencia_cadera" disabled>                
                    </div>                             
                    <div class="col-sm-3">
                    <h6 class="text-info">PRESIÓN ARTERIAL BRAZO</br>[mmHg]:</h6>
                        <input type="text" class="form-control" value="<?php echo $row_sv[6]."/".$row_sv[7];?>"             
                         name="presion_arterial" disabled>                      
                    </div>
                    <div class="col-sm-3">
                    <h6 class="text-info">PRESIÓN ARTERIAL TOBILLO</br>[mmHg]:</h6>
                        <input type="text" class="form-control" value="<?php echo $row_sv[8]."/".$row_sv[9];?>"             
                         name="presion_arterial" disabled>                      
                    </div>
                </div>
...
<hr>
    <div class="form-group row"> 
    <div class="col-sm-6">
    <h6 class="text-info">RESULTADOS DE LA EVALUACIÓN CLÍNICA</h6>
    </div> 
    <div class="col-sm-3"> 
    </div> 
    <div class="col-sm-3"> 
    ...
    <div class="form-group row"> 
    <div class="col-sm-4">
        <h6 class="text-info">CLASIFICACIÓN I.M.C.:</h6>
        <h6 class="text-info">(IMC)=
            <?php 
            $imc = number_format($imc_i, 6, '.', ''); 
            echo $imc;
            ?>     
        </h6>
            <select name="idclasificacion_imc"  id="idclasificacion_imc" class="form-control" disabled >
            <option selected>Seleccione</option>
            <?php
            $sqlv = " SELECT idclasificacion_imc, clasificacion_imc FROM clasificacion_imc ";
            $resultv = mysqli_query($link,$sqlv);
            if ($rowv = mysqli_fetch_array($resultv)){
            mysqli_field_seek($resultv,0);
            while ($fieldv = mysqli_fetch_field($resultv)){
            ...
            ?>
            <option value="<?php echo $rowv[0];?>" <?php if ($rowv[0]==$row_p[7]) echo "selected";?> ><?php echo $rowv[1];?></option>
            <?php
            } while ($rowv = mysqli_fetch_array($resultv));
            } else {
            }
    ...
    <div class="col-sm-4">
        <h6 class="text-info">RIÉSGO CINTURA CADERA:</h6> 
        <h6 class="text-info">(ÍNDICE)=
            <?php 
            $indice_cc = number_format($row_p[5], 4, '.', ''); 
            echo $indice_cc;
            ?>     
        </h6>
            <select name="idriesgo_cintura_cadera"  id="idriesgo_cintura_cadera" class="form-control" disabled >
            <option selected>Seleccione</option>
            <?php
            $sqlv = " SELECT idriesgo_cintura_cadera, riesgo_cintura_cadera FROM riesgo_cintura_cadera ";
            $resultv = mysqli_query($link,$sqlv);
            if ($rowv = mysqli_fetch_array($resultv)){
            mysqli_field_seek($resultv,0);
            while ($fieldv = mysqli_fetch_field($resultv)){
            ...
            ?>
            <option value="<?php echo $rowv[0];?>" <?php if ($rowv[0]==$row_p[8]) echo "selected";?> ><?php echo $rowv[1];?></option>
            <?php
            } while ($rowv = mysqli_fetch_array($resultv));
            } else {
            }
    ...
    <div class="col-sm-4"> 
        <h6 class="text-info">INTERPRETACIÓN TOBILLO-BRAZO:</h6>
        <h6 class="text-info">(ÍNDICE)=
            <?php 
            $indice_tb = number_format($row_p[6], 4, '.', ''); 
            echo $indice_tb;
            ?>     
        </h6>
            <select name="idinterpretacion_tobillo_brazo"  id="idinterpretacion_tobillo_brazo" class="form-control" disabled >
            <option selected>Seleccione</option>
            <?php
            $sqlv = " SELECT idinterpretacion_tobillo_brazo, interpretacion_tobillo_brazo FROM interpretacion_tobillo_brazo ";
            $resultv = mysqli_query($link,$sqlv);
            if ($rowv = mysqli_fetch_array($resultv)){
            mysqli_field_seek($resultv,0);
            while ($fieldv = mysqli_fetch_field($resultv)){
            ...
            ?>
            <option value="<?php echo $rowv[0];?>" <?php if ($rowv[0]==$row_p[9]) echo "selected";?> ><?php echo $rowv[1];?></option>
            <?php
            } while ($rowv = mysqli_fetch_array($resultv));
            } else {
            }
    ...
    <div class="form-group row"> 
        <div class="col-sm-4"> 
            <h6 class="text-info">CLASIFICACIÓN PRESIÓN ARTERIAL:</h6>
            <select name="idclasificacion_presion_arterial"  id="idclasificacion_presion_arterial" class="form-control" disabled >
            <option selected>Seleccione</option>
            <?php
            $sqlv = " SELECT idclasificacion_presion_arterial, clasificacion_presion_arterial FROM clasificacion_presion_arterial ";
            $resultv = mysqli_query($link,$sqlv);
            if ($rowv = mysqli_fetch_array($resultv)){
            mysqli_field_seek($resultv,0);
            while ($fieldv = mysqli_fetch_field($resultv)){
            ...
            ?>
            <option value="<?php echo $rowv[0];?>" <?php if ($rowv[0]==$row_p[10]) echo "selected";?> ><?php echo $rowv[1];?></option>
            <?php
            } while ($rowv = mysqli_fetch_array($resultv));
            } else {
            }
        ...
        <div class="col-sm-4">
            <h6 class="text-info">RIÉSGO CINTURA:</h6>
            <select name="idriesgo_cintura"  id="idriesgo_cintura" class="form-control" disabled >
            <option selected>Seleccione</option>
            <?php
            $sqlv = " SELECT idriesgo_cintura, riesgo_cintura FROM riesgo_cintura ";
            $resultv = mysqli_query($link,$sqlv);
            if ($rowv = mysqli_fetch_array($resultv)){
            mysqli_field_seek($resultv,0);
            while ($fieldv = mysqli_fetch_field($resultv)){
            ...
            ?>
            <option value="<?php echo $rowv[0];?>" <?php if ($rowv[0]==$row_p[11]) echo "selected";?> ><?php echo $rowv[1];?></option>
            <?php
            } while ($rowv = mysqli_fetch_array($resultv));
            } else {
            }
