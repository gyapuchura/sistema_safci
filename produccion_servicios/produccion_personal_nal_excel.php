...
<head>
    ...
    <title>REPORTE PRODUCCION SERVICIOS- NACIONAL</title>
</head>
<body>

<h2 style="font-family: Arial; font-size: 18px; color: #2D56CF; text-align: center;">REPORTE PRODUCCIÓN DE ATENCIONES MÉDICAS  SAFCI - MI SALUD</h2>
<h2 style="font-family: Arial; font-size: 18px; color: #2D56CF; text-align: center;">DEL: <?php echo $f_inicio;?> AL : <?php echo $f_finalizacion;?></h2>
