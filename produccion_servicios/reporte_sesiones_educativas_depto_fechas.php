...
$sql.= " AND sesion_educativa.iddepartamento = '$iddepartamento' AND sesion_educativa.fecha_sesion BETWEEN '$inicio' AND '$finalizacion' GROUP BY sesion_educativa.idcharla_psafci ";
...
$sql3.= " AND sesion_educativa.iddepartamento = '$iddepartamento' AND sesion_educativa.fecha_sesion BETWEEN '$inicio' AND '$finalizacion' GROUP BY sesion_educativa.idcharla_psafci ";
...
$sql4 =" SELECT count(idsesion_educativa) FROM sesion_educativa WHERE idcharla_psafci='$row3[0]' AND iddepartamento='$iddepartamento' AND fecha_sesion BETWEEN '$inicio' AND '$finalizacion' ";
...
<h4 align="center" style="font-family: Arial;">TOTAL DE SESIONES EDUCATIVAS DEPARTAMENTO <?php echo $row_dep[1];?> = 
                <?php
                $sql_dgt = " SELECT count(idsesion_educativa) FROM sesion_educativa WHERE iddepartamento='$iddepartamento' AND fecha_sesion BETWEEN '$inicio' AND '$finalizacion' ";
...
<table width="1400" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="400" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">SESIONES EDUCATIVAS - PSAFCI</span></td>
            ...
            $sql_m.= " WHERE sesion_educativa.idmunicipio=municipios.idmunicipio AND sesion_educativa.iddepartamento='$iddepartamento' AND sesion_educativa.fecha_sesion BETWEEN '$inicio' AND '$finalizacion' GROUP BY sesion_educativa.idmunicipio ";
           ...
           ?>
            ...
            while ($field_m = mysqli_fetch_field($result_m)){
                ...
                $sql_dg = " SELECT count(idsesion_educativa) FROM sesion_educativa WHERE idcharla_psafci='$row[0]' AND idmunicipio ='$row_m[0]' AND fecha_sesion BETWEEN '$inicio' AND '$finalizacion' ";
            ...
            <td bgcolor="#FFFFFF" align="center" style="font-family: Arial; font-size: 12px;">
                ...
                <?php
                $sql_dgt = " SELECT count(idsesion_educativa) FROM sesion_educativa WHERE idcharla_psafci='$row[0]' AND iddepartamento='$iddepartamento' AND fecha_sesion BETWEEN '$inicio' AND '$finalizacion' ";
                $result_dgt = mysqli_query($link,$sql_dgt);
                $row_dgt = mysqli_fetch_array($result_dgt);
