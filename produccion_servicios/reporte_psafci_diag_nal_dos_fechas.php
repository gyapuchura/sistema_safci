...
$sql.= " AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion'  GROUP BY diagnostico_psafci.idpatologia ";
...
$sql3.= " AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY diagnostico_psafci.idpatologia ";
...
$sql4.=" AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' AND diagnostico_psafci.idpatologia = '$row3[0]' ";
...
<h4 align="center" style="font-family: Arial;">Nº DIAGNÓSTICOS PREVENTIVOS 
 = 
                ...
                $sql_dgt.= " AND patologia.cie LIKE '%Z%' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
        ...
        <td width="50" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">CIE</span></td>
           ...
           ?>
            ...
            <td bgcolor="#FFFFFF" align="center" style="font-family: Arial; font-size: 12px;">
                ...
                $sql_dgt.= " AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' AND diagnostico_psafci.idpatologia = '$row[0]' ";
                $result_dgt = mysqli_query($link,$sql_dgt);
                $row_dgt = mysqli_fetch_array($result_dgt);
