    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">HISTORIAS CLÍNICAS POR ÁREA DE INFLUENCIA</h6>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <select name="idmunicipio_salud_af" id="idmunicipio_salud_af" class="form-control" required></select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9">
                        <select name="idestablecimiento_salud_af" id="idestablecimiento_salud_af" class="form-control" required></select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9">
                        <select name="idarea_influencia_hc" id="idarea_influencia_hc" class="form-control" required></select>
                        </div>
                    </div>

                    </div>
                    <div class="card-body" id="historias_clinicas_af">                    
                    </div>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">HISTORIAS CLÍNICAS A NIVEL ESTABLECIMIENTO</h6>
                    </div>                    
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-sm-3">
                    ...
                    <div class="card-body" id="historias_clinicas_est">                    
                    </div>
                </div>
                <!-- /.container-fluid -->
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">HISTORIAS CLÍNICAS POR MUNICIPIO</h6>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-sm-3">
                    ...
                    <div class="card-body" id="historias_clinicas_mun">                    
                    </div>
                </div>
