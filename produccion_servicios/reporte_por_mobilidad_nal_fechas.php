...
$sql.= " WHERE d.idpatologia=p.idpatologia AND d.idatencion_psafci=a.idatencion_psafci AND p.cie NOT LIKE '%Z%' ";
...
$sql_dgt.= " WHERE d.idpatologia=p.idpatologia AND p.cie NOT LIKE '%Z%' AND d.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<table width="1000" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="50" bgcolor="#FFFFFF" align="center" style="font-family: Arial; font-size: 12px;"><span class="Estilo8">CIE</span></td>
            ...
            <a href="reporte_morbilidad_dep_fechas.php?iddepartamento=<?php echo $row_d[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1420,height=820,scrollbars=YES,top=50,left=200'); return false;"><?php echo $row_d[1] ?></a>
            </td>
            <?php } ?>
