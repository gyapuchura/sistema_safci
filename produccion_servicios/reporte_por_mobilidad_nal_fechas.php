...
<h4 align="center" style="font-family: Arial;">TOTAL DE DIAGNÓSTICOS POR MORBILIDAD = 
                ...
                $sql_dgt.= " AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' AND patologia.cie NOT LIKE '%Z%' ";
    ...
    <tr>
        ...
        <td width="50" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">CIE</span></td>
            ...
            while ($field_d = mysqli_fetch_field($result_d)){
                ...
                <a href="reporte_por_morbilidad_dep_fechas.php?iddepartamento=<?php echo $row_d[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1420,height=820,scrollbars=YES,top=50,left=200'); return false;"><?php echo $row_d[1] ?></a> </span></td>
            <?php                  
