...
?>
        <tr>
          ...
          <a href="atenciones_telemetria_ec.php?idexamen_complementario=<?php echo $rowa[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1100,height=1000,left=600,scrollbars=YES,top=50,left=200'); return false;">VER</a>  
        </td>
        </tr>   
        <?php
        $numeroa=$numeroa+1;
