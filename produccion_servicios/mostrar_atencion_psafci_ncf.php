...
<hr>
    ...
    <div class="form-group row"> 
        ...
        <div class="col-sm-4">
            <h6 class="text-info">CONSENTIMIENTO INFORMADO:</h6> <h6>SI, ACEPTADO</h6> <input type="radio" name="consentimiento_informado" <?php if ($row_tel[6]=='SI') { echo 'checked'; } else { } ?> disabled>
...
<hr>
 ...
 <?php
    ...
    $sql_sv.="  descripcion_alergia FROM signo_vital_psafci WHERE idnombre ='$idnombre_paciente_ss' AND idatencion_psafci='$idatencion_psafci_ss' ORDER BY idsigno_vital_psafci DESC LIMIT 1 ";
...
<!---------------------------------------------------------------->
   ...
   <div class="form-group row"> 
    ...
    <div class="col-sm-6">
    <h6 class="text-info">OPCIONES ADICIONALES DE ATENCIÓN</h6>
    </div> 
    <div class="col-sm-3"> 
    </div> 
    </div> 
