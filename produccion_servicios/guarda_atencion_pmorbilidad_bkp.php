...
if ($diagnosticos == "1" && $tratamientos_1 == "1") {
    ...
    $idtipo_medicamento_12 = '0';
    $idmedicamento_12      = '0';
    $motivo_consulta2      = '0';
    $idpatologia2          = '0';
    $idtipo_medicamento_21 = '0';
    $idmedicamento_21      = '0';
    $idtipo_medicamento_22 = '0';
    $idmedicamento_22      = '0';
        ...
        if ($diagnosticos == "2" && $tratamientos_1 == "1" && $tratamientos_2 == "1") {
            ...
            $iddiagnostico_psafci_2 = mysqli_insert_id($link);
                ...
                if ($diagnosticos == "2" && $tratamientos_1 == "2" && $tratamientos_2 == "1") {
                    ...
                    echo "idcarpeta_familiar_ss = ".$idcarpeta_familiar_ss."</br>";
echo "idestablecimiento_salud_ss = ".$idestablecimiento_salud_ss."</br>";
echo "idintegrante_cf_ss = ".$idintegrante_cf_ss."</br>";
echo "idnombre_integrante_ss = ".$idnombre_integrante_ss."</br>";
echo "edad_ss = ".$edad_ss."</br></br>";

echo "diagnosticos = ".$diagnosticos."</br>";
echo "tratamientos_1 = ".$tratamientos_1."</br>";
echo "tratamientos_2 = ".$tratamientos_2."</br>";
