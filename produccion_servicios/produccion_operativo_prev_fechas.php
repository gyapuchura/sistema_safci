...
<html>
	<head>
		...
		<title>MEDI-SAFCI ATENCIONES INTEGRALES MEDICO - DIARIAS</title>
        ...
        title: {
            text: 'ATENCIONES PREVENTIVAS - Personal Médico : <?php echo mb_strtoupper($row_us[0]." ".$row_us[1]." ".$row_us[2]);?>'
        },
        subtitle: {
