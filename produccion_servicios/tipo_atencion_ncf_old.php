...
<form name="TELECONSULTA" action="guarda_teleconsulta_ncf.php" method="post">  
...
<form name="TELEMETRIA" action="guarda_telemetria_ncf.php" method="post">  
...
<hr>
            ...
            <div class="form-group row"> 
                <div class="col-sm-6">
                <h6 class="text-info">TELEMETR REALIZADA (SELECCIÓN MÚLTIPLE):</h6>
                </div> 
                <div class="col-sm-3"> 
                </div> 
                <div class="col-sm-3"> 
