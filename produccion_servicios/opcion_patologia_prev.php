...
$idpatologia_ap_sano = $_POST['patologia_ap_sano'];
  ...
  <!--------------------------------------------------------->
        ...
        if ($row_hp = mysqli_fetch_array($result_hp)){ 
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-warning">CONTROLES DE LA HISTORIA CLÍNICA PERINATAL Nº : <?php  echo $row_hp[1];?></h6>
                </div>

                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-sm-4">
                        <h6 class="text-warning">NOMBRE MADRE : </h6>
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <thead>
                                ...
                                <th scope="col">FECHA (F.U.M.)</th>
                                <th scope="col">FECHA PROBABLE DE PARTO</th>
                                <th scope="col">ACTUALIZAR ANTECEDENTES</th>
                                <th scope="col">REGISTRAR CONTROL ANTENATAL</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            ?>
                                ...
                                <a class="btn btn-warning btn-icon-split" href="../safci_perinatal/valida_historia_update.php?idhistoria_perinatal=<?php echo $row_hp[0];?>" target="_blank" onClick="window.open(this.href, this.target, 'width=900,height=800,top=50, left=700, scrollbars=YES'); return false;">
                                <span class="icon text-white-50">
                                    <i class="fas fa-book"></i>
                                </span>
                                <span class="text">ACTUALIZAR ANTECEDENTES</span></a> 

                                </td>
                                <td>
                                <a class="btn btn-warning btn-icon-split" href="../safci_perinatal/nuevo_control_hcp.php" target="_blank" onClick="window.open(this.href, this.target, 'width=900,height=800,top=50, left=700, scrollbars=YES'); return false;">
                                <span class="icon text-white-50">
                                    <i class="fas fa-book"></i>
                                </span>
                                <span class="text">NUEVO CONTROL</span></a> 
                                </td>
                                </tr>
                            <?php
                            $numero_g=$numero_g+1;
        ...
        <?php } else { ?>
            <!-------------  SE DEBE REGISTRAR LA NUEVA HISTORIA - BEGIN ----------->
        ...
        <div class="card-body">
            ...
            <!-------------  SE DEBE REGISTRAR LA NUEVA HISTORIA - END ----------->
        <?php } ?>


        <!--------------------------------------------------------->
        <!------------     CONTROL DE EMBARAZO - END --------------->
        <!--------------------------------------------------------->
