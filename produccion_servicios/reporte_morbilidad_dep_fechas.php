...
<html>
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'REPORTE DIAGNÓSTICOS POR MORBILIDAD - <?php echo $row_dep[1];?>'
        },
        subtitle: {
...
$sql.= " AND cie NOT LIKE '%Z%' AND atencion_psafci.iddepartamento = '$iddepartamento' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
$sql3.= " AND cie NOT LIKE '%Z%' AND atencion_psafci.iddepartamento = '$iddepartamento' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<h4 align="center" style="font-family: Arial;">DIAGNÓSTICOS POR MORBILIDAD DEPARTAMENTO : <?php echo $row_dep[1];?> = 
                <?php
                ...
                $sql_dgto.= " AND patologia.cie NOT LIKE '%Z%' AND atencion_psafci.iddepartamento='$iddepartamento' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<table width="1400" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="50" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">CIE</span></td>
            ...
            $sql_m.= " AND diagnostico_psafci.idpatologia=patologia.idpatologia AND patologia.cie NOT LIKE '%Z%'  ";
            $sql_m.= " AND atencion_psafci.iddepartamento='$iddepartamento' AND diagnostico_psafci.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY atencion_psafci.idmunicipio ORDER BY municipios.municipio ";
            ...
            while ($field_m = mysqli_fetch_field($result_m)){
                ...
                <a href="reporte_morbilidad_mun_fechas.php?idmunicipio=<?php echo $row_m[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1420,height=820,scrollbars=YES,top=50,left=200'); return false;"><?php echo $row_m[1];?></a>
                </span></td>
            <?php                  
           ...
           ?>
            ...
            while ($field_m = mysqli_fetch_field($result_m)){
                ...
                ?>
                    ...
                    <a href="patologias_diario_mun_fechas.php?idpatologia=<?php echo $row[0];?>&idmunicipio=<?php echo $row_m[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1420,height=820,scrollbars=YES,top=50,left=200'); return false;">
                        <?php 
                        if ($diagnosticos == '0') {
