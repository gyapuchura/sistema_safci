...
<!-- BEGIN aqui va el comntenido de la pagina ---->
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-danger">SE HA DETECTADO QUE LA PERSONA YA EXISTE EN SISTEMA!</h6>
                </div>
                <div class="card-body">
                <div class="form-group row">                               
                    <div class="col-sm-12">
                    <h6 class="text-danger">DEBE GUARDAR NUEVAMENTE LA ATENCIÓN MÉDICA LA CUAL SE ASOCIARÁ A LOS DATOS PERSONALES SIGUIENTES:</h6>
                    </div>
                </div>
            </div>
