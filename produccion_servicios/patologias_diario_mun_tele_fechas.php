...
<html>
	<head>
		...
		<title>MEDI-APS ATENCIONES POR TELESALUD - PATOLOGIA</title>
 ...
 <?php
$numero = 0;
$sql = " SELECT atencion_psafci.fecha_registro FROM atencion_psafci, diagnostico_teleconsulta WHERE diagnostico_teleconsulta.idatencion_psafci=atencion_psafci.idatencion_psafci ";
$sql.= " AND diagnostico_teleconsulta.idpatologia='$idpatologia' AND atencion_psafci.idmunicipio='$idmunicipio' AND diagnostico_teleconsulta.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY atencion_psafci.fecha_registro ORDER BY atencion_psafci.fecha_registro ";
...
?>
        ...
        yAxis: {
            title: {
                text: 'ATENCIONES POR TELESALUD DIARIAS'
            }
        },
        tooltip: {
            shared: true,
...
<?php
$sql7 = " SELECT diagnostico_teleconsulta.iddiagnostico_teleconsulta  FROM diagnostico_teleconsulta, atencion_psafci ";
...
$sql7.= " AND diagnostico_teleconsulta.idpatologia='$idpatologia' AND atencion_psafci.idmunicipio='$idmunicipio' AND diagnostico_teleconsulta.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" atencion_psafci.fecha_registro, atencion_psafci.hora_registro, atencion_psafci.idusuario  ";
    $sql.=" FROM atencion_psafci, nombre, departamento, municipios, establecimiento_salud, diagnostico_teleconsulta ";
    $sql.=" WHERE atencion_psafci.idnombre=nombre.idnombre AND diagnostico_teleconsulta.idatencion_psafci=atencion_psafci.idatencion_psafci ";
    $sql.=" AND atencion_psafci.iddepartamento=departamento.iddepartamento ";
    ...
    $sql.=" AND diagnostico_teleconsulta.idpatologia='$idpatologia' AND atencion_psafci.idmunicipio='$idmunicipio' AND diagnostico_teleconsulta.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ORDER BY atencion_psafci.idatencion_psafci DESC ";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
    ...
    ?>
		    <tr>
              ...
              <a href="imprime_atencion_psafci.php?idatencion_psafci=<?php echo $row[0];?>" target="_blank" onClick="window.open(this.href, this.target, 'width=800,height=1000,top=50, left=200, scrollbars=YES'); return false;">
              <?php echo $row[1];?></a>  </td>
              ...
              <?php 
                ...
                $sql_c.=" AND usuarios.idusuario='$row[10]' ORDER BY dato_laboral.idcargo_organigrama DESC LIMIT 1 ";
