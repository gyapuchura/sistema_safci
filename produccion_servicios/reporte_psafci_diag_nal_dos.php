...
<html>
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'REPORTE DIAGNÓSTICOS PSAFCI - NACIONAL'
        },
        subtitle: {
...
<table width="1000" border="1" align="center" bordercolor="#009999">
    <tr>
        <td width="20" bgcolor="#FFFFFF" style="font-family: Arial;"><span class="Estilo8 Estilo1 Estilo2" style="font-size: 12px"> N° </span></td>
        <td width="400" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">DIAGNÓSTICOS PSAFCI</span></td>
            ...
            while ($field_d = mysqli_fetch_field($result_d)){
                ...
                <td width="200" align="center" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo7"><?php echo $row_d[1];?></span></td>
            <?php                  
           ...
           ?>
            ...
            while ($field_d = mysqli_fetch_field($result_d)){
                ...
                ?>
                    <td bgcolor="#FFFFFF" align="center" style="font-family: Arial; font-size: 12px;"><?php echo $diagnosticos;?></td>
            <?php                  
            } while ($row_d = mysqli_fetch_array($result_d));
            } else {  }
            ?>
