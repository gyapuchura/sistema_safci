...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf' ";
...
<html>
	<head>
		...
		<title>PIRÁMIDE MORBILIDAD - MEDICO OPERATIVO</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE MORBILIDAD - <?php echo mb_strtoupper($morbilidad_est);?> - MÉDICO: <?php echo $operativo;?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND carpeta_familiar.idusuario='$idusuario' AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf'  ";
