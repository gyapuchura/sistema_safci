...
$sqlav.= " AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf' AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf' AND carpeta_familiar.iddepartamento='$iddepartamento'";
...
<html>
	<head>
		...
		<title>PIRÁMIDE DISCAPACIDAD - NIVEL DEPARTAMENTAL</title>
        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf' AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
