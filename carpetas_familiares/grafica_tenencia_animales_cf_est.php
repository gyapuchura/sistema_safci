        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY tenencia_animales_cf.idtenencia_animales ";
                    ...
                    $sql_c.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND tenencia_animales_cf.idtenencia_animales='$row[0]' ";
...
<?php
                    ...
                    $sql.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY tenencia_animales_cf.idtenencia_animales ";
                    $result = mysqli_query($link,$sql);
                    if ($row = mysqli_fetch_array($result)){
                    mysqli_field_seek($result,0);
                    while ($field = mysqli_fetch_field($result)){
