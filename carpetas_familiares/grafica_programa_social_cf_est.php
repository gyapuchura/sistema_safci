        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " WHERE integrante_beneficiario.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.estado='CONSOLIDADO' ";
                    $sql.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY integrante_beneficiario.idprograma_social ";
...
$sqla.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY integrante_beneficiario.idprograma_social ";
