        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND etapa_familiar_cf.vigente='SI' ";
                    ...
                    $sql.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND etapa_familiar_cf.vigente='SI' GROUP BY etapa_familiar_cf.idetapa_familiar ";
                    ...
                    $sql_c.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND etapa_familiar_cf.vigente='SI' AND etapa_familiar_cf.idetapa_familiar='$row[0]' ";
