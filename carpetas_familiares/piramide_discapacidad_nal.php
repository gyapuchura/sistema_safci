...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf' AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf' ";
        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf' AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf' ";
