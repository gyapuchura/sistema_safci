...
<html>
	<head>
		...
		<title>FUNCIONALIDAD VIVIENDA - DEPTO</title>
...
$(function () {
    $('#tenencia_vivienda').highcharts({
        ...
        title: {
            text: 'a) TENENCIA DE LA VIVIENDA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
...
$(function () {
    $('#techo_vivienda').highcharts({
        ...
        title: {
            text: 'b) ÍNDICE DE HACINAMIENTO - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
