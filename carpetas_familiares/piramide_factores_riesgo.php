...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idarea_influencia='$idarea_influencia' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf' ";
...
<html>
	<head>
		...
		<title>PIRÁMIDE FACTORES DE RIESGO - ÁREA DE INFLUENCIA</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE FACTORES DE RIESGO - ÁREA DE INFLUENCIA <?php echo mb_strtoupper($area_af);?> - <?php echo mb_strtoupper($riesgo);?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf'  ";
