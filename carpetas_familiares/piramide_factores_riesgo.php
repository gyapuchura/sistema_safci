        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idarea_influencia='$idarea_influencia' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf'  ";
