...
<table width="900" border="0" align="center">
  <tbody>
    <tr>
      ...
      INFORME SITUACIONAL DEPARTAMENTAL</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td width="29">&nbsp;</td>
      ...
      <td colspan="4"><table width="900" border="1" cellspacing="0">
        <tbody>
          <tr>
            ...
            <td width="651" style="font-family: Arial; font-size: 12px;"><?php echo $row_dep[1];?></td>
          </tr>
      ...
      <td colspan="2"><table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              <?php
                  ...
                  $sql_h.=" WHERE area_influencia.idestablecimiento_salud=establecimiento_salud.idestablecimiento_salud AND establecimiento_salud.iddepartamento='$iddepartamento' ";
                  ...
                  $sql_int.=" AND integrante_cf.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
          ...
          <?php
                      ...
                      $sql_f.=" WHERE area_influencia.idestablecimiento_salud=establecimiento_salud.idestablecimiento_salud AND establecimiento_salud.iddepartamento='$iddepartamento'  ";
                      ...
                      $sql_cf.=" AND iddepartamento='$iddepartamento' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;"></td>
              ...
              <?php
                  $sql_af =" SELECT idarea_influencia FROM carpeta_familiar WHERE iddepartamento='$iddepartamento' AND estado='CONSOLIDADO' GROUP BY idarea_influencia ";   
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql4.=" AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.iddepartamento='$iddepartamento' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql5.=" AND integrante_cf.edad BETWEEN '0' AND '4'  AND carpeta_familiar.iddepartamento='$iddepartamento' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql6.=" AND integrante_cf.edad BETWEEN '60' AND '160'  AND carpeta_familiar.iddepartamento='$iddepartamento' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_1.=" AND integrante_cf.edad BETWEEN '0' AND '1'  AND carpeta_familiar.iddepartamento='$iddepartamento' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_2.=" AND integrante_cf.idnombre=nombre.idnombre AND nombre.idgenero='1' AND integrante_cf.edad BETWEEN '15' AND '49' AND carpeta_familiar.iddepartamento='$iddepartamento'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_3.=" AND integrante_factor_riesgo.idfactor_riesgo_cf='13' AND integrante_cf.edad BETWEEN '10' AND '19' AND carpeta_familiar.iddepartamento='$iddepartamento'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_4.=" AND integrante_factor_riesgo.idfactor_riesgo_cf='13' AND carpeta_familiar.iddepartamento='$iddepartamento'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              <?php
                ...
                $sql_5.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
...
$sql_0.= " AND carpeta_familiar.iddepartamento='$iddepartamento' ";
...
?>
    ...
    <tr>
      <td colspan="2"><table width="450" border="1" cellspacing="0">
        ...
        $sql.="  AND carpeta_familiar.iddepartamento='$iddepartamento' GROUP BY integrante_factor_riesgo.idfactor_riesgo_cf ";
        ...
        $sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND integrante_factor_riesgo.idfactor_riesgo_cf='$row[0]' ";
        $result_c = mysqli_query($link,$sql_c);
        $row_c = mysqli_fetch_array($result_c);
      ...
      <table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          $sql.= " AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.vigente='SI' GROUP BY funcionalidad_familiar_cf.idfuncionalidad_familiar ";                  
          $result = mysqli_query($link,$sql);
          if ($row = mysqli_fetch_array($result)){
          mysqli_field_seek($result,0);
          while ($field = mysqli_fetch_field($result)){
          ...
          $sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='$row[0]' ";
    ...
    <tr>
      ...
      <table width="450" border="1" cellspacing="0">
        ...
        $sql.=" AND carpeta_familiar.iddepartamento='$iddepartamento' GROUP BY integrante_morbilidad.idmorbilidad_cf  ";
        $result = mysqli_query($link,$sql);
        if ($row = mysqli_fetch_array($result)){
        mysqli_field_seek($result,0);
        while ($field = mysqli_fetch_field($result)){
        ...
        ?>
            ...
            $sql_m.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND integrante_morbilidad.idmorbilidad_cf='$row[0]' ";
        ...
        <tbody>
          <tr>
            ...
            <td width="38" style="font-family: Arial; font-size: 12px; text-align: center;">%</td>
                    ...
                    $sql_ff.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
      ...
      <table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <?php 
              ...
              $sql_td.= " AND carpeta_familiar.iddepartamento='$iddepartamento' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_a.= " AND integrante_discapacidad.idtipo_discapacidad_cf='$row3[0]' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
              $result_a = mysqli_query($link,$sql_a);
              $row_a = mysqli_fetch_array($result_a);
              echo $row_a[0];
    ...
    <table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            $sql_seg.=" WHERE seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.iddepartamento='$iddepartamento' ";
          ...
          <tr>
            ...
            <?php 
              ...
              $sql_re.=" AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.idestado_visita_cf='3' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
 ...
 */
    ...
    $_REQUEST['data'] = 'https://virtual-safci.minsalud.gob.bo/medi-safci/carpetas_familiares/informe_operativo.php?iddepartamento='.$iddepartamento;
    $_REQUEST['size'] = 2 ;
