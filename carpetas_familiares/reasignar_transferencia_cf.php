        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">TRANSFERENCIA DE CARPETAS FAMILIARES DE UN OPERATIVO A OTRO</h1>
                    <p class="mb-4">En esta seccion se puede TRANSFERIR CARPETAS FAMILIARES del PROGRAMA NACIONAL SAFCI - MI SALUD a NIVEL NACIOANL por ESTABLECIMIENTO DE SALUD.</p>

                    <!-- DataTales Example -->

            <form name="TRANSFERENCIA_CF" action="guarda_transferencia_cf.php" method="post">

                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">MÉDICO OPERATIVO - 1 (QUE TRANSFIERE CARPETAS)</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">MÉDICO OPERATIVO - 2 (RECIBE CARPETAS FAMILIARES)</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-sm-9">
                    ...
                    GUARDAR TRANSFERENCIA DE CARPETAS FAMILIARES
                    </button>  
                </div> 
                </div>      
            </div> 
