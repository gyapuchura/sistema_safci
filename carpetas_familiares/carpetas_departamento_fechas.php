...
<html>
	<head>
		...
		<title>CARPETAS FAMILIARES DEPARTAMENTO FECHAS</title>
...
$(function () {
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            <?php
$sql_t =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_t = mysqli_query($link,$sql_t);
$row_t = mysqli_fetch_array($result_t);
$total = $row_t[0];

$sql_a =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='1' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_a = mysqli_query($link,$sql_a);
$row_a = mysqli_fetch_array($result_a);
$beni = $row_a[0];

$sql_b =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='2' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_b = mysqli_query($link,$sql_b);
$row_b = mysqli_fetch_array($result_b);
$cbba =    $row_b[0];

$sql_c =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='3' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_c = mysqli_query($link,$sql_c);
$row_c = mysqli_fetch_array($result_c);
$chuquisaca =$row_c[0];

$sql_d =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='4' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_d = mysqli_query($link,$sql_d);
$row_d = mysqli_fetch_array($result_d);
$la_paz = $row_d[0];

$sql_e =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='5' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_e = mysqli_query($link,$sql_e);
$row_e = mysqli_fetch_array($result_e);
$oruro = $row_e[0];

$sql_f =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='6' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_f = mysqli_query($link,$sql_f);
$row_f = mysqli_fetch_array($result_f);
$pando = $row_f[0];

$sql_g =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='7' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_g = mysqli_query($link,$sql_g);
$row_g = mysqli_fetch_array($result_g);
$potosi =$row_g[0];

$sql_h =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='8' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_h = mysqli_query($link,$sql_h);
$row_h = mysqli_fetch_array($result_h);
$santa_cruz = $row_h[0];

$sql_i =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='9' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">CANTIDAD DE CARPETAS DEL <?php echo $f_inicio;?> al <?php echo $f_finalizacion;?> </h2>
    ...
    while ($field = mysqli_fetch_field($result)){
        ...
        $sql_depto =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='$row[0]' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
    ...
    ?>
		    <tr>
              ...
              <a href="carpetas_municipio_fechas.php?iddepartamento=<?php echo $row[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" style="font-size: 12px; font-family: Arial;" onClick="window.open(this.href, this.target, 'width=850,height=1000,scrollbars=YES,top=60,left=400'); return false;">MUNICIPIOS</a>
              </td>
...
<?php
$sql_cf =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<?php
$sql_p = " SELECT idmunicipio FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY idmunicipio ";
...
<?php
$sql_mun =" SELECT idestablecimiento_salud FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY idestablecimiento_salud ";
...
<?php
$sql_int =" SELECT count(idintegrante_cf) FROM integrante_cf WHERE estado='CONSOLIDADO' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<?php
$sql_per = " SELECT idusuario FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY idusuario ";
