...
$(function () {
    $('#suministro_agua').highcharts({
        ...
        title: {
            text: 'FORMA DE AYUDA FAMILIAR NECESARIA - ÁREA DE INFLUENCIA: <?php echo mb_strtoupper($area_af);?> - Fuente: Sistema Medi-Safci al <?php echo $f_emision;?>'
        },
        tooltip: {
...
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">TOTAL DE CARPETAS FAMILIARES ÁREA DE INFLUENCIA = <?php echo $total;?> </h4></spam>
