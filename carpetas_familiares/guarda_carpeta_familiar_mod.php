...
$row_cf=mysqli_fetch_array($result_cf);
        ...
        $sql9 = " UPDATE carpeta_familiar SET familia='$familia', fecha_apertura='$fecha_apertura', fecha_registro='$fecha',  ";
        $sql9.= " hora_registro='$hora', idusuario='$idusuario_ss' WHERE idcarpeta_familiar='$idcarpeta_familiar_ss' ";
        $result9 = mysqli_query($link,$sql9);  
    
        header("Location:mensaje_carpeta_familiar_mod.php");
