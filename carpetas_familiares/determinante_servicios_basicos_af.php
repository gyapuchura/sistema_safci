...
<html>
	<head>
		...
		<title>SERVICIOS_BASICOS_AREA_INFLUENCIA</title>
...
$(function () {
    $('#suministro_agua').highcharts({
        ...
        title: {
            text: 'a) ABASTECIMIENTO DE AGUA PARA CONSUMO - ÁREA DE INFLUENCIA :  <?php echo mb_strtoupper($area_af);?>'
        },
        tooltip: {
...
$(function () {
    $('#manejo_basura').highcharts({
        ...
        title: {
            text: 'b) MANEJO DE LA BASURA - ÁREA DE INFLUENCIA :  <?php echo mb_strtoupper($area_af);?> '
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#servicio_higienico').highcharts({
        ...
        title: {
            text: 'c) SERVICIO HIGIENICO - ÁREA DE INFLUENCIA :  <?php echo mb_strtoupper($area_af);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#eliminacion_excretas').highcharts({
        ...
        title: {
            text: 'd). ELIMINACIÓN DE EXCRETAS - ÁREA DE INFLUENCIA :  <?php echo mb_strtoupper($area_af);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#iluminacion_vivienda').highcharts({
        ...
        title: {
            text: 'e). ILUMINACIÓN DE LA VIVIENDA - ÁREA DE INFLUENCIA :  <?php echo mb_strtoupper($area_af);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#combustible_energia').highcharts({
        ...
        title: {
            text: 'f). COMBUSTIBLE/ENERGIA PARA COCINAR - ÁREA DE INFLUENCIA :  <?php echo mb_strtoupper($area_af);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
