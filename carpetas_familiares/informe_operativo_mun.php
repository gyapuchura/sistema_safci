...
$idmunicipio = $_GET["idmunicipio"];
  ...
  $sql_u =" SELECT establecimiento_salud.idmunicipio, departamento.departamento, red_salud.red_salud, municipios.municipio, establecimiento_salud.establecimiento_salud ";   
  ...
  $sql_u.=" AND establecimiento_salud.idmunicipio='$idmunicipio' ";  
...
<table width="900" border="0" align="center">
  <tbody>
    <tr>
      ...
      INFORME OPERATIVO MUNICIPIO</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td width="29">&nbsp;</td>
      ...
      <td colspan="2"><table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              <?php
                  ...
                  $sql_int.=" AND integrante_cf.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
          ...
          <?php
                      ...
                      $sql_cf.=" AND idmunicipio='$idmunicipio' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;"></td>
              ...
              <?php
                  $sql_af =" SELECT idarea_influencia FROM carpeta_familiar WHERE idmunicipio='$idmunicipio' AND estado='CONSOLIDADO' GROUP BY idarea_influencia ";   
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql4.=" AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idmunicipio='$idmunicipio' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql5.=" AND integrante_cf.edad BETWEEN '0' AND '4'  AND carpeta_familiar.idmunicipio='$idmunicipio' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql6.=" AND integrante_cf.edad BETWEEN '60' AND '160'  AND carpeta_familiar.idmunicipio='$idmunicipio' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_1.=" AND integrante_cf.edad BETWEEN '0' AND '1'  AND carpeta_familiar.idmunicipio='$idmunicipio' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_2.=" AND integrante_cf.idnombre=nombre.idnombre AND nombre.idgenero='1' AND integrante_cf.edad BETWEEN '15' AND '49' AND carpeta_familiar.idmunicipio='$idmunicipio'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_3.=" AND integrante_factor_riesgo.idfactor_riesgo_cf='13' AND integrante_cf.edad BETWEEN '10' AND '19' AND carpeta_familiar.idmunicipio='$idmunicipio'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_4.=" AND integrante_factor_riesgo.idfactor_riesgo_cf='13' AND carpeta_familiar.idmunicipio='$idmunicipio'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              <?php
                ...
                $sql_5.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
...
$sql_0.= " AND carpeta_familiar.idmunicipio='$idmunicipio' ";
...
$sqla.= " AND carpeta_familiar.idmunicipio='$idmunicipio' GROUP BY integrante_cf.idnacion ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND integrante_cf.idnacion='$rowa[0]' ";
    ...
    <tr>
      ...
      <table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          $sql.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND funcionalidad_familiar_cf.vigente='SI' GROUP BY funcionalidad_familiar_cf.idfuncionalidad_familiar ";                  
          $result = mysqli_query($link,$sql);
          if ($row = mysqli_fetch_array($result)){
          mysqli_field_seek($result,0);
          while ($field = mysqli_fetch_field($result)){
          ...
          $sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='$row[0]' ";
    ...
    <tr>
      ...
      <table width="450" border="1" cellspacing="0">
        ...
        ?>
            ...
            $sql_m.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' AND integrante_morbilidad.idmorbilidad_cf='$row[0]' ";
        ...
        <tbody>
          <tr>
            ...
            <td width="38" style="font-family: Arial; font-size: 12px; text-align: center;">%</td>
                    ...
                    $sql_ff.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
      ...
      <table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <?php 
              ...
              $sql_td.= " AND carpeta_familiar.idmunicipio='$idmunicipio' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_a.= " AND integrante_discapacidad.idtipo_discapacidad_cf='$row3[0]' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
              $result_a = mysqli_query($link,$sql_a);
              $row_a = mysqli_fetch_array($result_a);
              echo $row_a[0];
    ...
    <table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            $sql_seg.=" WHERE seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idmunicipio='$idmunicipio' ";
          ...
          <tr>
            ...
            <?php 
              ...
              $sql_re.=" AND seguimiento_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND visita_cf.idestado_visita_cf='3' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
 ...
 */
    ...
    $_REQUEST['data'] = 'https://virtual-safci.minsalud.gob.bo/medi-safci/carpetas_familiares/informe_operativo.php?idmunicipio='.$idmunicipio;
    $_REQUEST['size'] = 2 ;
