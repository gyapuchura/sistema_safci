...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<html>
	<head>
		...
		<title>PIRÁMIDE MORBILIDAD - NIVEL NACIONAL</title>
        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
