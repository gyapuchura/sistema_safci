...
<html>
	<head>
		...
		<title>DISCAPACIDAD EN LOS INTEGRANTES DE LA FAMILIA</title>
...
<table width="806" border="1" align="center" cellspacing="0">
  <tbody>
    <tr>
      <td width="90" bgcolor="#C3EDD7" style="font-family: Arial; font-size: 12px; color: #205332;"><strong>NIVEL</strong></td>
      <td width="700" bgcolor="#C3EDD7" style="font-family: Arial; font-size: 12px; color: #284A1F; text-align: center;"><strong>TIPOS DE DISCAPACIDAD EN LOS INTEGRANTES DE LA FAMILIA</strong></td>
    </tr>
    <?php 

$sql4 = " SELECT idnivel_discapacidad_cf, nivel_discapacidad_cf FROM nivel_discapacidad_cf ORDER BY idnivel_discapacidad_cf ";
    ...
    <tr>
      ...
      <table width="736" border="0">
        <tbody>
          ...
          <?php 
$numero5 = 0;
$sql5 = " SELECT idtipo_discapacidad_cf, tipo_discapacidad_cf FROM tipo_discapacidad_cf ORDER BY idtipo_discapacidad_cf";
...
$sql_s =" SELECT idintegrante_discapacidad FROM integrante_discapacidad WHERE idtipo_discapacidad_cf='$row5[0]' AND idnivel_discapacidad_cf ='$row4[0]'  GROUP BY idintegrante_discapacidad ";
...
<a href="detalle_discapacidad_cf.php?idtipo_discapacidad_cf=<?php echo $row5[0];?>&idnivel_discapacidad_cf=<?php echo $row4[0];?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=700,scrollbars=YES,top=50,left=200'); return false;"><?php if ($row_s !='0') { echo $row_s; } else { } ?></a>  
