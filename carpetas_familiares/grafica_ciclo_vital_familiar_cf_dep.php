...
<html>
	<head>
		...
		<title>ESTRUCTURA FAMILIAR DEPTO</title>
...
$(function () {
    $('#ciclo_vital').highcharts({
        ...
        title: {
            text: 'ETAPA DEL CICLO VITAL FAMILIAR - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND carpeta_familiar.iddepartamento='$iddepartamento' AND etapa_familiar_cf.vigente='SI' ";
                    ...
                    $sql.= " AND carpeta_familiar.iddepartamento='$iddepartamento' AND etapa_familiar_cf.vigente='SI' GROUP BY etapa_familiar_cf.idetapa_familiar ";
                    ...
                    $sql_c.= " AND carpeta_familiar.iddepartamento='$iddepartamento' AND etapa_familiar_cf.vigente='SI' AND etapa_familiar_cf.idetapa_familiar='$row[0]' ";
