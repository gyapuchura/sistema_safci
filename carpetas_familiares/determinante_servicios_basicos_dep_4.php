...
$(function () {
    $('#eliminacion_escretas').highcharts({
        chart: {
            type: 'pie',
            options3d: {
                enabled: true,
        ...
        title: {
            text: 'd) ELIMINACIÓN DE ESCRETAS - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        subtitle: {
...
<div id="eliminacion_escretas" style="height: 350px"></div>
...
<table width="646" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="315" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">ELIMINACIÓN DE ESCRETAS</span></td>
