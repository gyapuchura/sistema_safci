...
<html>
	<head>
		...
		<title>DEFUNCION - ESTABLECIMIENTO DE SALUD</title>
...
$(function () {
    $('#suministro_agua').highcharts({
        ...
        title: {
            text: 'DEFUNCIÓN DE INTEGRANTES - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY defuncion_cf ";
