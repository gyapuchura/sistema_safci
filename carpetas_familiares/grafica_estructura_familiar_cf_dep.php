...
$(function () {
    $('#suministro_agua').highcharts({
        ...
        title: {
            text: 'ESTRUCTURA FAMILIAR - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= "  AND carpeta_familiar.iddepartamento='$iddepartamento' AND estructura_familiar_cf.vigente='SI' ";
                    ...
                    $sql.= "  AND carpeta_familiar.iddepartamento='$iddepartamento' AND estructura_familiar_cf.vigente='SI' GROUP BY estructura_familiar_cf.idestructura_familiar ";
                    ...
                    $sql_c.= " AND carpeta_familiar.iddepartamento='$iddepartamento' AND estructura_familiar_cf.vigente='SI' AND estructura_familiar_cf.idestructura_familiar='$row[0]' ";
