...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf' ";
        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf'  ";
