...
<html>
	<head>
		...
		<title>FUNCIONALIDAD VIVIENDA - RED DE SALUD</title>
...
$(function () {
    $('#tenencia_vivienda').highcharts({
        ...
        title: {
            text: 'a) TENENCIA DE LA VIVIENDA - Red de Salud: <?php echo mb_strtoupper($row_red[1]);?>'
        },
        subtitle: {
...
$(function () {
    $('#techo_vivienda').highcharts({
        ...
        title: {
            text: 'b) ÍNDICE DE HACINAMIENTO - Red de Salud: <?php echo mb_strtoupper($row_red[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#paredes_vivienda').highcharts({
        ...
        title: {
            text: 'c) TENENCIA DE ANIMALES EN LA VIVIENDA - Red de Salud: <?php echo mb_strtoupper($row_red[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
