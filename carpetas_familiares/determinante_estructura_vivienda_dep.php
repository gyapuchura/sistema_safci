...
<html>
	<head>
		...
		<title>ESTRUCTURA VIVIENDA DEPTAL</title>
...
$(function () {
    $('#tipo_vivienda').highcharts({
        ...
        title: {
            text: 'a) TIPO DE VIVIENDA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.iddepartamento='$iddepartamento' GROUP BY determinante_salud_cf.iditem_determinante_salud ";
                    ...
                    $sql_c.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.iddepartamento='$iddepartamento' ";
...
$(function () {
    $('#techo_vivienda').highcharts({
        ...
        title: {
            text: 'b) TECHO DE LA VIVIENDA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#paredes_vivienda').highcharts({
        ...
        title: {
            text: 'c) PAREDES DE LA VIVIENDA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#pisos_vivienda').highcharts({
        ...
        title: {
            text: 'd). PISOS DE LA VIVIENDA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#revoque_paredes').highcharts({
        ...
        title: {
            text: 'e). REVOQUE DE LAS PAREDES INTERIORES - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#riesgos_externos').highcharts({
        ...
        title: {
            text: 'g) RIESGOS EXTERNOS CON RELACIÓN A LA VIVIENDA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        subtitle: {
...
$sql2.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.iddepartamento='$iddepartamento' ";
...
$sql_a.=" AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.iddepartamento='$iddepartamento' ";
...
$(function () {
    $('#riesgos_internos').highcharts({
        ...
        title: {
            text: 'h) RIESGOS INTERNOS CON RELACIÓN A LA VIVIENDA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        subtitle: {
            text: 'Fuente: REGISTRO SISTEMA MEDI-SAFCI'
        },
