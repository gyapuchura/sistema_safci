...
<html>
	<head>
		...
		<title>APARENTEMENTE SANOS EN AREAS DE INFLUENCIA</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'APARENTEMENTE SANOS - ÁREAS DE INFLUENCIA DEL ESTABLECIMIENTO: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        subtitle: {
