...
$verificar_ss          = $_SESSION['verificar_ss'];
...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr> 
                    <h4 class="text-danger">NO SE PUEDE CONSOLIDAR LA CARPETA FAMILIAR!!! </h4>                   
                    <h6 class="text-danger">USTED NO HA INGRESADO </h6>
                    <h4 class="text-danger">EL <?php echo $verificar_ss; ?> </h4>

                    </br>
                    <a href="mostrar_carpeta_familiar.php"><h6>VOLVER -></h6></a>
                    </div>
