...
<html>
	<head>
		...
		<title>PIRÁMIDE DISCAPACIDAD - MUNICI[PAL</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE DISCAPACIDAD - MUNICIPIO DE <?php echo mb_strtoupper($municipio_cf);?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND integrante_cf.idgrupo_etareo_cf='$row2[0]' AND nombre.idgenero='2' AND integrante_cf.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
                ...
                data: [
                    <?php
                        ...
                        $sql7 = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_discapacidad, integrante_cf, nombre, carpeta_familiar WHERE integrante_cf.idnombre=nombre.idnombre ";
                        $sql7.= " AND integrante_discapacidad.idintegrante_cf=integrante_cf.idintegrante_cf AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar ";
                        $sql7.= " AND integrante_cf.idgrupo_etareo_cf='$row3[0]' AND nombre.idgenero='1' AND integrante_cf.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
                        $result7 = mysqli_query($link,$sql7);
                        $row7 = mysqli_fetch_array($result7);
