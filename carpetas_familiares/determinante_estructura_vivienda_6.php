        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT iditem_determinante_salud, item_determinante_salud FROM item_determinante_salud WHERE iddeterminante_salud='2' AND idcat_determinante_salud='13'";
