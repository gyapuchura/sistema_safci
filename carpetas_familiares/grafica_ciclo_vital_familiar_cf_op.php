...
<html>
	<head>
		...
		<title>ESTRUCTURA FAMILIAR MEDICO OPERATIVO</title>
...
$(function () {
    $('#ciclo_vital').highcharts({
        ...
        title: {
            text: 'ETAPA DEL CICLO VITAL FAMILIAR - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND carpeta_familiar.idusuario='$idusuario' AND etapa_familiar_cf.vigente='SI' ";
                    ...
                    $sql.= " AND carpeta_familiar.idusuario='$idusuario' AND etapa_familiar_cf.vigente='SI' GROUP BY etapa_familiar_cf.idetapa_familiar ";
                    ...
                    $sql_c.= " AND carpeta_familiar.idusuario='$idusuario' AND etapa_familiar_cf.vigente='SI' AND etapa_familiar_cf.idetapa_familiar='$row[0]' ";
