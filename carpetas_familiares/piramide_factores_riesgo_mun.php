...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf' ";
...
<html>
	<head>
		...
		<title>PIRÁMIDE FACTORES DE RIESGO - MUNICIPIOS</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE FACTORES DE RIESGO - MUNICIPIO: <?php echo mb_strtoupper($municipio_cf);?> - <?php echo mb_strtoupper($riesgo);?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf'  ";
