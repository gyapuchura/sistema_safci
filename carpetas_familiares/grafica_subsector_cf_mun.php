...
<html>
	<head>
		...
		<title>SUBSECTOR SALUD FAMILIAR - MUNICIPIO.</title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'CORRESPONDEN AL SUBSECTOR SALUD - Mun.. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idmunicipio='$idmunicipio'  ";
                    ...
                    $sql.= " AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idmunicipio='$idmunicipio'  ";
...
$(function () {
    $('#asiste_salud').highcharts({
        ...
        title: {
            text: 'ASISTEN AL SUBSECTOR SALUD - Mun.. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
