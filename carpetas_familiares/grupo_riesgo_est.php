...
<html>
	<head>
		...
		<title>FACTORES DE RIESGO EN ESTABLECIMIENTOS</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'FACTORES DE RIESGO - ESTABLECIMIENTOS DEL MUNICIPIO DE <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        subtitle: {
...
$sql4.=" AND carpeta_familiar.idestablecimiento_salud='$row3[0]' GROUP BY integrante_factor_riesgo.idintegrante_cf ";
