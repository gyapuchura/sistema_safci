...
<html>
	<head>
		...
		<title>EVALUACION RIESGO DE SERVICIOS BASICOS - ÁREA DE INFLUENCIA </title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO EN LOS SERVICIOS BÁSICOS - ÁREA DE INFLUENCIA <?php echo mb_strtoupper($area_af);?>'
                },
                subtitle: {
