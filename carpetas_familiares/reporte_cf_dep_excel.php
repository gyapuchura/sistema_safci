...
header("Content-Disposition: attachment; filename=REPORTE CARPETA FAMILIAR DEPARTAMENTO.xls");
...
<h4 style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">REPORTE DE CARPETAS FAMILIARES A NIVEL DE DEPARTAMENTO</h4>
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" AND area_influencia.idtipo_area_influencia=tipo_area_influencia.idtipo_area_influencia AND carpeta_familiar.idarea_influencia=area_influencia.idarea_influencia AND carpeta_familiar.iddepartamento='$iddepartamento' ";
