...
<html>
	<head>
		...
		<title>MEDICINA TRADICINAL - MEDICO OPERATIVO</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'MEDICINA TRADICIONAL - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
...
$sql2.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' GROUP BY integrante_tradicional.idlugar_atencion_trad ";
...
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">TOTAL DE CARPETAS FAMILIARES - MEDICO OPERATIVO = <?php echo $total_cf;?> </h4></spam>
...
?>
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">N° DE INTEGRANTES DE FAMILIA REGISTRADOS POR EL MEDICO OPERATIVO= <?php echo $integrantes;?> </h4></spam>
