...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf' ";
...
<html>
	<head>
		...
		<title>PIRÁMIDE MORBILIDAD - DEPARTAMENTO</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE MORBILIDAD - DEPARTAMENTO <?php echo mb_strtoupper($departamento_cf);?> - <?php echo mb_strtoupper($morbilidad_cf);?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND carpeta_familiar.iddepartamento='$iddepartamento' AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf'  ";
