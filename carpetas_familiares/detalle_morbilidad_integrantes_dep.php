...
<head>
  ...
  <title>DETALLE MORBILIDAD DE INTEGRANTES - DEPARTAMENTO</title>
</head>
	<body>
  ...
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;"><?php echo "DEPARTAMENTO: ".mb_strtoupper($departamento_cf);?></h3>
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
