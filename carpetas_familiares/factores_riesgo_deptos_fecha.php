...
<html>
	<head>
		...
		<title>FACTORES DE RIESGO DEPARTAMENTOS</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'FACTOR DE RIESGO - <?php echo $row_fr[1];?>'
        },
        subtitle: {
...
$sql_a.=" AND carpeta_familiar.iddepartamento='$row3[0]' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
