...
<html>
	<head>
		...
		<title>PROFESION - ESTABLECIMIENTO </title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'PROFESIÓN DE LOS INTEGRANTES DE LA FAMILIA - ESTABLECIMIENTO  DE <?php echo mb_strtoupper($row_est[1]);?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT integrante_datos_cf.idprofesion FROM integrante_datos_cf, carpeta_familiar, integrante_cf ";
                    ...
                    $sql.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY integrante_datos_cf.idprofesion ";
                    ...
                    $sql_c.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND integrante_datos_cf.idprofesion='$row[0]' ";
...
<?php
$numeroa = 1;
$sqla = " SELECT integrante_datos_cf.idprofesion, profesion.profesion FROM integrante_datos_cf, carpeta_familiar, profesion ";
$sqla.= " WHERE  integrante_datos_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND integrante_datos_cf.idprofesion=profesion.idprofesion AND carpeta_familiar.estado='CONSOLIDADO' ";
$sqla.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY integrante_datos_cf.idprofesion ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c = " SELECT count(integrante_datos_cf.idintegrante_datos_cf) FROM integrante_datos_cf, carpeta_familiar, integrante_cf ";
    $sql_c.= " WHERE integrante_datos_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_cf.estado='CONSOLIDADO' ";
    $sql_c.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND integrante_datos_cf.idprofesion='$rowa[0]' ";
    $result_c = mysqli_query($link,$sql_c);
    $row_c = mysqli_fetch_array($result_c);
    $conteoa = $row_c[0];
...
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">INTEGRANTES CON REGISTRO - PROFESIÓN = <?php echo $total;?> </h4></spam>
