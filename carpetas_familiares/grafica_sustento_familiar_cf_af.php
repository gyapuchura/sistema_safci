...
<html>
	<head>
		...
		<title>SUSTENTO FAMILIAR - ÁREA DE INFLUENCIA</title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'INTEGRANTES QUE CONTRIBUYEN AL SUSTENTO DE LA FAMILIA - ÁREA DE INFLUENCIA: <?php echo mb_strtoupper($area_af);?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' GROUP BY integrante_datos_cf.idcontribuye_cf ";
                    ...
                    $sql_c.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' AND integrante_datos_cf.idcontribuye_cf='$row[0]' ";
...
$sqla.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' GROUP BY integrante_datos_cf.idcontribuye_cf ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' AND integrante_datos_cf.idcontribuye_cf='$rowa[0]' ";
    $result_c = mysqli_query($link,$sql_c);
    $row_c = mysqli_fetch_array($result_c);
    $conteoa = $row_c[0];
