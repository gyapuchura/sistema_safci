...
<head>
  ...
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">MÉDICO: <?php echo $operativo;?></h3>
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf' AND carpeta_familiar.idusuario='$idusuario' ";
