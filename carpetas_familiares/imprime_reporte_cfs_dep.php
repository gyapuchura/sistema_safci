...
<head>
    ...
    <title>REPORTE CARPETAS FAMILIARES DEPARTAMENTO</title>
</head>
<body>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'REGISTRO DE CARPETAS FAMILIARES - DEPARTAMENTO <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
<h4 style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">CARPETAS FAMILIARES A NIVEL DE DEPARTAMENTO</h4>
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" AND area_influencia.idtipo_area_influencia=tipo_area_influencia.idtipo_area_influencia AND carpeta_familiar.idarea_influencia=area_influencia.idarea_influencia AND carpeta_familiar.iddepartamento='$iddepartamento' ORDER BY carpeta_familiar.idcarpeta_familiar DESC LIMIT 100 ";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
