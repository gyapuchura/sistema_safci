...
$sql_p =" SELECT idintegrante_cf FROM integrante_cf WHERE idnombre='$idnombre_persona' AND idcarpeta_familiar='$idcarpeta_familiar_ss'";
$result_p=mysqli_query($link,$sql_p);
if ($row_p=mysqli_fetch_array($result_p)) 
{

header("Location:mensaje_ci_existe_cf.php");
    ...
    $sql2.= " VALUES ('$idcarpeta_familiar_ss','$idnombre_persona','$edad','$idgrupo_etareo_cf','$idparentesco','$idnacion','$fecha','$hora','$idusuario_ss') ";
