...
<head>
  ...
  <title>DISCPACIDAD ESTABLECIMIENTO</title>
...
<h2><?php echo $discapacidad;?> <?php echo $nivel;?> -  ESTABLECIMIENTO : <?php echo mb_strtoupper($row_est[1]);?></h2>
...
var area_influencia ={"type":"FeatureCollection","features":[
        ...
        $sql5.= " AND ubicacion_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
