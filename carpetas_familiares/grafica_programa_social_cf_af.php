...
<html>
	<head>
		...
		<title>PROGRAMAS SOCIALES SALUD FAMILIAR - ÁREA DE INFLUENCIA</title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'BENEFICIARIOS DE PROGRAMAS SOCIALES - ÁREA DE INFLUENCIA :  <?php echo mb_strtoupper($area_af);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idarea_influencia='$idarea_influencia' GROUP BY integrante_beneficiario.idprograma_social ";
