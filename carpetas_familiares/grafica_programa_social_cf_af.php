        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idarea_influencia='$idarea_influencia' GROUP BY integrante_beneficiario.idprograma_social ";
...
$sqla.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' GROUP BY integrante_beneficiario.idprograma_social ";
