...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf' ";
        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf'  ";
