...
<head>
  ...
  <title>FACTORES DE RIESGO - ESTABLECIMIENTO</title>
...
<h2><?php echo $riesgo;?> - ESTABLECIMIENTO : <?php echo mb_strtoupper($row_est[1]);?></h2>

<a href="detalle_salud_integrantes_est.php?idestablecimiento_salud=<?php echo $idestablecimiento_salud;?>&idfactor_riesgo_cf=<?php echo $idfactor_riesgo_cf;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=700,height=800,scrollbars=YES,top=60,left=700'); return false;">             
...
var area_influencia ={"type":"FeatureCollection","features":[
        ...
        $sql5.= " FROM integrante_cf, nombre, integrante_factor_riesgo, carpeta_familiar, ubicacion_cf WHERE integrante_factor_riesgo.idintegrante_cf=integrante_cf.idintegrante_cf ";
        $sql5.= " AND integrante_cf.idnombre=nombre.idnombre AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar ";
        $sql5.= " AND ubicacion_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar  ";
        $sql5.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf' ";
...
var markers = L.markerClusterGroup();
        ...
        var Icono = L.icon({
        iconUrl: "../sala_situacional/marcadores/marcador_naranja.png",
        iconSize: [35, 35],
        iconAnchor: [15, 40],
  ...
  onEachFeature: function(feature, layer) {
    ...
    if (feature.properties) {
      layer.bindPopup(
        ...
        '<p><b>Factor de Riesgo : </b> ' + feature.properties.FACTOR_R + '</p>' +
