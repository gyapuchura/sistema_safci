...
<html>
	<head>
		...
		<title>PIRÁMIDE FACTORES DE RIESGO - ESTABLECIMIENTO</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE FACTORES DE RIESGO - ESTABLECIMIENTO: <?php echo mb_strtoupper($establecimiento);?> - <?php echo mb_strtoupper($riesgo);?>'
            },
            subtitle: {
