...
<html>
	<head>
		...
		<title>PIRÁMIDE MORBILIDAD - ESTABLECIMIENTO DE SALUD</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE MORBILIDAD - ESTABLECIMIENTO: <?php echo mb_strtoupper($establecimiento_salud_cf);?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    <?php
                    $sql7 = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_morbilidad, integrante_cf, nombre, carpeta_familiar WHERE integrante_cf.idnombre=nombre.idnombre  ";
                    $sql7.= " AND integrante_morbilidad.idintegrante_cf=integrante_cf.idintegrante_cf AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar ";
