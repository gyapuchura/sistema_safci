...
$(function () {
    $('#seguridad_alimentaria').highcharts({
        chart: {
            type: 'column'
        },
        title: {
...
?>
        ...
        yAxis: {
            min: 0,
            title: {
                text: 'Encuesta para grados de seguridad alimentaria'
            }
        },
        tooltip: {
...
<div id="seguridad_alimentaria" style="min-width: 410px; height: 400px; margin: 0 auto"></div>
