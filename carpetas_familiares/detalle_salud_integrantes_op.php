...
<head>
  ...
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">MÉDICO: <?php echo mb_strtoupper($operativo);?></h3>
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf' AND carpeta_familiar.idusuario='$idusuario' ";
