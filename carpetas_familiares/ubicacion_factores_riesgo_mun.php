...
<head>
  ...
  <title>FACTORES DE RIESGO - MUNICIPIO</title>
...
<h2><?php echo $riesgo;?> - MUNICIPIO : <?php echo mb_strtoupper($row_mun[1]);?></h2>

<a href="factores_riesgo_establecimientos.php?idmunicipio=<?php echo $idmunicipio;?>&idfactor_riesgo_cf=<?php echo $idfactor_riesgo_cf;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=900,height=800,scrollbars=YES,top=60,left=700'); return false;">             
ESTABLECIMIENTOS DEL MUNICIPIO</a>
</br></br>
<div id="safci"></div>
...
var area_influencia ={"type":"FeatureCollection","features":[
        ...
        $sql5.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf' ";
