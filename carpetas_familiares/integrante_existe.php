...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <h4 class="text-info">AGREGA INTEGRANTE</h4>
                    <hr> 
                    </div>

    <!-------- begin NUEVO PACIENTE --------->   
                <div class="text-center">                                     
                    <h4 class="text-info">LA CÉDULA DE IDENTIDAD A INCLUIR CORRESPONDE A:</h4>                    
                </div>
                <hr> 
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel">REGISTRO DE INTEGRANTE FAMILIAR</h5>
                        ...
                        <div class="modal-body">
                            ...
                            Esta seguro de Registrar AL INTEGRANTE FAMILIAR?
