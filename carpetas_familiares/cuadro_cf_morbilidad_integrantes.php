...
<h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">INTEGRANTES DE LA FAMILIA CON MORBILIDAD</h2>
        ...
        <?php
        $numero=1;
        $sql =" SELECT integrante_morbilidad.idmorbilidad_cf, morbilidad_cf.morbilidad_cf FROM integrante_morbilidad, ubicacion_cf, carpeta_familiar, morbilidad_cf ";
        $sql.=" WHERE integrante_morbilidad.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND ubicacion_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar  ";
        $sql.=" AND integrante_morbilidad.idmorbilidad_cf=morbilidad_cf.idmorbilidad_cf AND carpeta_familiar.estado='CONSOLIDADO' ";
        $sql.=" AND ubicacion_cf.idarea_influencia='$idarea_influencia' GROUP BY integrante_morbilidad.idmorbilidad_cf  ";
