...
$sql_a =" SELECT COUNT(idintegrante_ap_sano) FROM integrante_ap_sano WHERE fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
$sql_a.="  ";
$result_a = mysqli_query($link,$sql_a);
$row_a = mysqli_fetch_array($result_a);
$aparentemente_sano = $row_a[0];

$sql_b =" SELECT idintegrante_cf FROM integrante_factor_riesgo WHERE fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY idintegrante_cf ";
$sql_b.="  ";
$result_b = mysqli_query($link,$sql_b);
$factor_riesgo = mysqli_num_rows($result_b);

$sql_c =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$sql_c.="  ";
$result_c = mysqli_query($link,$sql_c);
$row_c = mysqli_fetch_array($result_c);
$morbilidad =$row_c[0];

$sql_d =" SELECT COUNT(idintegrante_discapacidad) FROM integrante_discapacidad WHERE fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$sql_d.="  ";
...
$(function () {
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            <?php
                $sql_t =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_t.="  ";
                $result_t = mysqli_query($link,$sql_t);
                $row_t = mysqli_fetch_array($result_t);
                $total = $row_t[0];

                $sql_a =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='1' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_a.="  ";
                $result_a = mysqli_query($link,$sql_a);
                $row_a = mysqli_fetch_array($result_a);
                $sedentarismo = $row_a[0];

                $sql_b =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='2' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_b.="  ";
                $result_b = mysqli_query($link,$sql_b);
                $row_b = mysqli_fetch_array($result_b);
                $consume_alcohol = $row_b[0];

                $sql_c =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='3' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_c.="  ";
                $result_c = mysqli_query($link,$sql_c);
                $row_c = mysqli_fetch_array($result_c);
                $fumar =$row_c[0];

                $sql_d =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='4' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_d.="  ";
                $result_d = mysqli_query($link,$sql_d);
                $row_d = mysqli_fetch_array($result_d);
                $drogas = $row_d[0];

                $sql_e =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='5' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_e.="  ";
                $result_e = mysqli_query($link,$sql_e);
                $row_e = mysqli_fetch_array($result_e);
                $promiscuidad = $row_e[0];

                $sql_f =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='6' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_f.="  ";
                $result_f = mysqli_query($link,$sql_f);
                $row_f = mysqli_fetch_array($result_f);
                $gaseosas = $row_f[0];

                $sql_g =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='7' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_g.="  ";
                $result_g = mysqli_query($link,$sql_g);
                $row_g = mysqli_fetch_array($result_g);
                $frituras =$row_g[0];

                $sql_h =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='8' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_h.="  ";
                $result_h = mysqli_query($link,$sql_h);
                $row_h = mysqli_fetch_array($result_h);
                $conservas = $row_h[0];

                $sql_i =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='9' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_i.="  ";
                $result_i = mysqli_query($link,$sql_i);
                $row_i = mysqli_fetch_array($result_i);
                $golosinas = $row_i[0];

                $sql_j =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='10' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_j.="  ";
                $result_j = mysqli_query($link,$sql_j);
                $row_j = mysqli_fetch_array($result_j);
                $sal = $row_j[0];

                $sql_k =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='11' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_k.="  ";
                $result_k = mysqli_query($link,$sql_k);
                $row_k = mysqli_fetch_array($result_k);
                $piezas =$row_k[0];

                $sql_l =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='12' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_l.="  ";
                $result_l = mysqli_query($link,$sql_l);
                $row_l = mysqli_fetch_array($result_l);
                $menor = $row_l[0];

                $sql_m =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='13' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_m.="  ";
                $result_m = mysqli_query($link,$sql_m);
                $row_m = mysqli_fetch_array($result_m);
                $embarazo = $row_m[0];

                $sql_n =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='14' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_n.="  ";
                $result_n = mysqli_query($link,$sql_n);
                $row_n = mysqli_fetch_array($result_n);
                $mayor = $row_n[0];

                $sql_o =" SELECT COUNT(idintegrante_factor_riesgo) FROM integrante_factor_riesgo WHERE idfactor_riesgo_cf='15' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_o.="  ";
...
$(function () {
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            <?php
                $sql_t =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
                $sql_t.="  ";
                $result_t = mysqli_query($link,$sql_t);
                $row_t = mysqli_fetch_array($result_t);
                $total = $row_t[0];

                $sql_a =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='1' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_a.="  ";
                $result_a = mysqli_query($link,$sql_a);
                $row_a = mysqli_fetch_array($result_a);
                $tuberculosis = $row_a[0];

                $sql_b =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='2' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_b.="  ";
                $result_b = mysqli_query($link,$sql_b);
                $row_b = mysqli_fetch_array($result_b);
                $sexual = $row_b[0];

                $sql_c =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='3' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_c.="  ";
                $result_c = mysqli_query($link,$sql_c);
                $row_c = mysqli_fetch_array($result_c);
                $malaria =$row_c[0];

                $sql_d =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='4' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_d.="  ";
                $result_d = mysqli_query($link,$sql_d);
                $row_d = mysqli_fetch_array($result_d);
                $lepra = $row_d[0];

                $sql_e =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='5' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_e.="  ";
                $result_e = mysqli_query($link,$sql_e);
                $row_e = mysqli_fetch_array($result_e);
                $leishmaniasis = $row_e[0];

                $sql_f =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='6' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_f.="  ";
                $result_f = mysqli_query($link,$sql_f);
                $row_f = mysqli_fetch_array($result_f);
                $chagas = $row_f[0];

                $sql_g =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='7' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_g.="  ";
                $result_g = mysqli_query($link,$sql_g);
                $row_g = mysqli_fetch_array($result_g);
                $hepatitis =$row_g[0];

                $sql_h =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='8' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_h.="  ";
                $result_h = mysqli_query($link,$sql_h);
                $row_h = mysqli_fetch_array($result_h);
                $cardiovascular = $row_h[0];

                $sql_i =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='9' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_i.="  ";
                $result_i = mysqli_query($link,$sql_i);
                $row_i = mysqli_fetch_array($result_i);
                $hipertension = $row_i[0];

                $sql_j =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='10' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_j.="  ";
                $result_j = mysqli_query($link,$sql_j);
                $row_j = mysqli_fetch_array($result_j);
                $diabetes = $row_j[0];

                $sql_k =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='11' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_k.="  ";
                $result_k = mysqli_query($link,$sql_k);
                $row_k = mysqli_fetch_array($result_k);
                $obesidad =$row_k[0];

                $sql_l =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='12' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_l.="  ";
                $result_l = mysqli_query($link,$sql_l);
                $row_l = mysqli_fetch_array($result_l);
                $renal = $row_l[0];

                $sql_m =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='13' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_m.="  ";
                $result_m = mysqli_query($link,$sql_m);
                $row_m = mysqli_fetch_array($result_m);
                $reumatica = $row_m[0];

                $sql_n =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='14' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_n.="  ";
                $result_n = mysqli_query($link,$sql_n);
                $row_n = mysqli_fetch_array($result_n);
                $pulmonar = $row_n[0];

                $sql_o =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='15' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_o.="  ";
                $result_o = mysqli_query($link,$sql_o);
                $row_o = mysqli_fetch_array($result_o);
                $autoinmune = $row_o[0];

                $sql_p =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='16' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_p.="  ";
                $result_p = mysqli_query($link,$sql_p);
                $row_p = mysqli_fetch_array($result_p);
                $hematologica = $row_p[0];

                $sql_q =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='17' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_q.="  ";
                $result_q = mysqli_query($link,$sql_q);
                $row_q = mysqli_fetch_array($result_q);
                $asma = $row_q[0];

                $sql_r =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='18' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_r.="  ";
                $result_r = mysqli_query($link,$sql_r);
                $row_r = mysqli_fetch_array($result_r);
                $cancer = $row_r[0];

                $sql_s =" SELECT COUNT(idintegrante_morbilidad) FROM integrante_morbilidad WHERE idmorbilidad_cf='19' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
                $sql_s.="  ";
...
<?php
$sql_a =" SELECT COUNT(idintegrante_discapacidad) FROM integrante_discapacidad WHERE idtipo_discapacidad_cf='$row3[0]' AND idnivel_discapacidad_cf='$row2[0]' AND fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
$result_a = mysqli_query($link,$sql_a);
$row_a = mysqli_fetch_array($result_a);
?>
<?php echo $row_a[0]; ?>
...
while ($field3 = mysqli_fetch_field($result3)){
	...
	?>
        ...
        $sql_a.= " AND integrante_discapacidad.idtipo_discapacidad_cf='$row3[0]' AND integrante_discapacidad.idnivel_discapacidad_cf='$row2[0]' AND integrante_discapacidad.fecha_registro BETWEEN '$inicio' AND '$finalizacion'";
        $result_a = mysqli_query($link,$sql_a);
        $row_a = mysqli_fetch_array($result_a);
        ?>
        <?php echo $row3[1]; ?>
