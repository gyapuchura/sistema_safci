...
header("Content-Disposition: attachment; filename=REPORTE CARPETIZACION OPERATIVOS.xls");
	...
	<table width="900" border="1" align="center" cellpadding="1" cellspacing="0">
	  <tbody>
        <tr>
            ...
            <td width="205" style="font-family: Arial; font-size: 12px; text-align: center; color: #294D7C;"><strong>ÁREA DE INFLUENCIA</strong></td>
            <td width="361" style="font-family: Arial; font-size: 12px; text-align: center; color: #294D7C;"><strong>MÉDICO OPERATIVO</strong></td>
            <td width="235" style="font-family: Arial; font-size: 12px; text-align: center; color: #294D7C;"><strong>ESTABLECIMIENTO DE SALUD</strong></td>
