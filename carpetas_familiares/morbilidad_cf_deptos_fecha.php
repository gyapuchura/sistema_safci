...
<html>
	<head>
		...
		<title>MORBILIDAD POR DEPARTAMENTOS</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'MORBILIDAD - <?php echo $row_mr[1];?>'
        },
        subtitle: {
...
$sql_a.=" WHERE integrante_morbilidad.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.estado='CONSOLIDADO' ";
$sql_a.=" AND carpeta_familiar.iddepartamento='$row3[0]' AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
