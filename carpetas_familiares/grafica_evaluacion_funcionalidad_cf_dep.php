...
<html>
	<head>
		...
		<title>FUNCIONALIDAD FAMILIAR - DEPTAL</title>
...
?>
            ...
            $('#funcionalidad_cf').highcharts({
                ...
                title: {
                    text: 'FUNCIONALIDAD FAMILIAR - Departamento: <?php echo mb_strtoupper($row_dep[1]);?>'
                },
                subtitle: {
...
?>
            ...
            $('#disfuncionalidad_cf').highcharts({
                ...
                title: {
                    text: 'DISFUNCIONALIDAD FAMILIAR - Departamento: <?php echo mb_strtoupper($row_dep[1]);?>'
                },
                subtitle: {
                    text: 'Fuente: Sistema Medi-Safci al <?php echo $f_emision;?>'
                },
...
$(function () {
    $('#evaluacion_funcionalidad').highcharts({
        ...
        title: {
            text: 'EVALUACIÓN FUNCIONALIDAD FAMILIAR - Departamento: <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
