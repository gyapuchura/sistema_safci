...
$sql_i.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='9' ";
...
$sql_j.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='10' ";
...
$sql_k.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='11' ";
...
$sql_l.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='12' ";
...
$sql_8.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='1' ";
...
$sql_b.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='2' ";
...
$sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='3' ";
...
$sql_d.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='4' ";
...
$sql_e.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='5' ";
...
$sql_f.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='6' ";
...
$sql_g.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='7' ";
...
$sql_h.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND funcionalidad_familiar_cf.idfuncionalidad_familiar ='8' ";
...
?>
            ...
            $('#disfuncionalidad_cf').highcharts({
                ...
                title: {
                    text: 'DISFUNCIONALIDAD FAMILIAR - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
                },
                subtitle: {
                    text: 'Fuente: Sistema Medi-Safci al <?php echo $f_emision;?>'
                },
