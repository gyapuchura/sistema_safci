...
$idusuario = $_GET["idusuario_op"];
  ...
  $sql_u =" SELECT dato_laboral.iddato_laboral, departamento.departamento, red_salud.red_salud, municipios.municipio, establecimiento_salud.establecimiento_salud, nombre.nombre, nombre.paterno, nombre.materno, nombre.ci  ";   
  ...
  $sql_u.=" AND establecimiento_salud.idmunicipio=municipios.idmunicipio AND dato_laboral.idusuario='$idusuario' ORDER BY dato_laboral.iddato_laboral DESC LIMIT 1 ";
      ...
      <td colspan="4"><table width="900" border="1" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px;"><?php echo mb_strtoupper($row_u[5]." ".$row_u[6]." ".$row_u[7]);?></td>
          </tr>
          <tr>
            <td style="font-family: Arial; font-size: 12px;">CEDULA DE IDENTIDAD:</td>
            <td style="font-family: Arial; font-size: 12px;"><?php echo $row_u[8];?></td>
          </tr>
        </tbody>
      </table></td>
    </tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql4.=" AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idusuario='$idusuario' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql5.=" AND integrante_cf.edad BETWEEN '0' AND '4'  AND carpeta_familiar.idusuario='$idusuario' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql6.=" AND integrante_cf.edad BETWEEN '60' AND '160'  AND carpeta_familiar.idusuario='$idusuario' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_1.=" AND integrante_cf.edad BETWEEN '0' AND '1'  AND carpeta_familiar.idusuario='$idusuario' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_2.=" AND integrante_cf.idnombre=nombre.idnombre AND nombre.idgenero='1' AND integrante_cf.edad BETWEEN '15' AND '49' AND carpeta_familiar.idusuario='$idusuario'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_3.=" AND integrante_factor_riesgo.idfactor_riesgo_cf='13' AND integrante_cf.edad BETWEEN '10' AND '19' AND carpeta_familiar.idusuario='$idusuario'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_4.=" AND integrante_factor_riesgo.idfactor_riesgo_cf='13' AND carpeta_familiar.idusuario='$idusuario'  ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              <?php
                ...
                $sql_5.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' ";
...
?>
    ...
    <tr>
      ...
      <td colspan="2"><table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <?php
                $sql_t =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE  estado='CONSOLIDADO' AND idusuario='$idusuario' ";
                ...
                $sql_b.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_e.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' ";
    ...
    <tr>
      ...
      <table width="450" border="1" cellspacing="0">
        ...
        ?>
            ...
            $sql_m.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' AND integrante_morbilidad.idmorbilidad_cf='$row[0]' ";
        ...
        <tbody>
          <tr>
            ...
            <td width="38" style="font-family: Arial; font-size: 12px; text-align: center;">%</td>
                    ...
                    $sql_ff.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' ";
      ...
      <table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <?php 
              ...
              $sql_td.= " AND carpeta_familiar.idusuario='$idusuario' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              ...
              $sql_a.= " AND integrante_discapacidad.idtipo_discapacidad_cf='$row3[0]' AND carpeta_familiar.idusuario='$idusuario' ";
              $result_a = mysqli_query($link,$sql_a);
              $row_a = mysqli_fetch_array($result_a);
              echo $row_a[0];
    ...
    $sql_cf.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' GROUP BY seguimiento_cf.idcarpeta_familiar ";
    $result_cf = mysqli_query($link,$sql_cf);
    ...
    <table width="450" border="1" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
            <?php 
            $sql_seg =" SELECT count(idseguimiento_cf) FROM seguimiento_cf WHERE idusuario='$idusuario' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
              <?php 
              $sql_pr =" SELECT count(idvisita_cf) FROM visita_cf WHERE idusuario='$idusuario' ";
          ...
          <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: center;">
            <?php 
              $sql_re =" SELECT count(idvisita_cf) FROM visita_cf WHERE idestado_visita_cf='3' AND idusuario='$idusuario' ";
    ...
    <?php
      ...
      $sqlus.=" AND usuarios.idusuario='$idusuario' ";
      $resultus = mysqli_query($link,$sqlus);
      $rowus = mysqli_fetch_array($resultus);?>
    <tr>
      <td style="font-family: Arial; font-size: 12px;">&nbsp;</td>
      <td style="font-family: Arial; font-size: 12px; text-align: center;">Yo :  <?php echo mb_strtoupper($rowus[0]." ".$rowus[1]." ".$rowus[2]);?></br></br> Declaro la veracidad de la información del presente documento.</td>
 ...
 */
    ...
    $_REQUEST['data'] = 'https://virtual-safci.minsalud.gob.bo/medi-safci/carpetas_familiares/informe_operativo.php?idusuario='.$idusuario;
    $_REQUEST['size'] = 2 ;
