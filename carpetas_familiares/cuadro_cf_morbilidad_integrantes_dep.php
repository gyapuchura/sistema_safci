...
<head>
    ...
    <title>INTEGRANTES CON MORBILIDAD - DEPARTAMENTO</title>
</head>
<body>

<h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">DEPARTAMENTO: <?php echo mb_strtoupper($departamento_cf);?></h2>
...
<h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">INTEGRANTES DE LA FAMILIA CON MORBILIDAD</h2>
        ...
        $sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' AND integrante_morbilidad.idmorbilidad_cf='$row[0]' ";
        ...
        $row_c = mysqli_fetch_array($result_c);
          ...
          <?php echo $row_c[0];?>
              ...
              <td style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">
              <a href="piramide_morbilidad_dep.php?iddepartamento=<?php echo $iddepartamento;?>&idmorbilidad_cf=<?php echo $row[0];?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=600'); return false;">             
              VER PIRAMIDE</a>
              </td>
	        </tr>
        <?php
