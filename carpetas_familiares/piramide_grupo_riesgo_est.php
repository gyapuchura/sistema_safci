...
<html>
	<head>
		...
		<title>PIRÁMIDE FACTORES DE RIESGO - ESTABLECIMIENTO DE SALUD</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE FACTORES DE RIESGO - ESTABLECIMIENTO: <?php echo mb_strtoupper($establecimiento_salud_cf);?>'
            },
            subtitle: {
