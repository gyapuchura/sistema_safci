        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idarea_influencia='$idarea_influencia' AND estructura_familiar_cf.vigente='SI' ";
                    ...
                    $sql.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idarea_influencia='$idarea_influencia' AND estructura_familiar_cf.vigente='SI' GROUP BY estructura_familiar_cf.idestructura_familiar ";
                    ...
                    $sql_c.= " AND ubicacion_cf.idarea_influencia='$idarea_influencia' AND estructura_familiar_cf.vigente='SI' AND estructura_familiar_cf.idestructura_familiar='$row[0]' ";
