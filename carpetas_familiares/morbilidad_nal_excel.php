...
header("Content-Disposition: attachment; filename=REPORTE MORBILIDAD NACIONAL.xls");
...
<body>
    <span style="font-family: Arial; font-size: 14px;"><h4 align="center">REPORTE NACIONAL </h4></spam>
	...
	<table width="850" border="1" align="center" cellspacing="0">
	  <tbody>
        ...
        <?php
            ...
            $sql2.= "  GROUP BY carpeta_familiar.idestablecimiento_salud ";
