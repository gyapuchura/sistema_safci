...
<html>
	<head>
		...
		<title>COMBUSTIBLE PARA COCINAR</title>
...
$(function () {
    $('#combustible_cocina').highcharts({
        ...
        title: {
            text: 'f) COMBUSTIBLE PARA COCINAR - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        subtitle: {
...
<div id="combustible_cocina" style="height: 350px"></div>
...
<table width="646" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="315" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">COMBUSTIBLE PARA COCINAR</span></td>
