...
<?php 
        $sql0 = " SELECT idcarpeta_familiar FROM carpeta_familiar WHERE estado='CONSOLIDADO' ";
        $result0 = mysqli_query($link,$sql0);
        $total = mysqli_num_rows($result0);
?>
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">TOTAL DE FAMILIAS = <?php echo $total;?> </h4></spam>
