...
<h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">INTEGRANTES DE LA FAMILIA CON DISCAPACIDAD - ESTABLECIMIENTO DE SALUD <?php echo mb_strtoupper($row_est[1]);?></h2>
