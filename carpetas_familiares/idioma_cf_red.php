...
<html>
	<head>
		...
		<title>IDIOMA RED DE SALUD</title>
...
$(function () {
    $('#hablado').highcharts({
        ...
        title: {
            text: 'IDIOMA HABLADO DE LAS FAMILIAS - RED DE SALUD <?php echo $red_salud_cf;?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND idioma_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idred_salud='$idred_salud' ";
                    ...
                    $sql.= " AND carpeta_familiar.idred_salud='$idred_salud' AND idioma_cf.idorigen_idioma ='1' GROUP BY idioma_cf.ididioma "; 
                    ...
                    $sql_c.=" AND idioma_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idred_salud='$idred_salud' AND idioma_cf.ididioma ='$row[0]' ";
...
$(function () {
    $('#materno').highcharts({
        ...
        title: {
            text: 'IDIOMA MATERNO DE LAS FAMILIAS - RED DE SALUD <?php echo $red_salud_cf;?>'
        },
        subtitle: {
            text: 'Fuente: Sistema Medi-Safci al <?php echo $f_emision;?>'
        },
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT idioma_cf.ididioma FROM idioma_cf, carpeta_familiar WHERE idioma_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar  ";
                    $sql.= " AND carpeta_familiar.idred_salud='$idred_salud' AND idioma_cf.idorigen_idioma ='2' GROUP BY idioma_cf.ididioma "; 
                    $result = mysqli_query($link,$sql);
                    $conteo_tipo = mysqli_num_rows($result);
...
$sqla.= " AND carpeta_familiar.idred_salud='$idred_salud' AND idioma_cf.idorigen_idioma ='1' GROUP BY idioma_cf.ididioma "; 
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c = " SELECT count(idioma_cf.ididioma_cf) FROM idioma_cf, carpeta_familiar WHERE idioma_cf.idorigen_idioma ='1'  ";
    $sql_c.= " AND idioma_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.idred_salud='$idred_salud' AND idioma_cf.ididioma ='$rowa[0]' ";
    $result_c = mysqli_query($link,$sql_c);
    $row_c = mysqli_fetch_array($result_c);
    $conteoa = $row_c[0];
...
$numeroa = 1;
$sqla = " SELECT idioma_cf.ididioma FROM idioma_cf, carpeta_familiar WHERE idioma_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar  ";
$sqla.= " AND carpeta_familiar.idred_salud='$idred_salud' AND idioma_cf.idorigen_idioma ='2' GROUP BY idioma_cf.ididioma "; 
$resulta = mysqli_query($link,$sqla);
 if ($rowa = mysqli_fetch_array($resulta)){
mysqli_field_seek($resulta,0);
while ($fielda = mysqli_fetch_field($resulta)){
