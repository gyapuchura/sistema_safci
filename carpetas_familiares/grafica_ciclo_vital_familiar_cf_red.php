...
$(function () {
    $('#ciclo_vital').highcharts({
        ...
        title: {
            text: 'ETAPA DEL CICLO VITAL FAMILIAR - Red de Salud: <?php echo mb_strtoupper($row_red[1]);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idred_salud='$idred_salud' AND etapa_familiar_cf.vigente='SI' ";
                    ...
                    $sql.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idred_salud='$idred_salud' AND etapa_familiar_cf.vigente='SI' GROUP BY etapa_familiar_cf.idetapa_familiar ";
                    ...
                    $sql_c.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idred_salud='$idred_salud' AND etapa_familiar_cf.vigente='SI' AND etapa_familiar_cf.idetapa_familiar='$row[0]' ";
