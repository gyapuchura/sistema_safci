...
$sql_af = " SELECT idestablecimiento_salud, establecimiento_salud FROM establecimiento_salud WHERE idestablecimiento_salud='$idestablecimiento_salud' ";
$result_af = mysqli_query($link,$sql_af);
$row_af = mysqli_fetch_array($result_af);
$establecimiento_salud_cf = $row_af[1];
...
<html>
	<head>
		...
		<title>PIRÁMIDE DISCAPACIDAD - ESTABLECIMIENTO DE SALUD</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE DISCAPACIDAD - ESTABLECIMIENTO: <?php echo mb_strtoupper($establecimiento_salud_cf);?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    <?php
                    $sql7 = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_discapacidad, integrante_cf, nombre, carpeta_familiar WHERE integrante_cf.idnombre=nombre.idnombre  ";
                    $sql7.= " AND integrante_discapacidad.idintegrante_cf=integrante_cf.idintegrante_cf AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar ";
                    $sql7.= " AND integrante_cf.idgrupo_etareo_cf='$row2[0]' AND nombre.idgenero='2' AND integrante_cf.estado='CONSOLIDADO' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
                ...
                data: [
                    <?php
                        ...
                        $sql7 = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_discapacidad, integrante_cf, nombre, carpeta_familiar WHERE integrante_cf.idnombre=nombre.idnombre ";
                        $sql7.= " AND integrante_discapacidad.idintegrante_cf=integrante_cf.idintegrante_cf AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar ";
                        $sql7.= " AND integrante_cf.idgrupo_etareo_cf='$row3[0]' AND nombre.idgenero='1' AND integrante_cf.estado='CONSOLIDADO' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
                        $result7 = mysqli_query($link,$sql7);
                        $row7 = mysqli_fetch_array($result7);
