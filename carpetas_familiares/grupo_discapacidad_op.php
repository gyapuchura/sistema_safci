...
<html>
	<head>
		...
		<title>DISCAPACIDAD EN AREAS DE INFLUENCIA</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'DISCAPACIDAD - ÁREAS DE INFLUENCIA - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
        ...
        xAxis: {
            categories: [
                <?php 
$numero = 0;
$sql = " SELECT carpeta_familiar.idarea_influencia, area_influencia.area_influencia FROM integrante_discapacidad, carpeta_familiar, area_influencia ";
...
data: [
    ...
    <?php 
$numero3 = 0;
$sql3 = " SELECT carpeta_familiar.idarea_influencia FROM integrante_discapacidad, carpeta_familiar ";
