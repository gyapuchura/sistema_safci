...
<html>
	<head>
		...
		<title>APARENTEMENTE SANOS EN MUNICIPIOS</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'APARENTEMENTE SANOS - MUNICIPIOS DEL DEPARTAMENTO DE <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        subtitle: {
        ...
        xAxis: {
            categories: [
                <?php 
$numero = 0;
$sql = " SELECT carpeta_familiar.idmunicipio, municipios.municipio FROM integrante_ap_sano, carpeta_familiar, municipios ";
...
data: [
    ...
    <?php 
$numero3 = 0;
$sql3 = " SELECT carpeta_familiar.idmunicipio FROM integrante_ap_sano, carpeta_familiar ";
