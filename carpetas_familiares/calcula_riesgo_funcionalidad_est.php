...
<html>
	<head>
		...
		<title>RIESGO FUNCIONAL DE LA VIVIENDA - ESTABLECIMIENTO DE SALUD</title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO FUNCIONAL DE LA VIVIENDA - Establecimiento <?php echo mb_strtoupper($row_est[1]);?>'
                },
                subtitle: {
