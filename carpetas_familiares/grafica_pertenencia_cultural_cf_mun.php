...
<html>
	<head>
		...
		<title>AUTOPERTENENCIA CULTURAL - MUNICIPAL </title>
...
$(function () {
    $('#autopertenencia-cultural').highcharts({
        ...
        title: {
            text: 'AUTOPERTENENCIA CULTURAL DE LOS INTEGRANTES DE LA FAMILIA - MUNICIPIO DE <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.idmunicipio='$idmunicipio' GROUP BY integrante_cf.idnacion ";
                    ...
                    $sql_c.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND integrante_cf.idnacion='$row[0]' ";
