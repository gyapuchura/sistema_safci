...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf' ";
...
<html>
	<head>
		...
		<title>PIRÁMIDE FACTORES DE RIESGO - MEDICO OPERATIVO</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE FACTORES DE RIESGO - <?php echo mb_strtoupper($riesgo);?> - MÉDICO: <?php echo $operativo;?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND carpeta_familiar.idusuario='$idusuario' AND integrante_factor_riesgo.idfactor_riesgo_cf='$idfactor_riesgo_cf'  ";
