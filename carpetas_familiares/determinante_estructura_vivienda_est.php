...
$(function () {
    $('#tipo_vivienda').highcharts({
        ...
        title: {
            text: 'a) TIPO DE VIVIENDA - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY determinante_salud_cf.iditem_determinante_salud ";
                    ...
                    $sql_c.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idestablecimiento_salud='$idestablecimiento_salud' ";
...
$(function () {
    $('#paredes_vivienda').highcharts({
        ...
        title: {
            text: 'c) PAREDES DE LA VIVIENDA - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#pisos_vivienda').highcharts({
        ...
        title: {
            text: 'd). PISOS DE LA VIVIENDA - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#revoque_paredes').highcharts({
        ...
        title: {
            text: 'e). REVOQUE DE LAS PAREDES INTERIORES - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#cuarto_cocina').highcharts({
        ...
        title: {
            text: 'f) TIENE CUARTO SOLO PARA COCINAR - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$sql2.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idestablecimiento_salud='$idestablecimiento_salud' ";
...
$sql_a.=" AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idestablecimiento_salud='$idestablecimiento_salud' ";
...
$(function () {
    $('#riesgos_internos').highcharts({
        ...
        title: {
            text: 'h) RIESGOS INTERNOS CON RELACIÓN A LA VIVIENDA - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        subtitle: {
            text: 'Fuente: REGISTRO SISTEMA MEDI-SAFCI'
        },
