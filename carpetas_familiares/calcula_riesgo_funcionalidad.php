...
/************ Evaluamos para cada detrminante de la salud  BEGIN ************/
        ...
        $sqla = "SELECT sum(valor_cf)  FROM determinante_salud_cf WHERE idcarpeta_familiar='$row[0]' AND iddeterminante_salud='3' ";
...
<html>
	<head>
		...
		<title>RIESGO FUNCIONAL DE LA VIVIENDA</title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO FUNCIONAL DE LA VIVIENDA - NIVEL NACIONAL'
                },
                subtitle: {
