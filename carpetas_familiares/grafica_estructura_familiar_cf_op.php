...
$(function () {
    $('#suministro_agua').highcharts({
        ...
        title: {
            text: 'ESTRUCTURA FAMILIAR - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND carpeta_familiar.idusuario='$idusuario' AND estructura_familiar_cf.vigente='SI' ";
                    ...
                    $sql.= " AND carpeta_familiar.idusuario='$idusuario' AND estructura_familiar_cf.vigente='SI' GROUP BY estructura_familiar_cf.idestructura_familiar ";
                    ...
                    $sql_c.= " AND carpeta_familiar.idusuario='$idusuario' AND estructura_familiar_cf.vigente='SI' AND estructura_familiar_cf.idestructura_familiar='$row[0]' ";
