...
$(function () {
    $('#hablado').highcharts({
        ...
        title: {
            text: 'IDIOMA HABLADO DE LAS FAMILIAS - NIVEL NACIONAL'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    $sql0 = " SELECT count(ididioma_cf) FROM idioma_cf WHERE idorigen_idioma ='1' ";
                    $result0 = mysqli_query($link,$sql0);
                    $row0 = mysqli_fetch_array($result0);
                    $total = $row0[0];

                    $numero = 0;
                    $sql = " SELECT ididioma FROM idioma_cf GROUP BY ididioma ";
                    ...
                    $sql_c= " SELECT count(ididioma_cf) FROM idioma_cf WHERE ididioma='$row[0]' AND idorigen_idioma ='1' ";
...
$(function () {
    $('#materno').highcharts({
        ...
        title: {
            text: 'IDIOMA MATERNO DE LAS FAMILIAS - NIVEL NACIONAL'
        },
        subtitle: {
            text: 'Fuente: Sistema Medi-Safci al <?php echo $f_emision;?>'
        },
        ...
        series: [{
            ...
            data: [
                <?php
                    $sql0 = " SELECT count(ididioma_cf) FROM idioma_cf WHERE idorigen_idioma ='2'";
                    $result0 = mysqli_query($link,$sql0);
                    $row0 = mysqli_fetch_array($result0);
                    $total2 = $row0[0];
                    ...
                    $sql_c= " SELECT count(ididioma_cf) FROM idioma_cf WHERE ididioma='$row[0]' AND idorigen_idioma ='2' ";
                    $result_c = mysqli_query($link,$sql_c);
                    $row_c = mysqli_fetch_array($result_c);
                    $conteo = $row_c[0];
...
<div id="hablado" style="height: 700px"></div>

<div id="materno" style="height: 700px"></div>
...
<?php
$numeroa = 1;
$sqla = " SELECT ididioma FROM idioma_cf GROUP BY ididioma ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c = " SELECT count(ididioma_cf) FROM idioma_cf WHERE ididioma='$rowa[0]' AND idorigen_idioma ='1' ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c = " SELECT count(ididioma_cf) FROM idioma_cf WHERE ididioma='$rowa[0]' AND idorigen_idioma ='2' ";
