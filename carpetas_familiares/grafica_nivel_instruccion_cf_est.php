...
<html>
	<head>
		...
		<title>NIVEL DE INSTRUCCION - ESTABLECIMIENTO </title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'NIVEL DE INSTRUCCIÓN DE LOS INTEGRANTES DE LA FAMILIA - ESTABLECIMIENTO  DE <?php echo mb_strtoupper($row_est[1]);?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= "AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
                    $result0 = mysqli_query($link,$sql0);
                    $row0 = mysqli_fetch_array($result0);
                    $total = $row0[0];

                    $numero = 0;
                    $sql = " SELECT integrante_datos_cf.idnivel_instruccion FROM integrante_datos_cf, carpeta_familiar, integrante_cf ";
                    ...
                    $sql.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY integrante_datos_cf.idnivel_instruccion ";
                    ...
                    $sql_t = " SELECT idnivel_instruccion, nivel_instruccion FROM nivel_instruccion WHERE idnivel_instruccion='$row[0]' ";
                    ...
                    $sql_c.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND integrante_datos_cf.idnivel_instruccion='$row[0]' ";
...
<table width="646" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="315" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">NIVEL DEINSTRUCCIÓN</span></td>
...
<?php
$numeroa = 1;
$sqla = " SELECT integrante_datos_cf.idnivel_instruccion, nivel_instruccion.nivel_instruccion FROM integrante_datos_cf, carpeta_familiar, nivel_instruccion ";
$sqla.= " WHERE  integrante_datos_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND integrante_datos_cf.idnivel_instruccion=nivel_instruccion.idnivel_instruccion AND carpeta_familiar.estado='CONSOLIDADO' ";
$sqla.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY integrante_datos_cf.idnivel_instruccion ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c = " SELECT count(integrante_datos_cf.idintegrante_datos_cf) FROM integrante_datos_cf, carpeta_familiar, integrante_cf ";
    $sql_c.= " WHERE integrante_datos_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_cf.estado='CONSOLIDADO' ";
    $sql_c.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' AND integrante_datos_cf.idnivel_instruccion='$rowa[0]' ";
    $result_c = mysqli_query($link,$sql_c);
    $row_c = mysqli_fetch_array($result_c);
    $conteoa = $row_c[0];
...
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">INTEGRANTES CON REGISTRO - NIVEL DE INSTRUCCIÓN = <?php echo $total;?> </h4></spam>
