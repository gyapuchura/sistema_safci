...
<html>
	<head>
		...
		<title>MORBILIDAD - MEDICO OPERATIVO</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'MORBILIDAD - ÁREAS DE INFLUENCIA - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
        ...
        xAxis: {
            categories: [
                <?php 
$numero = 0;
$sql = " SELECT carpeta_familiar.idarea_influencia, area_influencia.area_influencia FROM integrante_morbilidad, carpeta_familiar, area_influencia ";
...
?>
        ...
        series: [
{
name: 'Integrantes MORBILIDAD',
data: [
    
    <?php 
$numero3 = 0;
$sql3 = " SELECT carpeta_familiar.idarea_influencia FROM integrante_morbilidad, carpeta_familiar ";
