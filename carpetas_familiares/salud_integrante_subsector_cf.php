...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <a href="salud_integrante_cf.php"><h6 class="text-info"><- VOLVER</h6></a>
                    <hr>             
                    <h4 class="text-info">CARPETA FAMILIAR:</h4>
                    <h4 class="text-primary"><?php echo $row_cf[1]; ?></h4>
                    <h4 class="text-info">6.- SUBSECTOR</h4>
                    <hr> 
                    </div>
...
<!-- BEGIN aqui va el comntenido de la pagina ---->
                        ...
                        <table class="table table-striped" id="example" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-info">CORRESPONDE/ASISTE</th>
                                    <th class="text-info">SUBSECTOR SALUD</th>
                            ...
                            <tbody>
                                    ...
                                    $sql4.=" AND integrante_subsector_salud.idsubsector_salud=subsector_salud.idsubsector_salud AND integrante_subsector_salud.idintegrante_cf='$idintegrante_cf_ss' ";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if ($row4[3] == '9') { } else { echo $row4[1];} ?></td>
                                        <td><?php echo $row4[2];?></td>
                                        <td>
                                        <form name="BORRAR" action="elimina_subsector_integrante_cf.php" method="post">  
                                        <input type="hidden" name="idintegrante_subsector_salud" value="<?php echo $row4[0];?>">
    ...
    <hr>
        <div class="form-group row">  
    <div class="col-sm-6">
        <h6 class="text-info">ACUDE O CORRESPONDE A ALGÚN SUBSECTOR SALUD?</h6>
    </div>
    <hr> 
    <div class="col-sm-6">
        <select name="subsector" id="subsector" class="form-control" required autofocus>
...
<div class="col-lg-12" id="subsector_salud_cf">  
    <div class="p-2">

    </div>
</div>

    <!-------- ESUBSECTOR SALUD DEL INTEGRANTE (END) --------->
          <hr>
             <div class="text-center"> 
               <a href="salud_integrante_beneficiario_cf.php"><h6 class="text-success">SIGUIENTE -></h6></a>                                                                   
            </div>
    ...
    <!-- scripts para calendario -->
        ...
        $("#subsector").change(function () {
                    $("#subsector option:selected").each(function () {
                        subsector=$(this).val();
                    $.post("subsector_salud_cf.php", {subsector:subsector}, function(data){
                    $("#subsector_salud_cf").html(data);
                    });
                });
        })
        });
