...
<html>
	<head>
		...
		<title>TENENCIA DE ANIMALES DOMESTICOS ÁREA DE INFLUENCIA</title>
...
$(function () {
    $('#suministro_agua').highcharts({
        ...
        title: {
            text: 'TENENCIA DE ANIMALES DOMÉSTICOS - ÁREA DE INFLUENCIA: <?php echo mb_strtoupper($area_af);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idarea_influencia='$idarea_influencia'  ";
                    ...
                    $sql.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idarea_influencia='$idarea_influencia' GROUP BY tenencia_animales_cf.idtenencia_animales ";
                    ...
                    $sql_c.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idarea_influencia='$idarea_influencia' AND tenencia_animales_cf.idtenencia_animales='$row[0]' ";
