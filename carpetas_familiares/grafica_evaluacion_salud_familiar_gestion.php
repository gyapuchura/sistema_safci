...
$(function () {
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            <?php
$sql_t =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE  estado='CONSOLIDADO' AND gestion=$gestion ";
...
$sql_a.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.gestion=$gestion ";
...
$sql_b.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.gestion=$gestion  ";
...
$sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.gestion=$gestion ";
...
?>
            $('#container').highcharts({
                ...
                title: {
                    text: 'EVALUACIÓN DE LA SALUD FAMILIAR GESTIÓN <?php echo $gestion;?>- NIVEL NACIONAL '
                },
                subtitle: {
