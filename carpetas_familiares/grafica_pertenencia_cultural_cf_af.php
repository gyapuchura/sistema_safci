...
<html>
	<head>
		...
		<title>AUTOPERTENENCIA CULTURAL - AREA DE INFLUENCIA</title>
...
$(function () {
    $('#autopertenencia-cultural').highcharts({
        ...
        title: {
            text: 'AUTOPERTENENCIA CULTURAL DE LOS INTEGRANTES DE LA FAMILIA - ÁREA DE INFLUENCIA: <?php echo mb_strtoupper($area_af);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' GROUP BY integrante_cf.idnacion ";
                    ...
                    $sql_c.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' AND integrante_cf.idnacion='$row[0]' ";
...
$sql_0.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' ";
...
$sqla.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' GROUP BY integrante_cf.idnacion ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_cf, carpeta_familiar ";
    $sql_c.= " WHERE integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.estado='CONSOLIDADO'";
    $sql_c.= " AND carpeta_familiar.idarea_influencia='$idarea_influencia' AND integrante_cf.idnacion='$rowa[0]' ";
    $result_c = mysqli_query($link,$sql_c);
    $row_c = mysqli_fetch_array($result_c);
    $conteoa = $row_c[0];
