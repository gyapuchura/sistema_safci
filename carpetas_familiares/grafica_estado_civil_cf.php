...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'ESTADO CIVIL DE LOS INTEGRANTES DE LA FAMILIA - NIVEL NACIONAL'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT idestado_civil FROM integrante_datos_cf GROUP BY idestado_civil ";
                    ...
                    $sql_c= " SELECT count(idintegrante_datos_cf) FROM integrante_datos_cf WHERE idestado_civil='$row[0]' ";
