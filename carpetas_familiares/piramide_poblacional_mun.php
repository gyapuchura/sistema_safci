        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
...
<div id="pantalla-carga">
    ...
    <div class="texto-loader">Procesando PIRÁMIDE POBLACIONAL, por favor espere...</div>
</div>
...
<?php
                    ...
                    while ($field = mysqli_fetch_field($result)){
                        ...
                        $sql_m.= "  AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
                        ...
                        $sql_f.= "  AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idmunicipio='$idmunicipio' ";
