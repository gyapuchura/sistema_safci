...
<html>
	<head>
		...
		<title>PIRÁMIDE GRUPO FACTOR RIESGO - NACIONAL</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE GRUPO II - FACTORES DE RIESGO - NACIONAL'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    <?php
                    $sql7 = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_factor_riesgo, integrante_cf, nombre  ";
                    $sql7.= " WHERE integrante_cf.idnombre=nombre.idnombre AND integrante_factor_riesgo.idintegrante_cf=integrante_cf.idintegrante_cf ";
