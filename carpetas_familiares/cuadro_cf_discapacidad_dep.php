...
<head>
    ...
    <title>CUADRO DISCAPACIDAD DEPARTAMENTAL</title>
</head>
<body>

<h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">INTEGRANTES DE LA FAMILIA CON DISCAPACIDAD - DEPARTAMENTO DE <?php echo $row_dep[1];?></h2>
