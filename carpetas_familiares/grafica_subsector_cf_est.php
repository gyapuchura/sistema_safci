...
<html>
	<head>
		...
		<title>SUBSECTOR SALUD FAMILIAR - ESTABLECIMIENTO DE SALUD</title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'CORRESPONDEN AL SUBSECTOR SALUD - Establecimiento : <?php echo mb_strtoupper($row_est[1]);?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idestablecimiento_salud='$idestablecimiento_salud'  ";
                    ...
                    $sql.= " AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idestablecimiento_salud='$idestablecimiento_salud'  ";
...
$(function () {
    $('#asiste_salud').highcharts({
        ...
        title: {
            text: 'ASISTEN AL SUBSECTOR SALUD - Establecimiento : <?php echo mb_strtoupper($row_est[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
