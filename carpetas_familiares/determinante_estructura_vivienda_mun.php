...
<html>
	<head>
		...
		<title>ESTRUCTURA VIVIENDA - MUNICIPAL</title>
...
$(function () {
    $('#tipo_vivienda').highcharts({
        ...
        title: {
            text: 'a) TIPO DE VIVIENDA - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
...
$(function () {
    $('#techo_vivienda').highcharts({
        ...
        title: {
            text: 'b) TECHO DE LA VIVIENDA - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#paredes_vivienda').highcharts({
        ...
        title: {
            text: 'c) PAREDES DE LA VIVIENDA - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#pisos_vivienda').highcharts({
        ...
        title: {
            text: 'd). PISOS DE LA VIVIENDA - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#revoque_paredes').highcharts({
        ...
        title: {
            text: 'e). REVOQUE DE LAS PAREDES INTERIORES - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#cuarto_cocina').highcharts({
        ...
        title: {
            text: 'f) TIENE CUARTO SOLO PARA COCINAR - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$sql2.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idmunicipio='$idmunicipio' ";
...
$sql_a.=" AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idmunicipio='$idmunicipio' ";
...
$(function () {
    $('#riesgos_internos').highcharts({
        ...
        title: {
            text: 'h) RIESGOS INTERNOS CON RELACIÓN A LA VIVIENDA - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        subtitle: {
            text: 'Fuente: REGISTRO SISTEMA MEDI-SAFCI'
        },
