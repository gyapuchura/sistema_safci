...
<html>
	<head>
		...
		<title>PIRÁMIDE POBLACIONAL - MEDICO OPERATIVO</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE POBLACIONAL - MÉDICO: <?php echo $operativo;?>'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= "  AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' ";
...
<?php
                    ...
                    while ($field = mysqli_fetch_field($result)){
                        ...
                        $sql_m.= "  AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' ";
                        ...
                        $sql_f.= "  AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' ";
