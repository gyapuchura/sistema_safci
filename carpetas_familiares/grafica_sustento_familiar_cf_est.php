...
<html>
	<head>
		...
		<title>SUSTENTO FAMILIAR - ESTABLECIMIENTO</title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'INTEGRANTES QUE CONTRIBUYEN AL SUSTENTO DE LA FAMILIA - ESTABLECIMIENTO: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        subtitle: {
