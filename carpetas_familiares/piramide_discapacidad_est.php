...
$sqlav.= " AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf' AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud'";
...
<html>
	<head>
		...
		<title>PIRÁMIDE DISCAPACIDAD - NIVEL MUNICIPAL</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE DISCAPACIDAD <?php echo mb_strtoupper($tipo_dis);?> <?php echo mb_strtoupper($nivel);?> - ESTABLECIMIENTO DE SALUD: <?php echo mb_strtoupper($row_est[1]);?> '
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf' AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
