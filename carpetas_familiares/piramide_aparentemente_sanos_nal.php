        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    <?php
                    $sql7 = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_ap_sano, integrante_cf, nombre, carpeta_familiar  ";
                    ...
                    $sql7.= " AND integrante_ap_sano.idintegrante_cf=integrante_cf.idintegrante_cf";
