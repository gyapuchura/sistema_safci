...
<head>
  ...
  <title>CARPETIZACION MUNICIPIOS - SAFCI</title>
	...
	<body>
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">PORCENTAJE DE CARPETIZACIÓN FAMILIAR MUNICIPIOS</h3>
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">DEPARTAMENTO DE <?php echo $row_dep[1];?></h3>
	<table width="850" border="1" align="center">
	  <tbody>
        <tr>
            ...
            <td width="180" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>MUNICIPIO</strong></td>
            <td width="62" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>FAMILIAS POR ÁREA DE INFLUENCIA</strong></td>
            <td width="62" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>FAMILIAS CARPETIZADAS EN SISTEMA</strong></td>
            <td width="62" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>% DE CARPETIZACIÓN</strong></td>
            <td width="78" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>HABITANTES POR ÁREA DE INFLUENCIA</strong></td>
            <td width="78" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>INTEGRANTES REGISTRADOS EN SISTEMA</strong></td>
            <td width="52" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>% DE POBLACIÓN</strong></td>	
