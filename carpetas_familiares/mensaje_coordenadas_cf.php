...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>                     
                    <h4 class="text-danger">USTED NO HA INGRESADO </h4>
                    <h4 class="text-danger">LAS COORDENADAS GEOGRÁFICAS </h4>

                    </br>
                    <a href="nueva_carpeta_familiar.php"><h6>IR A NUEVA CARPETA FAMILIAR --></h6></a>
                    </div>
