...
<html>
	<head>
		...
		<title>CARACTERISTICAS SOCIOECONÓMICAS - MEDICO OPERATIVO</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'CARACTERÍSTICAS SOCIOECONÓMICAS - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
...
$sql2.= " AND carpeta_familiar.idusuario='$idusuario' GROUP BY socio_economica_cf.valor ";
...
$sql_a.=" AND carpeta_familiar.idusuario='$idusuario' ";
