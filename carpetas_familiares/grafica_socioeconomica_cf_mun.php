...
<html>
	<head>
		...
		<title>CARACTERISTICAS SOCIOECONOMICAS MUNICIPIO</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'CARACTERÍSTICAS SOCIOECONÓMICAS - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        subtitle: {
...
$sql2.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idmunicipio='$idmunicipio' GROUP BY socio_economica_cf.valor ";
...
$sql_a.=" AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idmunicipio='$idmunicipio' ";
