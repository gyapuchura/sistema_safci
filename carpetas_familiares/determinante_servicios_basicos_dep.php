...
<html>
	<head>
		...
		<title>SERVICIOS_BASICOS_DEPTO</title>
...
$(function () {
    $('#suministro_agua').highcharts({
        ...
        title: {
            text: 'a) ABASTECIMIENTO DE AGUA PARA CONSUMO - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
...
$(function () {
    $('#manejo_basura').highcharts({
        ...
        title: {
            text: 'b) MANEJO DE LA BASURA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?> '
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#servicio_higienico').highcharts({
        ...
        title: {
            text: 'c) SERVICIO HIGIENICO - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#eliminacion_excretas').highcharts({
        ...
        title: {
            text: 'd). ELIMINACIÓN DE EXCRETAS - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#iluminacion_vivienda').highcharts({
        ...
        title: {
            text: 'e). ILUMINACIÓN DE LA VIVIENDA - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#combustible_energia').highcharts({
        ...
        title: {
            text: 'f). COMBUSTIBLE/ENERGIA PARA COCINAR - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
...
$(function () {
    $('#acceso_comunicacion').highcharts({
        ...
        title: {
            text: 'g) ACCESO A COMUNICACIÓN - DPTO. <?php echo mb_strtoupper($row_dep[1]);?>'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
