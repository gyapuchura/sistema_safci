...
<html>
	<head>
		...
		<title>RIESGOS INTERNOS VIVIENDA</title>
...
<?php
                    ...
                    $sql.= " AND determinante_salud_cf.iddeterminante_salud='2' AND determinante_salud_cf.idcat_determinante_salud='15' ";
                    ...
                    $sql_si.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
                    $sql_si.= " AND determinante_salud_cf.iddeterminante_salud='2' AND determinante_salud_cf.idcat_determinante_salud='15' AND determinante_salud_cf.iditem_determinante_salud='$row[0]' AND determinante_salud_cf.valor_cf='5'  ";
                    ...
                    $sql_no.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.iddepartamento='$iddepartamento' ";
                    $sql_no.= " AND determinante_salud_cf.iddeterminante_salud='2' AND determinante_salud_cf.idcat_determinante_salud='15' AND determinante_salud_cf.iditem_determinante_salud='$row[0]' AND determinante_salud_cf.valor_cf='1'  ";
