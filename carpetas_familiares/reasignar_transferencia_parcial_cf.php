...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">TRANSFERENCIA PARCIAL DE CARPETAS FAMILIARES</h1>
                    <p class="mb-4">En esta seccion se puede TRANSFERIR CARPETAS FAMILIARES DE MANERA PARCIAL DEL PROGRAMA NACIONAL SAFCI - MI SALUD A NIVEL NACIOANL POR ESTABLECIMIENTO DE SALUD.</p>

                    <!-- DataTales Example -->

            <form name="TRANSFERENCIA_CF" action="guarda_transferencia_parcial_cf.php" method="post">

                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">MÉDICO OPERATIVO - 1 (QUE TRANSFIERE CARPETAS PARCIALMENTE)</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">MÉDICO OPERATIVO - 2 (RECIBE CARPETAS FAMILIARES DE MANERA PARCIAL)</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-sm-9">
                    ...
                    GUARDAR TRANSFERENCIA PARCIAL DE CARPETAS FAMILIARES
                    </button>  
                </div> 
                </div>      
            </div> 
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel">TRANSFERENCIA DE CARPETAS FAMILIARES</h5>
                        ...
                        <div class="modal-body">
                            ...
                            Esta seguro de Registrar LA TRANSFERENCIA DE CARPETAS FAMILIARES?
    ...
    <script language="javascript">
        ...
        $("#medico_operativo_cf1").change(function () {
                    ...
                    $.post("carpetas_familiares_operativo_parcial_1.php", {medico_operativo:medico_operativo}, function(data){
    ...
    <script language="javascript">
        ...
        $("#idestablecimiento_salud_op2").change(function () {
                    $("#idestablecimiento_salud_op2 option:selected").each(function () {
                        establecimiento_salud=$(this).val();
                    $.post("medico_operativo_cf_e.php", {establecimiento_salud:establecimiento_salud}, function(data){
    ...
    <script language="javascript">
        ...
        $("#medico_operativo_cf2").change(function () {
                    $("#medico_operativo_cf2 option:selected").each(function () {
                        medico_operativo=$(this).val();
                    $.post("carpetas_familiares_operativo_parcial_2.php", {medico_operativo:medico_operativo}, function(data){
