...
$sqlav.= " AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf'  ";
$sqlav.= " AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<html>
	<head>
		...
		<title>PIRÁMIDE DISCAPACIDAD - NIVEL NACIONAL</title>
        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    $sql7.= " AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf' AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
