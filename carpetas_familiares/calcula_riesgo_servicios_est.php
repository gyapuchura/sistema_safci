...
/************ Evaluamos para cada detrminante de la salud  BEGIN ************/
        ...
        $sqla.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idestablecimiento_salud='$idestablecimiento_salud' ";
...
<html>
	<head>
		...
		<title>EVALUACION RIESGO DE SERVICIOS BASICOS - ESTABLECIMIENTO DE SALUD </title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO EN LOS SERVICIOS BÁSICOS - Establecimiento <?php echo mb_strtoupper($row_mun[1]);?>'
                },
                subtitle: {
