...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'DISCAPACIDAD - <?php echo $tipo_dis;?> <?php echo $nivel;?> - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
...
$sql.= " AND carpeta_familiar.idusuario='$idusuario' GROUP BY carpeta_familiar.idestablecimiento_salud ";
...
$sql3.= " AND carpeta_familiar.idusuario='$idusuario' GROUP BY carpeta_familiar.idestablecimiento_salud  ";
