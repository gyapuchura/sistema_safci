...
<html>
	<head>
		...
		<title>CARACTERISTICAS SOCIOECONÓMICAS ESTABLECIMIENTO DE SALUD</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'CARACTERÍSTICAS SOCIOECONÓMICAS - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        subtitle: {
...
$sql2.= " AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY socio_economica_cf.valor ";
...
$sql_a.=" AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
