...
<html>
	<head>
		...
		<title>EVALUACION RIESGO EN LAS DETERMINANTES DE LA SALUD - ESTABLECIMIENTO DE SALUD </title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO EN LAS DETERMINANTES DE LA SALUD - Establecimiento <?php echo mb_strtoupper($row_est[1]);?>'
                },
                subtitle: {
