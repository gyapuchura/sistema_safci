...
<html>
	<head>
		...
		<title>EVALUACION DE SALUD FAMILIAR - MEDICO OPERATIVO</title>
...
?>
            $('#container').highcharts({
                ...
                title: {
                    text: 'EVALUACIÓN DE LA SALUD FAMILIAR - MÉDICO: <?php echo $operativo;?>'
                },
                subtitle: {
...
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">TOTAL DE CARPETAS FAMILIARES DEL MÉDICO OPERATIVO = <?php echo $total;?> </h4></spam>
