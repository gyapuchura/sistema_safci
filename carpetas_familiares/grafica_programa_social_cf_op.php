...
<html>
	<head>
		...
		<title>PROGRAMAS SOCIALES SALUD FAMILIAR - MEDICO OPERATIVO</title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'BENEFICIARIOS DE PROGRAMAS SOCIALES - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.idusuario='$idusuario' GROUP BY integrante_beneficiario.idprograma_social ";
...
$sqla.= " AND carpeta_familiar.idusuario='$idusuario' GROUP BY integrante_beneficiario.idprograma_social ";
