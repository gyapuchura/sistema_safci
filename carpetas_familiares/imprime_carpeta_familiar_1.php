    ...
    <tr>
      <td colspan="3"><table width="1200" border="1" cellpadding="0" cellspacing="0">
        <tbody>
          ...
          <tr>
            <td rowspan="2"><strong style="font-family: arial; color: #503B92; font-size: 12px;">1. Familia: <?php echo $row_cf[8];?></strong></td>
            <td><strong style="font-family: arial; color: #503B92; font-size: 12px;">1. Departamento: <?php echo $row_dep[1];?></strong></td>
            <td colspan="3"><strong style="font-family: arial; color: #503B92; font-size: 12px;">5. Avenida/Calle/Carretera/Camino:</strong></td>
            <td rowspan="5">&nbsp;</td>
          </tr>
          <tr>
            <td><strong style="font-family: arial; color: #503B92; font-size: 12px;">2. Provincia: <?php echo $row_mun[1];?></strong></td>
            <td colspan="3"><strong style="font-family: arial; color: #503B92; font-size: 12px;">6. Número de Puerta:</strong></td>
            </tr>
          <tr>
            <td rowspan="3"><strong style="font-family: Arial; font-size: 12px; color: #503B92;">2. Idioma:</strong></td>
            <td><strong style="font-family: arial; color: #503B92; font-size: 12px;">3. Municipio: <?php echo $row_mun[2];?></strong></td>
            <td colspan="3"><strong style="font-family: arial; color: #503B92; font-size: 12px;">7. Nombre del edificio, Piso y No. de Departamento:</strong></td>
            </tr>
          <tr>
            <td rowspan="2"><p><strong style="font-family: arial; color: #503B92; font-size: 12px;">4. Comunidad/ Barrio/ Zona/ Unidad Vecinal:</br><?php echo $row_ar[1];?> <?php echo $row_ar[2];?></strong></p>
              <p>&nbsp;</p></td>
            <td width="133"><strong style="font-family: arial; color: #503B92; font-size: 12px;">8. Latitud: </strong></td>
            <td width="130"><strong style="font-family: arial; color: #503B92; font-size: 12px;">9. Longitud:</strong></td>
            <td width="113"><strong style="font-family: arial; color: #503B92; font-size: 12px;">10. Altura (msnm)::</strong></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
      ...
      <td colspan="3"><table width="1200" border="1" cellspacing="0">
        <tbody>
          ...
          <tr>
            ...
            <td width="77" bgcolor="#EEEFF3" style="font-family: Arial; font-size: 12px; color: #503B92; text-align: center;"><strong>Fecha de<br>
            ...
            <td width="61" bgcolor="#EEEFF3" style="font-family: Arial; font-size: 12px; color: #503B92; text-align: center;"><strong>Contribuye<br>
              al<br>
              Sustento<br>
              Familiar</strong></td>
            </tr>
