...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>                     
                    <h4 class="text-success">LA LISTA DE INTEGRANTES DE LA CARPETA FAMILIAR</h4>
                    ...
                    <h4 class="text-danger">HA SIDO DESCONSOLIDADA!</h4>
                    <h4 class="text-danger">IMPORTANTE</h4>
                    <h4 class="text-secundary">AHORA PODRA ELIMINAR INTEGRANTES</h4>
                    <h4 class="text-sucsecundarycess">Y REALIZAR LOS AJUSTES CORRESPONDIENTES</h4>
                    </br>
                    <a href="integrantes_cf.php"><h6>IR A INTEGRANTES DE LA FAMILIA -></h6></a>
                    </div>
