...
$sql_t =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE  estado='CONSOLIDADO' AND idarea_influencia='$idarea_influencia' ";
...
$sql_e.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idarea_influencia='$idarea_influencia' ";
...
<html>
	<head>
		...
		<title>EVALUACION RIESGO EN LAS DETERMINANTES DE LA SALUD - AREA DE INFLUENCIA </title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO EN LAS DETERMINANTES DE LA SALUD - Área de Influencia <?php echo mb_strtoupper($area_af);?>'
                },
                subtitle: {
