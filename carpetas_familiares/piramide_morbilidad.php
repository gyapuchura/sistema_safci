        ...
        $('#container').highcharts({
            ...
            series: [{
                ...
                data: [
                    ...
                    <?php
                    $sql7 = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_morbilidad, integrante_cf, nombre, ubicacion_cf, carpeta_familiar  ";
                    ...
                    $sql7.= " AND integrante_morbilidad.idintegrante_cf=integrante_cf.idintegrante_cf AND ubicacion_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar ";
                    ...
                    $sql7.= " AND ubicacion_cf.ubicacion_actual='SI' AND ubicacion_cf.idarea_influencia='$idarea_influencia' AND integrante_morbilidad.idmorbilidad_cf='$idmorbilidad_cf'  ";
