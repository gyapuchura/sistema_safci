...
<html>
	<head>
		...
		<title>OCUPACION - MEDICO OPERATIVO </title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'OCUPACIÓN DE LOS INTEGRANTES DE LA FAMILIA - MÉDICO: <?php echo $operativo;?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idusuario='$idusuario' GROUP BY integrante_datos_cf.ocupacion ";
                    ...
                    $sql_c.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idusuario='$idusuario' AND integrante_datos_cf.ocupacion='$row[0]' ";
...
$sqla.= " AND carpeta_familiar.idusuario='$idusuario' GROUP BY integrante_datos_cf.ocupacion ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c = " SELECT count(integrante_datos_cf.idintegrante_datos_cf) FROM integrante_datos_cf, carpeta_familiar, integrante_cf ";
    $sql_c.= " WHERE integrante_datos_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_cf.estado='CONSOLIDADO' ";
    $sql_c.= " AND integrante_datos_cf.idintegrante_cf=integrante_cf.idintegrante_cf AND carpeta_familiar.idusuario='$idusuario' AND integrante_datos_cf.ocupacion='$rowa[0]' ";
    $result_c = mysqli_query($link,$sql_c);
    $row_c = mysqli_fetch_array($result_c);
    $conteoa = $row_c[0];
