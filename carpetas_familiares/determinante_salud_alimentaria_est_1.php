...
<html>
	<head>
		...
		<title>SALUD ALIMENTARIA CF - ESTABLECIMIENTO DE SALUD</title>
...
$sql2.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
...
<table width="646" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="315" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">Encuesta Seguridad Alimentaria</span></td>
...
<?php
            ...
            $sql_si.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
            ...
            $sql_no.= " AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idestablecimiento_salud='$idestablecimiento_salud' ";
            $sql_no.= " AND determinante_salud_cf.iditem_determinante_salud='$row[0]' AND determinante_salud_cf.valor_cf='0'  ";
