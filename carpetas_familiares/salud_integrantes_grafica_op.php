...
$sql_b.=" AND carpeta_familiar.idusuario='$idusuario' GROUP BY integrante_factor_riesgo.idintegrante_cf ";
...
$sql_d.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' ";
...
$grupo_4       = ($discapacidad*100)/$total;
            ...
            $('#grupo_salud').highcharts({
                ...
                title: {
                    text: ' SALUD DE LOS INTEGRANTES DE LA FAMILIA - Médico: <?php echo $operativo;?>'
                },
                subtitle: {
...
<!--- <h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">
 <a href="cuadro_cf_establecimiento.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=250,scrollbars=YES,top=60,left=400'); return false;">             
MOSTRAR CUADRO</a></h2>  --->
...
<table width="700" border="1" align="center" cellspacing="0">
		  <tbody>
            ...
            <td style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;"><?php echo $aparentemente_sano;?> </td>
              ...
              <a href="aparentemente_sanos_op.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1000,height=950,scrollbars=YES,top=60,left=500'); return false;">             
              ÁREAS DE INFLUENCIA</a>
              </td>
              <td style="font-size: 12px; font-family: Arial; text-align: center;">
              <a href="piramide_aparentemente_sanos_op.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=500'); return false;">             
              VER PIRAMIDE</a>
              </td>
	        </tr>
            <tr>
              ...
              <td style="font-size: 12px; font-family: Arial; text-align: center;">
              <a href="grupo_riesgo_op.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1000,height=950,scrollbars=YES,top=60,left=500'); return false;">             
              ÁREAS DE INFLUENCIA</a>
              </td>
              <td style="font-size: 12px; font-family: Arial; text-align: center;">
              <a href="piramide_grupo_riesgo_op.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=500'); return false;">             
              VER PIRAMIDE</a>
              </td>
	        </tr>
            <tr>
              ...
              <td style="font-size: 12px; font-family: Arial; text-align: center;">
              <a href="grupo_morbilidad_op.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1000,height=950,scrollbars=YES,top=60,left=500'); return false;">             
              ÁREAS DE INFLUENCIA</a>
              </td>
              <td style="font-size: 12px; font-family: Arial; text-align: center;">
              <a href="piramide_grupo_morbilidad_op.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=500'); return false;">             
              VER PIRAMIDE</a>
              </td>
	        </tr>
            <tr>
              ...
              <td style="font-size: 12px; font-family: Arial; text-align: center;">
              <a href="grupo_discapacidad_op.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1000,height=950,scrollbars=YES,top=60,left=500'); return false;">             
              ÁREAS DE INFLUENCIA</a>
              </td>
              <td style="font-size: 12px; font-family: Arial; text-align: center;">
              <a href="piramide_grupo_discapacidad_op.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=500'); return false;">             
              VER PIRAMIDE</a>
              </td>
	        </tr>
	      </tbody>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            <?php
                ...
                $sql_a.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='1' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_a = mysqli_query($link,$sql_a);
                $row_a = mysqli_fetch_array($result_a);
                ...
                $sql_b.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='2' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_b = mysqli_query($link,$sql_b);
                ...
                $sql_c.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='3' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_c = mysqli_query($link,$sql_c);
                $row_c = mysqli_fetch_array($result_c);
                $fumar =$row_c[0];
                ...
                $sql_d.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='4' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_d = mysqli_query($link,$sql_d);
                $row_d = mysqli_fetch_array($result_d);
                $drogas = $row_d[0];
                ...
                $sql_e.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='5' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_f.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='6' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_g.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='7' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_h.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='8' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_i.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='9' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_j.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='10' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_k.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='11' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_l.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='12' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_m.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='13' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_n.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='14' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_o.="  AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_factor_riesgo.idfactor_riesgo_cf='15' AND carpeta_familiar.idusuario='$idusuario' ";
            ...
            $('#grupo_riesgo').highcharts({
                ...
                title: {
                    text: 'GRUPO II - FACTORES DE RIESGO - Médico: <?php echo $operativo;?>'
                },
                subtitle: {
...
<!-- <h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">
  <a href="cuadro_cf_salud_integrantes_est.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=400,scrollbars=YES,top=60,left=400'); return false;">             
...
<table width="700" border="1" align="center" cellspacing="0">
        ...
        $sql.="  AND carpeta_familiar.idusuario='$idusuario' GROUP BY integrante_factor_riesgo.idfactor_riesgo_cf ";
        ...
        $sql_c =" SELECT COUNT(integrante_factor_riesgo.idintegrante_factor_riesgo) FROM integrante_factor_riesgo, carpeta_familiar  ";
        $sql_c.=" WHERE integrante_factor_riesgo.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar ";
        $sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' AND integrante_factor_riesgo.idfactor_riesgo_cf='$row[0]' ";
        ...
        $row_c = mysqli_fetch_array($result_c);
          ...
          <?php echo $row_c[0];?>
              ...
              <td style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">
              <a href="detalle_salud_integrantes_op.php?idusuario=<?php echo $idusuario;?>&idfactor_riesgo_cf=<?php echo $row[0];?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=600'); return false;">             
              VER INTEGRANTES</a>
              </td>

              <td style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">
              <a href="piramide_factores_riesgo_op.php?idusuario=<?php echo $idusuario;?>&idfactor_riesgo_cf=<?php echo $row[0];?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=600'); return false;">             
              VER PIRAMIDE</a>
              </td>
	        </tr>
        <?php
...
$(function () {
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            <?php
                ...
                $sql_a.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='1' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_a = mysqli_query($link,$sql_a);
                $row_a = mysqli_fetch_array($result_a);
                ...
                $sql_b.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='2' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_b = mysqli_query($link,$sql_b);
                $row_b = mysqli_fetch_array($result_b);
                $sexual = $row_b[0];
                ...
                $sql_c =" SELECT COUNT(integrante_morbilidad.idintegrante_morbilidad) FROM integrante_morbilidad, carpeta_familiar  ";
                $sql_c.=" WHERE integrante_morbilidad.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar";
                $sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='3' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_c = mysqli_query($link,$sql_c);
                $row_c = mysqli_fetch_array($result_c);
                $malaria =$row_c[0];
                ...
                $sql_d.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='4' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_d = mysqli_query($link,$sql_d);
                $row_d = mysqli_fetch_array($result_d);
                $lepra = $row_d[0];
                ...
                $sql_e.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='5' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_e = mysqli_query($link,$sql_e);
                $row_e = mysqli_fetch_array($result_e);
                ...
                $sql_f.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='6' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_f = mysqli_query($link,$sql_f);
                $row_f = mysqli_fetch_array($result_f);
                $chagas = $row_f[0];
                ...
                $sql_g.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='7' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_g = mysqli_query($link,$sql_g);
                $row_g = mysqli_fetch_array($result_g);
                $hepatitis =$row_g[0];
                ...
                $sql_h.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='8' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_h = mysqli_query($link,$sql_h);
                $row_h = mysqli_fetch_array($result_h);
                ...
                $sql_i.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='9' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_i = mysqli_query($link,$sql_i);
                $row_i = mysqli_fetch_array($result_i);
                ...
                $sql_j.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='10' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_j = mysqli_query($link,$sql_j);
                $row_j = mysqli_fetch_array($result_j);
                $diabetes = $row_j[0];
                ...
                $sql_k.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='11' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_k = mysqli_query($link,$sql_k);
                $row_k = mysqli_fetch_array($result_k);
                $obesidad =$row_k[0];
                ...
                $sql_l.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='12' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_l = mysqli_query($link,$sql_l);
                $row_l = mysqli_fetch_array($result_l);
                $renal = $row_l[0];
                ...
                $sql_m.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='13' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_m = mysqli_query($link,$sql_m);
                $row_m = mysqli_fetch_array($result_m);
                $reumatica = $row_m[0];
                ...
                $sql_n.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='14' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_n = mysqli_query($link,$sql_n);
                $row_n = mysqli_fetch_array($result_n);
                $pulmonar = $row_n[0];
                ...
                $sql_o.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='15' AND carpeta_familiar.idusuario='$idusuario' ";
                $result_o = mysqli_query($link,$sql_o);
                $row_o = mysqli_fetch_array($result_o);
                $autoinmune = $row_o[0];
                ...
                $sql_p.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='16' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_q.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='17' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_r.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='18' AND carpeta_familiar.idusuario='$idusuario' ";
                ...
                $sql_s.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_morbilidad.idmorbilidad_cf='19' AND carpeta_familiar.idusuario='$idusuario' ";
            ...
            $('#grupo_morbilidad').highcharts({
                ...
                title: {
                    text: 'GRUPO III - MORBILIDAD - Médico: <?php echo $operativo;?>'
                },
                subtitle: {
                    text: 'SALUD DE LOS INTEGRANTES DE LA FAMILIA'
                },
    ...
    <!--    <h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">
 <a href="cuadro_cf_morbilidad_integrantes_est.php?idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=400,scrollbars=YES,top=60,left=400'); return false;">             
    ...
    <table width="700" border="1" align="center" cellspacing="0">
        ...
        $sql.=" AND carpeta_familiar.idusuario='$idusuario' GROUP BY integrante_morbilidad.idmorbilidad_cf  ";
        $result = mysqli_query($link,$sql);
        if ($row = mysqli_fetch_array($result)){
        mysqli_field_seek($result,0);
        while ($field = mysqli_fetch_field($result)){
        ...
        $sql_c.=" WHERE integrante_morbilidad.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar";
        $sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$idusuario' AND integrante_morbilidad.idmorbilidad_cf='$row[0]' ";
        $result_c = mysqli_query($link,$sql_c);
        $row_c = mysqli_fetch_array($result_c);
          ...
          <?php echo $row_c[0];?>
              ...
              <td style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">
              <a href="detalle_morbilidad_integrantes_op.php?idusuario=<?php echo $idusuario;?>&idmorbilidad_cf=<?php echo $row[0];?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=600'); return false;">             
              VER INTEGRANTES</a>
              </td>

              <td style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">
              <a href="piramide_morbilidad_op.php?idusuario=<?php echo $idusuario;?>&idmorbilidad_cf=<?php echo $row[0];?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=800,scrollbars=YES,top=60,left=600'); return false;">             
              VER PIRAMIDE</a>
              </td>
	        </tr>
        <?php
...
$(function () {
    $('#grupo_discapacidad').highcharts({
        ...
        title: {
            text: 'GRUPO VI INTEGRANTES CON DISCAPACIDAD POR TIPO Y NIVEL - Médico: <?php echo $operativo;?>'
        },
        subtitle: {
...
while ($field3 = mysqli_fetch_field($result3)){
	...
	?>
        ...
        $sql_a.= " AND integrante_discapacidad.idtipo_discapacidad_cf='$row3[0]' AND integrante_discapacidad.idnivel_discapacidad_cf='$row2[0]' AND carpeta_familiar.idusuario='$idusuario' ";
        $result_a = mysqli_query($link,$sql_a);
        $row_a = mysqli_fetch_array($result_a);
        ?>
        <?php echo $row3[1]; ?>
...
<a href="piramide_discapacidad_op.php?idnivel_discapacidad_cf=<?php echo $row2[0];?>&idtipo_discapacidad_cf=<?php echo $row3[0];?>&idusuario=<?php echo $idusuario;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=650,scrollbars=YES,top=60,left=600'); return false;">ETÁREO</a>
