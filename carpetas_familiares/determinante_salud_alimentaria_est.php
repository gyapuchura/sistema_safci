...
$(function () {
    $('#consumo_alimentos').highcharts({
        ...
        subtitle: {
            text: 'Fuente: REGISTRO SISTEMA MEDI-SAFCI - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?> '
        },
        xAxis: {
            categories: [
...
$(function () {
    $('#consumo_diario_alimentos').highcharts({
        ...
        title: {
            text: 'b) Consumo diario de alimentos - Establecimiento: <?php echo mb_strtoupper($row_est[1]);?>'
        },
        subtitle: {
