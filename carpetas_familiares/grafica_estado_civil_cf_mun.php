        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.idmunicipio='$idmunicipio' GROUP BY integrante_datos_cf.idestado_civil ";
                    ...
                    $sql_c.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND integrante_datos_cf.idestado_civil='$row[0]' ";
...
while ($fielda = mysqli_fetch_field($resulta)){
    ...
    $sql_c.= " AND carpeta_familiar.idmunicipio='$idmunicipio' AND integrante_datos_cf.idestado_civil='$rowa[0]' ";
    $result_c = mysqli_query($link,$sql_c);
    $row_c = mysqli_fetch_array($result_c);
    $conteoa = $row_c[0];
