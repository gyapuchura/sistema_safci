...
$num_estructura_muy_grave = 0;
            ...
            $sql.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idarea_influencia='$idarea_influencia' ";
...
/************ Evaluamos para cada detrminante de la salud  BEGIN ************/
        ...
        $sqla.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idarea_influencia='$idarea_influencia' ";
...
<html>
	<head>
		...
		<title>RIESGO EN ESTRUCTURA DE LA VIVIENDA - ÁREA DE INFLUENCIA</title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO ESTRUCTURAL DE LA VIVIENDA  - ÁREA DE INFLUENCIA: <?php echo mb_strtoupper($area_af);?>'
                },
                subtitle: {
...
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">TOTAL DE CARPETAS FAMILIARES - ÁREA DE INFLUENCIA DE SALUD = <?php echo $total_cf;?> </h4></spam>
...
?>
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">N° DE INTEGRANTES DE FAMILIA REGISTRADOS EN EL ÁREA DE INFLUENCIA DE SALUD= <?php echo $integrantes;?> </h4></spam>
...
?>
<span style="font-family: Arial; font-size: 12px;"><h4 align="center">N° DE PERSONAL SAFCI EN EL ÁREA DE INFLUENCIA DE SALUD = <?php echo $personal;?> </h4></spam>
	</body>
</html>
