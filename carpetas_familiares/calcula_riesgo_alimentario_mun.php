...
$sqld.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idmunicipio='$idmunicipio' ";
...
$sqlcon.= " AND ubicacion_cf.ubicacion_actual='SI' AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idmunicipio='$idmunicipio' ";
...
<html>
	<head>
		...
		<title>RIESGO DE LA SALUD ALIMENTARIA - MUNICIPIO</title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO DE LA SALUD ALIMENTARIA  - Mun. <?php echo mb_strtoupper($row_mun[1]);?>'
                },
                subtitle: {
