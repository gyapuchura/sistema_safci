...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <a href="funcionalidad_familiar_cf.php"><h6 class="text-info"><- VOLVER</h6></a>
                    <hr>             
                    <h4 class="text-info">CARPETA FAMILIAR:</h4>
                    <h4 class="text-primary"><?php echo $row_cf[1]; ?></h4>
                    <h4 class="text-info">17.- RESULTADO DE LA EVALUACIÓN DE LA SALUD FAMILIAR</h4>
                    <hr> 
                    </div>
...
<!------- DATOS DEL AREA DE INFLUENCIA ---------->
                        ...
                        <table class="table table-striped" id="example" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-info">RESULTADO DE LA EVALUACIÓN DE LA SALUD FAMILIAR:</th>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <form name="BORRAR" action="elimina_evaluacion_resultado_cf.php" method="post">  
                                        <input type="hidden" name="idevaluacion_salud_familiar_cf" value="<?php echo $row5[0];?>">
        ...
        <form name="GUARDA_RESULTADO" action="guarda_resultado_salud_cf.php" method="post"> 
        ...
        /** RIESGO DE LA SALUD ALIMENTARIA */
            ...
            /**RIESGO DE LAS DETERMINANTES DE LA SALUD */
                ...
                ?>
                <input type="hidden" name="evaluacion_salud_familiar_cf[1]" value="<?php echo $row5[0]." EN LAS DETERMINANTES DE LA SALUD ";?>">
                <?php
            } else {
                if ($riesgo_total <= 60) {
                    ...
                    ?>
                    <input type="hidden" name="evaluacion_salud_familiar_cf[1]" value="<?php echo $row6[0]." EN LAS DETERMINANTES DE LA SALUD ";?>">
                    <?php
                } else {
                    if ($riesgo_total <= 88) {
                            ...
                            ?>
                            <input type="hidden" name="evaluacion_salud_familiar_cf[1]" value="<?php echo $row7[0]." EN LAS DETERMINANTES DE LA SALUD ";?>">
                            <?php
                    } else {
                        if ($riesgo_total <= 121) {
                                ...
                                ?>
                                <input type="hidden" name="evaluacion_salud_familiar_cf[1]" value="<?php echo $row8[0]." EN LAS DETERMINANTES DE LA SALUD ";?>">
                                <?php
                        } else { 
                            if ($riesgo_total <= 165) {
                                    ...
                                    ?>
                                    <input type="hidden" name="evaluacion_salud_familiar_cf[1]" value="<?php echo $row9[0]." EN LAS DETERMINANTES DE LA SALUD ";?>">
                                    <?php
                            } else {  } } } } }                              
            ?>
            ...
            <?php
                ...
                if ($row_s = mysqli_fetch_array($result_s)) {
                   echo "CON PROBLEMAS EN LA SALUD DE LOS INTEGRANTES DE LA FAMILIA ";
                   ?>
                   <input type="hidden" name="evaluacion_salud_familiar_cf[2]" value="CON PROBLEMAS EN LA SALUD DE LOS INTEGRANTES DE LA FAMILIA">
                   <?php
                } else {
                    ...
                    if ($row_t = mysqli_fetch_array($result_t)) {
                     ...
                     <?php            
                            ...
                            if ($row_u = mysqli_fetch_array($result_u)) {
                                ...
                                $result_u = mysqli_query($link,$sql_u);      
                                if ($row_u = mysqli_fetch_array($result_u)) {
                                    echo "SIN PROBLEMAS EN LA SALUD DE LOS INTEGRANTES DE LA FAMILIA "; 
                                    ?>
                                    <input type="hidden" name="evaluacion_salud_familiar_cf[2]" value="SIN PROBLEMAS EN LA SALUD DE LOS INTEGRANTES DE LA FAMILIA">
                                    <?php
                                } else {                                    
                                } } } }
            ?>
            ...
            <?php
                ...
                if ($row_ev = mysqli_fetch_array($result_ev)){
                    ...
                    ?>
                    <input type="hidden" name="evaluacion_salud_familiar_cf[3]" value="DISFUNCIONAL FAMILIAR">
                    <?php
                        ...
                        if ($row_dev = mysqli_fetch_array($result_dev)){
                            ...
                            ?>
                            <input type="hidden" name="evaluacion_salud_familiar_cf[3]" value="FUNCIONALIDAD FAMILIAR">
                            <?php
                        } else {
            ...
            <input type="date"  class="form-control" name="fecha_registro" value="<?php echo $fecha;?>">
            </div>
            ...
            <span class="text">REGISTRAR COMPORTAMIENTO</span>    
            </button> 
            </div>  
    </div>
    </form>
