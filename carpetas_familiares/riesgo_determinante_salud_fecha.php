...
$sql_a.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion'  ";
...
$sql_b.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion'  ";
...
$sql_c.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion'  ";
...
$sql_d.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion'  ";
...
$sql_e.=" AND carpeta_familiar.estado='CONSOLIDADO' AND carpeta_familiar.fecha_registro BETWEEN '$inicio' AND '$finalizacion'  ";
...
<html>
	<head>
		...
		<title>EVALUACION RIESGO EN LAS DETERMINANTES DE LA SALUD - NACIONAL </title>
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            $('#container').highcharts({
                ...
                title: {
                    text: 'RIESGO EN LAS DETERMINANTES DE LA SALUD - NIVEL NACIONAL'
                },
                subtitle: {
