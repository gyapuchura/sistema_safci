...
<html>
	<head>
		...
		<title>ESTRUCTURA VIVIENDA</title>
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT iditem_determinante_salud FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='9' GROUP BY iditem_determinante_salud ";
                    $result = mysqli_query($link,$sql);
                    $conteo_tipo = mysqli_num_rows($result);
                    ...
                    $sql_c= " SELECT count(iddeterminante_salud_cf) FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='9' AND iditem_determinante_salud='$row[0]' ";
                    $result_c = mysqli_query($link,$sql_c);
                    $row_c = mysqli_fetch_array($result_c);
                    $conteo = $row_c[0];
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT iditem_determinante_salud FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='10' GROUP BY iditem_determinante_salud ";
                    $result = mysqli_query($link,$sql);
                    $conteo_tipo = mysqli_num_rows($result);
                    ...
                    $sql_c= " SELECT count(iddeterminante_salud_cf) FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='10' AND iditem_determinante_salud='$row[0]' ";
                    $result_c = mysqli_query($link,$sql_c);
                    $row_c = mysqli_fetch_array($result_c);
                    $conteo = $row_c[0];
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT iditem_determinante_salud FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='11' GROUP BY iditem_determinante_salud ";
                    $result = mysqli_query($link,$sql);
                    $conteo_tipo = mysqli_num_rows($result);
                    ...
                    $sql_c= " SELECT count(iddeterminante_salud_cf) FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='11' AND iditem_determinante_salud='$row[0]' ";
                    $result_c = mysqli_query($link,$sql_c);
                    $row_c = mysqli_fetch_array($result_c);
                    $conteo = $row_c[0];
...
$(function () {
    $('#revoque_paredes').highcharts({
        ...
        title: {
            text: 'e). REVOQUE DE LAS PAREDES INTERIORES'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT iditem_determinante_salud FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='12' GROUP BY iditem_determinante_salud ";
                    $result = mysqli_query($link,$sql);
                    $conteo_tipo = mysqli_num_rows($result);
                    ...
                    $sql_c= " SELECT count(iddeterminante_salud_cf) FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='12' AND iditem_determinante_salud='$row[0]' ";
                    $result_c = mysqli_query($link,$sql_c);
                    $row_c = mysqli_fetch_array($result_c);
                    $conteo = $row_c[0];
...
$(function () {
    $('#cuarto_cocina').highcharts({
        ...
        title: {
            text: 'f) TIENE CUARTO SOLO PARA COCINAR'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $numero = 0;
                    $sql = " SELECT iditem_determinante_salud FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='13' GROUP BY iditem_determinante_salud ";
                    $result = mysqli_query($link,$sql);
                    $conteo_tipo = mysqli_num_rows($result);
                    ...
                    $sql_c= " SELECT count(iddeterminante_salud_cf) FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='13' AND iditem_determinante_salud='$row[0]' ";
                    $result_c = mysqli_query($link,$sql_c);
                    $row_c = mysqli_fetch_array($result_c);
                    $conteo = $row_c[0];
...
$(function () {
    $('#riesgos_externos').highcharts({
        ...
        title: {
            text: 'g) RIESGOS EXTERNOS CON RELACIÓN A LA VIVIENDA'
        },
        subtitle: {
...
?>
        ...
        series: [
            ...
            <?php 
$numero2 = 0;
$sql2 = " SELECT valor_cf FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='14' GROUP BY valor_cf ";
...
<?php
$sql_a =" SELECT count(valor_cf) FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='14' AND iditem_determinante_salud='$row3[0]' AND valor_cf='$row2[0]' ";
...
?>
        ...
        series: [
            ...
            <?php 
$numero2 = 0;
$sql2 = " SELECT valor_cf FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='15' GROUP BY valor_cf ";
$result2 = mysqli_query($link,$sql2);
$total2 = mysqli_num_rows($result2);
 if ($row2 = mysqli_fetch_array($result2)){
mysqli_field_seek($result2,0);
...
<?php
$sql_a =" SELECT count(valor_cf) FROM determinante_salud_cf WHERE iddeterminante_salud='2' AND idcat_determinante_salud='15' AND iditem_determinante_salud='$row3[0]' AND valor_cf='$row2[0]' ";
$result_a = mysqli_query($link,$sql_a);
$row_a = mysqli_fetch_array($result_a);
?>
<?php echo $row_a[0]; ?>
