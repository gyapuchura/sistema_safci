...
<html>
	<head>
		...
		<title>PROGRAMAS SOCIALES SALUD FAMILIAR - RED DE SALUD</title>
...
$(function () {
    $('#corresponde_salud').highcharts({
        ...
        title: {
            text: 'BENEFICIARIOS DE PROGRAMAS SOCIALES - Red de Salud: <?php echo mb_strtoupper($row_red[1]);?>'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql.= " AND carpeta_familiar.estado='CONSOLIDADO' AND ubicacion_cf.idred_salud='$idred_salud' GROUP BY integrante_beneficiario.idprograma_social ";
