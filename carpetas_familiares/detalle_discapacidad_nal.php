...
<head>
  ...
  <title>DETALLE DE INTEGRANTES CON DISCAPACIDAD - NIVEL NACIONAL</title>
</head>
	<body>
  <h3 style="font-family: Arial; text-align: center;">DISCAPACIDAD <?php echo mb_strtoupper($tipo_dis);?></h3>
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;"><?php echo mb_strtoupper($nivel);?></h3>
	...
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" FROM carpeta_familiar, integrante_cf, nombre, integrante_discapacidad WHERE integrante_discapacidad.idintegrante_cf=integrante_cf.idintegrante_cf ";
            $sql.=" AND integrante_cf.idnombre=nombre.idnombre ";
            $sql.=" AND integrante_cf.idcarpeta_familiar=carpeta_familiar.idcarpeta_familiar ";
            $sql.=" AND integrante_discapacidad.idnivel_discapacidad_cf='$idnivel_discapacidad_cf' AND integrante_discapacidad.idtipo_discapacidad_cf='$idtipo_discapacidad_cf'";
