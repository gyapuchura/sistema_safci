...
/*********** Guarda el registro de grupo de salud (BEGIN) *************/
    ...
    $sql0 = " INSERT INTO integrante_morbilidad (idcarpeta_familiar, idintegrante_cf, idmorbilidad_cf, otra_enfermedad, fecha_registro, hora_registro, idusuario) ";
    $sql0.= " VALUES ('$idcarpeta_familiar_ss','$idintegrante_cf_ss','$idmorbilidad_cf','$otra_enfermedad','$fecha','$hora','$idusuario_ss') ";
