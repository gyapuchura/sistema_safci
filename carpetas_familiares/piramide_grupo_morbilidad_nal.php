...
<html>
	<head>
		...
		<title>PIRÁMIDE GRUPO DE MORBILIDAD - NACIONAL</title>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'PIRÁMIDE GRUPO III - MORBILIDAD - NACIONAL'
            },
            subtitle: {
            ...
            series: [{
                ...
                data: [
                    ...
                    <?php
                    $sql7 = " SELECT count(integrante_cf.idintegrante_cf) FROM integrante_morbilidad, integrante_cf, nombre  ";
                    $sql7.= " WHERE integrante_cf.idnombre=nombre.idnombre AND integrante_morbilidad.idintegrante_cf=integrante_cf.idintegrante_cf ";
