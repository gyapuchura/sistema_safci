...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VIGILANCIA NACIONAL: <?php echo mb_strtoupper($row_sos[1]);?> - GESTIÓN <?php echo $gestion;?>'
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
<h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">DEPARTAMENTOS CON SOSPECHAS DE <?php echo mb_strtoupper($row_sos[1]);?></h2>
    ...
    ?>
		    <tr>
              ...
              <a href="marco_ep_departamental_gestion.php?sospecha_diag_deptal=<?php echo $idsospecha_diag_nal;?>&departamento_ep=<?php echo $row[0];?>&gestion=<?php echo $gestion?>" target="_blank" class="Estilo12" style="font-size: 12px; font-family: Arial;" onClick="window.open(this.href, this.target, 'width=1000,height=700,scrollbars=YES,top=60,left=400'); return false;">REPORTE</a>
              </td>
		      <td style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">
              <a href="piramide_sospechas_deptal_gestion.php?sospecha_diag_deptal=<?php echo $idsospecha_diag_nal;?>&departamento_ep=<?php echo $row[0];?>&gestion=<?php echo $gestion?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1000,height=400,scrollbars=YES,top=50,left=300'); return false;">             
              GRUPOS</a> 
              </td>
