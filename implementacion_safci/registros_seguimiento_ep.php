...
<?php
        $cantidad=0;
        $sql3 ="  SELECT ficha_ep.idficha_ep, ficha_ep.codigo, municipios.municipio, establecimiento_salud.establecimiento_salud FROM ficha_ep, registro_enfermedad, notificacion_ep, establecimiento_salud, red_salud, municipios, nombre ";
