...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'SOSPECHAS <?php echo $row_sos[1];?> - Municipio: <?php echo $row_m[1];?> '
            },
            subtitle: {
...
<div id="pantalla-carga">
    ...
    <div class="texto-loader">Procesando REPORTE EPIDEMIOLÓGICO, por favor espere...</div>
</div>
<?php
