...
$idsospecha_diag_nal = $_POST["sospecha_diag_nal"];
...
?>
        <div class="form-group row">
            <div class="col-sm-12">
                <h4 class="text-primary">SOSPECHA DIAGNÓSTICA: <?php echo mb_strtoupper($row_sos[1]);?></h4>
            </div>
        </div>

        <div class="form-group row">
            <div class="col-sm-3">
            <a class="btn btn-primary btn-icon-split" href="marco_ep_nacional_gestion.php?sospecha_diag_nal=<?php echo $idsospecha_diag_nal;?>&gestion=<?php echo $gestion_ss;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1000,height=650,scrollbars=YES,top=50,left=300'); return false;">
            <span class="icon text-white-50">
                <i class="fas fa-book"></i>
            </span>
            <span class="text">REPORTE NACIONAL - GESTIÓN <?php echo $gestion_ss;?></span></a>
            </div>
            ...
            <div class="col-sm-3">                
            <a class="btn btn-info btn-icon-split" href="piramide_sospechas_nal_gestion.php?sospecha_diag_nal=<?php echo $idsospecha_diag_nal;?>&gestion=<?php echo $gestion_ss;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=900,height=400,scrollbars=YES,top=50,left=300'); return false;">
            <span class="icon text-white-50">
                <i class="fas fa-book"></i>
            </span>
