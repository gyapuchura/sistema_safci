...
<head>
    ...
    <title>SAFCI REPORTE EVENTOS DE NOTIFICACION INMEDIATA DEPARTAMENTAL</title>
...
<h2><?php echo $row1[1];?> - <?php echo $row_dep[1];?></h2>
<a href="http://"></a>
<div id="mi_mapa" style="width: 100%; height: 500px;"></div>
		<h2 style="text-align: center; font-family: Arial; font-size: 14px; color: #2D56CF;">REGISTRO DE EVENTOS DE NOTIFICACIÓN SOBRE: <?php echo mb_strtoupper($row1[1]);?> - <?php echo $row_dep[1];?></h2>
...
<script>
    ...
    L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
        ...
        $sql2.= " AND notificacion_ep.estado='CONSOLIDADO' AND registro_evento_notificacion.idevento_notificacion ='$idevento_notificacion' AND notificacion_ep.iddepartamento='$iddepartamento' GROUP BY notificacion_ep.idestablecimiento_salud ";
