...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'VIGILANCIA: <?php echo mb_strtoupper($row_sos[1]);?> - <?php echo mb_strtoupper($row_d[1]);?>'
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
$sql7.= " AND registro_enfermedad.gestion='$gestion' AND notificacion_ep.iddepartamento='$iddepartamento_ep'";
