...
<a href="cuadro_ep_municipal.php?sospecha_diag_deptal=<?php echo $idsospecha_diag_deptal;?>&departamento_ep=<?php echo $iddepartamento_ep;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=600,scrollbars=YES,top=60,left=400'); return false;">             
MOSTRAR CUADRO MUNICIPIOS</a></h2>
