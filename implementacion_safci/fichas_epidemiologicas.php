        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">FICHAS EPIDEMIOLÓGICAS SAFCI</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secundary">DEPARTAMENTO: <?php echo $row[2];?></h6>
                            <h6 class="m-0 font-weight-bold text-secundary">RED: <?php echo $row[3];?></h6>
                            ...
                            <h4 class="m-0 font-weight-bold text-primary"><?php echo $row_sos[1];?></h4>
                        </div>
                        <div class="card-body">
