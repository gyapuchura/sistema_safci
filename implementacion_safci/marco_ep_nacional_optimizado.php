...
<?php
$sql7 = " SELECT count(seguimiento_ep.idseguimiento_ep) FROM seguimiento_ep, semana_ep ";
$sql7.= " WHERE seguimiento_ep.idsemana_ep=semana_ep.idsemana_ep AND seguimiento_ep.idestado_paciente='2' ";
$sql7.= " AND seguimiento_ep.idsospecha_diag='$idsospecha_diag_nal' AND semana_ep.semana_ep='$row[0]' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_fetch_array($result7);
$recuperados = $row7[0];
?>
...
<div id="container" style="min-width: 300px; height: 350px; margin: 0 auto"></div>
    ...
    ?>
		    <tr>
              ...
              <a href="marco_ep_departamental.php?sospecha_diag_deptal=<?php echo $idsospecha_diag_nal;?>&departamento_ep=<?php echo $row[0];?>" target="_blank" class="Estilo12" style="font-size: 12px; font-family: Arial;" onClick="window.open(this.href, this.target, 'width=1000,height=600,scrollbars=YES,top=60,left=400'); return false;">REPORTE</a>
              </td>
		      <td style="font-size: 12px; color: #2D56CF; font-family: Arial; text-align: center;">
