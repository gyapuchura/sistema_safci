...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'PORCENTAJE REGISTRO F302A - NIVEL NACIONAL'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND  ";
                    ...
                    $sql.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag ";
                    ...
                    $sql_c.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag ";
...
$sql_ta.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND  ";
...
$sqla.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag ";
...
$sql_ca.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag ";
