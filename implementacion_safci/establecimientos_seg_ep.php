...
$sql2.= " AND notificacion_ep.estado='CONSOLIDADO' AND establecimiento_salud.idmunicipio='$idmunicipio' GROUP BY establecimiento_salud.idestablecimiento_salud ORDER BY establecimiento_salud.establecimiento_salud ";
