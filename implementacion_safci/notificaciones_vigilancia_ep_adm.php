...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card-body">
                    ...
                    <div class="card-body" id="notificaciones_ep_depto_salud">                    
                    </div>
                </div>
    ...
    <script language="javascript">
        ...
        $("#iddepartamento").change(function () {
                    ...
                    $.post("notificaciones_ep_depto_salud.php", {departamento:departamento}, function(data){
                    $("#notificaciones_ep_depto_salud").html(data);
                    });
                });
        })
        });
