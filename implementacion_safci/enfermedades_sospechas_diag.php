...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'SOSPECHAS DIAGNÓSTICAS - NIVEL NACIONAL'
        },
        tooltip: {
...
$sql_ta.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='1' AND  ";
...
$sqla.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='1' ";
...
$sql_ca.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='1' ";
