...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>                     
                    <h4 class="text-danger">NO SE PUEDE DESCONSOLIDAR LA NOTIFICACIÓN </h4>
                    <h4 class="text-danger">POR QUE YA FUERON GENERADAS</h4>
                    <h4 class="text-danger">LAS FICHAS EPIDEMIOLÓGICAS !!!</h4>
                    </br>
                    <a href="notificaciones_vigilancia_ep_mun.php"><h6>VOLVER</h6></a>
