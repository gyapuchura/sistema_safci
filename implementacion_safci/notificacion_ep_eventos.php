...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <h5 class="text-info">REGISTRO DE EVENTOS DE NOTIFICACIÓN INMEDIATA</h5>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="example" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $sql4.=" registro_evento_notificacion.numero_eventos, registro_evento_notificacion.personas_afectadas, registro_evento_notificacion.personas_fallecidas ";
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" name="cifra" value="<?php echo $row4[2];?>"></td>
                            <td><input type="number" class="form-control" name="cifra" value="<?php echo $row4[3];?>"></td>
                            <td><input type="number" class="form-control" name="cifra" value="<?php echo $row4[4];?>"></td>
                            <td>
