      ...
      <td colspan="3"><table width="1200" border="1" cellspacing="0">
        <tbody>
          <tr>
            ...
            <td width="150" style="font-family: Arial; font-size: 12px; font-style: normal; text-align: center;">MUNICIPIO</td>
            ...
            <td width="100" style="font-family: Arial; font-size: 12px; text-align: center;">MÉDICO</td>
          </tr>
          <?php
                $numero=1;
