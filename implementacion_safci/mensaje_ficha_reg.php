...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>                     
                    <h4 class="text-success">LA FICHA EPIDEMIOLÓGICA</h4>
                    <h4 class="text-success">PARA ESTA NOTIFICACIÓN</h4>
                    <h4 class="text-success">FUE ACTUALIZADA CORRECTAMENTE !!!</h4>
                    </br>
                    <a href="fichas_epidemiologicas.php"><h6>IR A FICHAS EPIDEMIOLÓGICAS</h6></a>
