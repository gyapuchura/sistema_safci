...
$sql = " SELECT ficha_ep.idficha_ep, ficha_ep.codigo, nombre.ci, nombre.nombre, nombre.paterno, nombre.materno, nombre.fecha_nac, ficha_ep.celular, ficha_ep.direccion, ficha_ep.latitud, ficha_ep.longitud, ficha_ep.idnombre ";
        ...
        <form name="INFLUENCIA" action="guarda_ficha_ep_mod.php" method="post">  
                ...
                <div class="form-group row">                               
                    ...
                    <h6 class="text-primary">NOMBRES:</h6>
                        ...
                        value="<?php echo $row[3];?>" name="nombre" >                
                    </div>
                    <div class="col-sm-3">
                    <h6 class="text-primary">PRIMER APELLIDO:</h6>
                        <input type="text" class="form-control" 
                        value="<?php echo $row[4];?>" name="paterno" >                
                    </div>
                    <div class="col-sm-3">
                    <h6 class="text-primary">SEGUNDO APELLIDO:</h6>
                        <input type="text" class="form-control" 
                        value="<?php echo $row[5];?>" name="materno" >                
                    </div>
                </div>
                ...
                <div class="form-group row">  
                    ...
                    <h6 class="text-primary">FECHA DE NACIMIENTO:</h6>
                        <input type="date"  class="form-control" 
                            placeholder="ingresar fecha" name="fecha_nac" value="<?php echo $row[6];?>"required>
                    </div>      
                    <div class="col-sm-4">
                    <h6 class="text-primary">TELEFONO/CELULAR:</h6>
                        <input type="text" class="form-control" 
                        value="<?php echo $row[7];?>" name="celular" >                
                    </div>                           
                    <div class="col-sm-4">
                    <h6 class="text-primary">DIRECCIÓN ACTUAL:</h6>
                    <textarea class="form-control" rows="2" name="direccion" ><?php echo $row[8]?></textarea>
                    </div>
                </div>                
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="NUMBER" name="latitud" class="form-control" id="LAT" value="<?php echo $row[9];?>" min="-9.662687" max="-22.908152" title="Debe ingresar latitud correspondiente a Bolivia" readonly required>
                    </div>
                    <div class="col-sm-6">
                        <h6 class="text-primary">LONGITUD</h6>
                        <input type="number" name="longitud" class="form-control" id="LONGI" value="<?php echo $row[10];?>" min="-57.452675" max="-69.626293" title="Debe ingresar Longitud correspondiente a Bolivia" readonly required>
