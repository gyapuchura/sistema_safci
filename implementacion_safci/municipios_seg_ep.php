...
$sql2.= " AND notificacion_ep.estado='CONSOLIDADO' AND municipios.iddepartamento='$iddepartamento' GROUP BY municipios.idmunicipio ORDER BY municipios.municipio ";
