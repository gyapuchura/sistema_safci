...
header("Content-Disposition: attachment; filename=REPORTE_FICHAS_EP_SAFCI.xls");
...
<table width="1200" border="0" align="center">
  <tbody>
    <tr>
      <td colspan="3"><p style="text-align: center; font-family: Arial; font-size: 16px;"><?php echo $row_sos[1];?></p>
      <p style="text-align: center; font-family: Arial; font-size: 16px;"><strong style="font-family: Arial; font-size: 16px; text-align: right;">REPORTE - SEGUIMIENTO A FICHAS EPIDEMIOLÓGICAS</strong></p>
      <p style="text-align: center; font-family: Arial; font-size: 16px;"><span style="font-family: Arial; font-size: 14px;">DEPARTAMENTO: <?php echo $row0[1];?></span></p></td>
    </tr>
    <tr>
      <td width="313" style="font-family: Arial; font-size: 12px;">&nbsp;</td>
      <td width="595" style="font-family: Arial; font-size: 12px;">&nbsp;</td>
      <td width="278" style="font-size: 12px; font-family: Arial;">Fecha: 
      <?php 
