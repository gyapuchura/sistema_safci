...
$sql_dep = " SELECT establecimiento_salud.idestablecimiento_salud, establecimiento_salud.latitud, establecimiento_salud.longitud, ";
$sql_dep.= " departamento.departamento FROM establecimiento_salud, departamento WHERE establecimiento_salud.iddepartamento=departamento.iddepartamento ";
$sql_dep.= " AND establecimiento_salud.latitud != '' AND establecimiento_salud.longitud != '' AND establecimiento_salud.iddepartamento='$iddepartamento' LIMIT 1 ";
$result_dep = mysqli_query($link,$sql_dep);
$row_dep = mysqli_fetch_array($result_dep);

$latitud_c  = $row_dep[1];
$longitud_c = $row_dep[2];
$zoom_c     = "7";
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <title>SAFCI REPORTE EVENTOS DE NOTIFICACION INMEDIATA NIVEL DEPARTAMENTAL</title>
...
<h2>EVENTOS DE NOTIFICACIÓN INMEDIATA - <?php echo $row_dep[3];?></h2>
<a href="http://"></a>
...
<script>
    ...
    L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
        ...
        $sql2.= " AND notificacion_ep.estado='CONSOLIDADO' AND notificacion_ep.iddepartamento='$iddepartamento' GROUP BY notificacion_ep.idestablecimiento_salud ";
