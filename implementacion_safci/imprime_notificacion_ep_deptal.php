...
$sql =" SELECT departanmento.departanmento,  FROM notificacion_ep, departamento WHERE iddepartamento='$iddepartamento_ep' ";
$sql.="  ";
$sql.="  ";
$sql.="  ";
      ...
      <td colspan="3"><table width="1188" border="1" cellspacing="0">
        <tbody>
          ...
          <?php
            ...
            $sql7.=" registro_enfermedad.idsospecha_diag = '$idsospecha_diag_deptal' GROUP BY registro_enfermedad.idsospecha_diag ";
