...
$sql_e = " SELECT idmunicipio, municipio FROM municipios WHERE idmunicipio='$idmunicipio' ";
...
$(function () {
    $('#container_perfil').highcharts({
        ...
        title: {
            text: 'VIGILANCIA: <?php echo mb_strtoupper($row_sos[1]);?> - MUNICIPIO : <?php echo mb_strtoupper($row_e[1]);?>'
        },
        legend: {
            layout: 'vertical',
            align: 'left',
...
$sql.= " AND registro_enfermedad.idsospecha_diag='$idsospecha_diag_estab' AND notificacion_ep.idmunicipio='$idmunicipio' AND notificacion_ep.gestion ='$gestion'  ";
...
$sql_r.= " AND notificacion_ep.estado='CONSOLIDADO' AND seguimiento_ep.idsospecha_diag='$idsospecha_diag_estab' AND notificacion_ep.idmunicipio='$idmunicipio' ";
...
$sql7.= " AND seguimiento_ep.idsospecha_diag='$idsospecha_diag_estab' AND seguimiento_ep.idsemana_ep='$row[0]' AND notificacion_ep.idmunicipio='$idmunicipio' ";
$result7 = mysqli_query($link,$sql7);
$row7 = mysqli_fetch_array($result7);
$recuperados = $row7[0];
?>
...
$(function () {
    ...
    $(document).ready(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'GRUPOS ETÁREOS <?php echo $row_sos[1];?> - MUNICIPIO : <?php echo $row_e[1];?> '
            },
            subtitle: {
