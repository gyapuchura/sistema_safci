...
$gestion_ss     = $_GET['gestion'];
$idcat_registro = $_GET['idcat_registro'];

$sql_cat    = " SELECT idcat_registro, cat_registro FROM cat_registro WHERE idcat_registro ='$idcat_registro' ";
...
<html>
	<head>
		...
		<title>REGISTRO ENFERMEDADES - NIVEL NACIONAL</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: '<?php echo $row_cat[1];?> - NIVEL NACIONAL - GESTIÓN <?php echo $gestion_ss;?>'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='$idcat_registro' AND  ";
                    $sql0.= " registro_enfermedad.cifra !='0' AND registro_enfermedad.gestion='$gestion_ss' AND notificacion_ep.estado='CONSOLIDADO' ";
                    ...
                    $sql.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='$idcat_registro' ";
                    $sql.= " AND notificacion_ep.estado='CONSOLIDADO' AND  registro_enfermedad.cifra !='0' ";
                    $sql.= " AND registro_enfermedad.gestion='$gestion_ss' GROUP BY registro_enfermedad.idsospecha_diag ";
                    ...
                    $sql_c.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='$idcat_registro' ";
                    $sql_c.= " AND registro_enfermedad.cifra !='0' AND registro_enfermedad.idsospecha_diag='$row[0]'  ";
                    $sql_c.= " AND registro_enfermedad.gestion='$gestion_ss' AND notificacion_ep.estado='CONSOLIDADO' ";
...
$sql_ta.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='$idcat_registro' AND  ";
$sql_ta.= " registro_enfermedad.cifra !='0' AND registro_enfermedad.gestion='$gestion_ss' AND notificacion_ep.estado='CONSOLIDADO' ";
...
$sqla.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='$idcat_registro' ";
$sqla.= " AND notificacion_ep.estado='CONSOLIDADO' AND  registro_enfermedad.cifra !='0' ";
$sqla.= " AND registro_enfermedad.gestion='$gestion_ss' GROUP BY registro_enfermedad.idsospecha_diag ";
...
$sql_ca.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='$idcat_registro' ";
$sql_ca.= " AND registro_enfermedad.cifra !='0' AND registro_enfermedad.idsospecha_diag='$rowa[0]'  ";
$sql_ca.= " AND registro_enfermedad.gestion='$gestion_ss' AND notificacion_ep.estado='CONSOLIDADO' ";
...
?>
        <tr>
          ...
          <a class="btn btn-primary btn-icon-split" href="marco_ep_nacional_gestion.php?sospecha_diag_nal=<?php echo $rowa[0];?>&gestion=<?php echo $gestion_ss;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1000,height=650,scrollbars=YES,top=50,left=300'); return false;">
        REPORTE NACIONAL</a>
        </td>
        </tr>   
        <?php
