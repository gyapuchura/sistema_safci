...
$sql1.= " departamento.departamento FROM notificacion_ep, registro_enfermedad, establecimiento_salud, departamento  ";
$sql1.= " WHERE registro_enfermedad.idnotificacion_ep=notificacion_ep.idnotificacion_ep AND notificacion_ep.iddepartamento=departamento.iddepartamento ";
$sql1.= " AND notificacion_ep.idestablecimiento_salud=establecimiento_salud.idestablecimiento_salud AND notificacion_ep.estado='CONSOLIDADO' ";
$sql1.= " AND registro_enfermedad.cifra != '0' AND establecimiento_salud.latitud != '' AND establecimiento_salud.longitud != '' ";
$sql1.= " AND registro_enfermedad.idsospecha_diag='$idsospecha_diag' AND notificacion_ep.iddepartamento='$iddepartamento' LIMIT 1 ";
...
<body>
    <div class="sala"><h3 class="text-center">DEPARTAMENTO: <?php echo $row_d[1];?> - SOSPECHA: <?php echo $row_sos[1];?></h3></div>  
...
$sql2.= " AND registro_enfermedad.idsospecha_diag='$idsospecha_diag' AND notificacion_ep.iddepartamento='$iddepartamento' GROUP BY notificacion_ep.idmunicipio ";
