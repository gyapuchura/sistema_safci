...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'INFECCIONES DE TRANSMISIÓN SEXUAL - NIVEL NACIONAL'
        },
        tooltip: {
        ...
        series: [{
            ...
            data: [
                <?php
                    ...
                    $sql0.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='3' AND  ";
                    ...
                    $sql.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='3' ";
                    ...
                    $sql_c.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='3' ";
...
$sql_ta.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='3' AND  ";
...
$sqla.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='3' ";
...
$sql_ca.= " registro_enfermedad.idsospecha_diag=sospecha_diag.idsospecha_diag AND sospecha_diag.idcat_registro='3' ";
