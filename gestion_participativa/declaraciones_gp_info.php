        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">INFORMACIÓN MUNICIPAL GESTIÓN PARTICIPATIVA - SAFCI</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        $sql.=" AND gestion_participativa.idusuario=usuarios.idusuario AND usuarios.idnombre=nombre.idnombre AND gestion_participativa.idmunicipio='$row_e[1]' ORDER BY gestion_participativa.idgestion_participativa ";
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td> 
                                                <a href="formulario_gestion_participativa.php?idgestion_participativa=<?php echo $row[0];?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1280,height=800,top=50, left=200, scrollbars=YES'); return false;">
                                                <?php echo $row[1];?></a> </td>
                                            ...
                                            <td>
                                                <form name="FORM_GP" action="valida_declaracion_gp_info.php" method="post">
