...
$idgestion_participativa = $_GET['idgestion_participativa'];
...
$sql_gp.=" AND gestion_participativa.idvigencia_convenio=vigencia_convenio.idvigencia_convenio AND  gestion_participativa.idgestion_participativa='$idgestion_participativa'  ";
