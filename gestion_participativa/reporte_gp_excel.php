...
header("Content-Disposition: attachment; filename=REPORTE GESTION PARTICIPATIVA.xls");
...
<head>
    ...
    <title>REPORTE GESTION PARTICIPATIVA</title>
</head>
<body>
    
<h4 style="font-family: Arial; font-size: 16px; color: #2D56CF; text-align: center;">DECLARACIONES GESTIÓN PARTICIPATIVA</h4>
