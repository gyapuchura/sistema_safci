        ...
        xAxis: {
            categories: [
                ...
                <?php 
                    ...
                    $sql.= " AND tratamiento.idevento_safci='$idevento_safci_ss' AND tratamiento.entregado_farmacia='SI' GROUP BY tratamiento.idmedicamento, medicamento.medicamento ";
...
$sql2.= " AND tratamiento.idevento_safci='$idevento_safci_ss' AND tratamiento.entregado_farmacia='SI' GROUP BY tratamiento.idtipo_medicamento ";
...
<?php 
$numero3 = 0;
$sql3 = " SELECT idmedicamento FROM tratamiento WHERE idevento_safci='$idevento_safci_ss' AND entregado_farmacia='SI' GROUP BY idmedicamento ";
...
<?php
$sql_a =" SELECT count(idmedicamento) FROM tratamiento WHERE idevento_safci='$idevento_safci_ss' AND idtipo_medicamento='$row2[0]' AND idmedicamento='$row3[0]' ";
...
<div id="container" style="min-width: 310px; max-width: 850px; height: <?php echo $numero2*400;?>px; margin: 0 auto"></div>
