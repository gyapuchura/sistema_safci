...
<html>
	<head>
		...
		<title>MEDICAMENTOS POR EVENTO SAFCI</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'TRATAMIENTOS EMITIDOS - EVENTO <?php echo $row_ev[4];?>'
        },
        subtitle: {
        ...
        xAxis: {
            categories: [
                ...
                <?php 
                    ...
                    $sql.= " AND tratamiento.idevento_safci='$idevento_safci_ss' AND tratamiento.entregado_farmacia='SI' GROUP BY tratamiento.idtipo_medicamento ";
...
$sql2.= " AND tratamiento.idevento_safci='$idevento_safci_ss' AND tratamiento.entregado_farmacia='SI' GROUP BY tratamiento.idmedicamento, medicamento.medicamento ";
...
$sql3.= " AND tratamiento.idevento_safci='$idevento_safci_ss' AND tratamiento.entregado_farmacia='SI' GROUP BY tratamiento.idtipo_medicamento ";
...
<?php
$sql_a =" SELECT count(idmedicamento) FROM tratamiento WHERE idevento_safci='$idevento_safci_ss' AND idtipo_medicamento='$row3[0]' AND idmedicamento='$row2[0]'";
...
<div id="container" style="min-width: 310px; max-width: 850px; height: <?php echo $numero3*250;?>px; margin: 0 auto"></div>
