...
header("Content-Disposition: attachment; filename=REPORTE_ATENCIONES_SAFCI.xls");
...
<table width="1200" border="0" align="center">
  <tbody>
    <tr>
      <td><p style="font-family: Arial; font-size: 16px; text-align: center;">EVENTO: <?php echo $row_ev[4];?> </p>
      <p><span style="text-align: center"><strong style="font-family: Arial; font-size: 18px;"></strong></span><strong style="font-family: Arial; font-size: 18px;">PLANILLA DE ATENCION MEDICA - TRIAGE Y OTROS</strong></p></td>
    </tr>
    <tr>
      <td style="font-family: Arial; font-size: 12px;">Municipio: <?php echo $row_ev[2];?>   Establecimiento de Salud: <?php echo $row_ev[3];?>Fecha: 
      <?php 
    ...
    <tr>
      <td><table width="1200" border="1" cellspacing="0">
        <tbody>
          <tr>
      ...
      <td><table width="328" border="0">
        <tbody> 
          <tr>
            ...
            <td width="69" style="font-family: Arial; font-size: 14px; text-align: center;"><strong>F</strong></td>
          </tr>
          <tr>
            <td style="font-family: Arial; font-size: 12px; text-align: right;"><strong>TOTAL ATENCIONES</strong></td>
