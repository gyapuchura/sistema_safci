...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'DIAGNOSTICOS EMITIDOS SISTEMA MEDI-SAFCI'
        },
        subtitle: {
...
$sql.= " GROUP BY diagnostico_atencion.idpatologia ";
...
data: [
    ...
    <?php 
$numero3 = 0;
$sql3 = " SELECT idpatologia FROM diagnostico_atencion GROUP BY idpatologia ";
...
$sql4 =" SELECT count(iddiagnostico_atencion) FROM diagnostico_atencion WHERE idpatologia='$row3[0]' ";
