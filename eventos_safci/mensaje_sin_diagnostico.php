...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>                     
                    <h4 class="text-danger">USTED NO EMITIÓ NINGÚN DIAGNÓSTICO  </h4>
                    <h4 class="text-danger">PARA LA ESPECIALIDAD MÉDICA !!</h4>
                    </br>
                    <a href="consulta_especialidad_paciente.php"><h6>VOLVER</h6></a>
