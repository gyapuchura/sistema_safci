...
<head>
    ...
    <title>SISTEMA_MEDI_SAFCI</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Ingreso a Sistema</h1>
                                    </div>
                                    <form class="user" method="post" action="validacion.php" >
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Recordarme el password</label>
                                            </div>
                                        </div>
