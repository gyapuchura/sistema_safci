...
$sql.= " AND registro_enfermedad.idsospecha_diag='$idsospecha_diag' AND notificacion_ep.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY notificacion_ep.fecha_registro ORDER BY notificacion_ep.fecha_registro ";
...
$sql7.= " AND notificacion_ep.idestablecimiento_salud='$idestablecimiento_salud' AND registro_enfermedad.gestion='$gestion' AND notificacion_ep.fecha_registro='$row[0]' ";
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql2.= " AND usuarios.idnombre=nombre.idnombre AND notificacion_ep.idestablecimiento_salud='$idestablecimiento_salud' AND registro_enfermedad.idsospecha_diag='$idsospecha_diag' GROUP BY notificacion_ep.idnotificacion_ep DESC ";
