...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'CONCURRENCIA DEL <?php echo $f_emision;?> SISTEMA MEDI-SAFCI'
        },
        legend: {
            layout: 'vertical',
            align: 'left',
 ...
 <?php
$numero = 0;
$sql = " SELECT fecha_hora FROM log_login WHERE fecha = '$fecha' GROUP BY fecha_hora ORDER BY fecha_hora ";
...
<?php
$sql7 = " SELECT idlog_login, fecha_hora FROM log_login WHERE fecha_hora='$row[0]'";
