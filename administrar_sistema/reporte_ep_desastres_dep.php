        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    $sql.=" AND notificacion_ep.iddepartamento='$iddepartamento' GROUP BY registro_evento_notificacion.idevento_notificacion ORDER BY registro_evento_notificacion.idevento_notificacion  ";
                              ...
                              <div class="card-body">
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                         ...
                                         <a href="../implementacion_safci/marco_eventos_sala_dep.php?idevento_notificacion=<?php echo $row[0];?>&iddepartamento=<?php echo $iddepartamento;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=900,height=800,scrollbars=YES,top=50,left=300'); return false;">
                                         ...
                                         <?php echo $row[1];?>
                                          ...
                                          <?php 
                                            ...
                                            $sql_c.="  AND registro_evento_notificacion.idevento_notificacion='$row[0]' AND notificacion_ep.iddepartamento='$iddepartamento' AND registro_evento_notificacion.gestion='$gestion' AND notificacion_ep.estado='CONSOLIDADO'  ";
