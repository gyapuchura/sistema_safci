...
$sql.= " AND registro_enfermedad.idnotificacion_ep=notificacion_ep.idnotificacion_ep AND notificacion_ep.semana_ep='$semana_ep' AND registro_enfermedad.gestion='$gestion' AND registro_enfermedad.cifra !='0' ";
