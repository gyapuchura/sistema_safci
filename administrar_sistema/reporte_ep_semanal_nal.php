...
<head>
    ...
    <title>REPORTE EPIDEMIOLOGICO NACIONAL - SAFCI</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    <!-- Page Heading -->
                    <h3 class="text-primary">REPORTE EPIDEMIOLÓGICO HASTA LA SEMANA Nº <?php echo $semana_ep;?></h3>
                    <h6 class="text-primary">NIVEL NACIONAL</h6>
                <div class="row">
                  </br>
                </div>
                          ...
                          <div class="card border-left-primary shadow h-100 py-2">
                              <div class="card-body">
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                         ...
                                         <?php echo $row[1];?>
                                          ...
                                          <?php 
                                            ...
                                            $sql_c.=" AND registro_enfermedad.idsospecha_diag='$row[0]' AND registro_enfermedad.gestion='$gestion' AND notificacion_ep.estado='CONSOLIDADO' ";
                                      ...
                                      <div class="col-auto">
                                      <a href="../administrar_sistema/notificaciones_ep_semana_nal.php?idsospecha_diag=<?php echo $row[0];?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1100,height=900,scrollbars=YES'); return false;">
