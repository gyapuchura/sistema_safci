        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    $sql.=" AND notificacion_ep.idestablecimiento_salud='$idestablecimiento_salud' GROUP BY registro_evento_notificacion.idevento_notificacion ORDER BY registro_evento_notificacion.idevento_notificacion  ";
                                      ...
                                      <div class="col mr-2">
                                         ...
                                         <?php echo $row[1];?>
                                          ...
                                          <?php 
                                            ...
                                            $sql_c.="  AND registro_evento_notificacion.idevento_notificacion='$row[0]' AND notificacion_ep.idestablecimiento_salud='$idestablecimiento_salud' AND registro_evento_notificacion.gestion='$gestion' AND notificacion_ep.estado='CONSOLIDADO'  ";
