...
$sql.= " AND registro_enfermedad.idsospecha_diag='$idsospecha_diag' AND notificacion_ep.idmunicipio='$idmunicipio' GROUP BY notificacion_ep.fecha_registro ORDER BY notificacion_ep.fecha_registro ";
...
$sql7.= " AND notificacion_ep.idmunicipio='$idmunicipio' AND registro_enfermedad.gestion='$gestion' AND notificacion_ep.fecha_registro='$row[0]' ";
