...
<head>
    ...
    <title>REPORTE EPIDEMIOLOGICO SEMANAL DEPARTAMENTO - SAFCI</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    <h4 class="text-primary">DEPARTAMENTO : <?php echo $row_dep[1];?></h4>
                <div class="row">
                  </br>
                </div>
                    ...
                    $sql.=" AND registro_enfermedad.cifra !='0' AND notificacion_ep.iddepartamento='$iddepartamento' GROUP BY sospecha_diag.sospecha_diag ORDER BY registro_enfermedad.idsospecha_diag ";
                              ...
                              <div class="card-body">
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                         ...
                                         <a href="../implementacion_safci/marco_ep_departamento_sala.php?idsospecha_diag_estab=<?php echo $row[0];?>&iddepartamento=<?php echo $iddepartamento;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=900,height=800,scrollbars=YES,top=50,left=300'); return false;">
                                         ...
                                         <?php echo $row[1];?>
                                          ...
                                          <?php 
                                            ...
                                            $sql_c.=" AND registro_enfermedad.idsospecha_diag='$row[0]' AND notificacion_ep.iddepartamento='$iddepartamento' AND registro_enfermedad.gestion='$gestion'  AND notificacion_ep.estado='CONSOLIDADO' ";
