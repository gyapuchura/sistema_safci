...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">INSCRITOS BONO JUANA AZURDUY </h1>
                    <p class="mb-4">En esta seccion se puede encontrar los registros de BENEIFICARIOS DEL BONO JUANA AZURDUY.</p>

                    <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">INSCRITOS POR MUNICIPIO</h6>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-body" id="inscritos_bono_ja">                    
                    </div>
                </div>
    ...
    <script language="javascript">
        ...
        $("#iddepartamento").change(function () {
                    ...
                    $.post("municipio_bono.php", {departamento:departamento}, function(data){
...
<!------- inscritos_bono_ja.php ----->
    <script language="javascript">
        $(document).ready(function(){
        $("#idmunicipio_salud").change(function () {
                    $("#idmunicipio_salud option:selected").each(function () {
                        municipio_salud=$(this).val();
                    $.post("inscritos_bono_mun.php", {municipio_salud:municipio_salud}, function(data){
                    $("#inscritos_bono_ja").html(data);
                    });
                });
        })
        });
