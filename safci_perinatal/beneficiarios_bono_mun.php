...
<div class="table-responsive">
        ...
        $sql.=" FROM integrante_beneficiario, integrante_cf, nombre, carpeta_familiar, parentesco, establecimiento_salud,  tipo_area_influencia, area_influencia ";
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <h6 class="text-info"><?php echo $row[5];?></h6></a> 
                </td>
                ...
                <td>
                <form name="FORM_RED" action="valida_benficiario_bono.php" method="post">
