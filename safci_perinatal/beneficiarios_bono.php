...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">BENEFICIARIOS BONO JUANA AZURDUY </h1>
                    <p class="mb-4">En esta seccion se puede encontrar los registros de BENEIFICARIOS DEL BONO JUANA AZURDUY.</p>

                    <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">BENEFICIARIOS POR MUNICIPIO</h6>
                    </div>
    ...
    <script language="javascript">
        ...
        $("#iddepartamento").change(function () {
                    ...
                    $.post("../recursos_humanos/municipio_salud_area.php", {departamento:departamento}, function(data){
...
<!------- areas_influencia_mun_salud.php ----->
    <script language="javascript">
        $(document).ready(function(){
        $("#idmunicipio_salud").change(function () {
                    $("#idmunicipio_salud option:selected").each(function () {
                        municipio_salud=$(this).val();
                    $.post("beneficiarios_bono_mun.php", {municipio_salud:municipio_salud}, function(data){
