...
$sql.= " AND cie LIKE '%Z%' AND referencia_hc.idmunicipio = '$idmunicipio' AND diagnostico_egreso.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY diagnostico_egreso.idpatologia  ";
...
$sql3.= " AND cie LIKE '%Z%' AND referencia_hc.idmunicipio = '$idmunicipio' AND diagnostico_egreso.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY diagnostico_egreso.idpatologia  ";
