...
<style>
    ...
    .spinner-loader {
        ...
        border-top: 6px solid #2b908f; /* Turquesa corporativo de referencias */
        border-radius: 50%;
...
<div id="pantalla-carga">
    ...
    <div class="texto-loader">Procesando DIAGNÓSTICOS DE EGRESO A LA CONTRARREFERENCIA, por favor espere...</div>
</div>
...
<h4 align="center" style="font-family: Arial;">DIAGNÓSTICOS  MUNICIPIO : <?php echo mb_strtoupper($row_mun[1]);?> = 
                ...
                $sql_dgto.= "  AND referencia_hc.idmunicipio='$idmunicipio' AND diagnostico_egreso.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<table width="1400" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="50" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">CIE</span></td>
            ...
            $sql_est.= " AND diagnostico_egreso.idpatologia=patologia.idpatologia   ";
