...
<html>
	<head>
		...
		<title>MEDI-APS REFERENCIAS - PATOLOGIA</title>
        ...
        title: {
            text: '<?php echo $row_pat[1];?> - <?php echo $row_pat[2];?> - Municipio : <?php echo $row_mun[1];?>'
        },
        subtitle: {
...
$sql.= " AND diagnostico_presuntivo.idpatologia='$idpatologia' AND referencia_hc.idmunicipio='$idmunicipio' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY referencia_hc.fecha_registro ORDER BY referencia_hc.fecha_registro ";
...
$sql7.= " AND diagnostico_presuntivo.idpatologia='$idpatologia' AND referencia_hc.idmunicipio='$idmunicipio' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<div align="center">
<!-- <form action="reporte_diagnosticos_preventivos_excel_mun.php" method="post">
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" especialidad_medica.especialidad_medica,referencia_hc.fecha_registro, referencia_hc.hora_registro, referencia_hc.idusuario  ";
    $sql.=" FROM referencia_hc, nombre, estado_referencia, especialidad_medica, departamento, municipios, establecimiento_salud, diagnostico_presuntivo ";
    $sql.=" WHERE referencia_hc.idnombre=nombre.idnombre AND diagnostico_presuntivo.idreferencia_hc=referencia_hc.idreferencia_hc ";
    ...
    $sql.=" AND referencia_hc.idespecialidad_medica=especialidad_medica.idespecialidad_medica AND diagnostico_presuntivo.idpatologia='$idpatologia' AND referencia_hc.idmunicipio='$idmunicipio' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ORDER BY referencia_hc.idreferencia_hc DESC ";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
