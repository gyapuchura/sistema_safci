...
/*********** se llenan otras tablas con relacion al CONTROL PERINATAL ***********/
    ...
    if ($idgenero == '1' && $edad > '14') {
            ...
            /****** SI YA HAY HISTORIA PERINATAL SOLO ACTUALIZAMOS TABLAS QUE CORRESPONDAN  *******/
            ...
            /********* INSERTAMOS/REGISTRAMOS LA HISTORIA PERINATAL Y LAS DEMAS TABLAS *******/
                ...
                $sql_2.= " VALUES ('$idhistoria_perinatal','$idnombre_integrante_ss','','','3','$fecha_fum','', '','$fecha_pp', ";
                $sql_2.= " '','','','','','2','','','','','$fecha','$hora','$idusuario_ss') ";
