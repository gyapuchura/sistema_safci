...
<html>
    <head>
        ...
        <title>REPORTE DIAGNOSTICOS PRESUNTIVOS - REFERENCIA</title>
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'REPORTE DIAGNÓSTICOS PRESUNTIVOS PARA REFERENCIA - <?php echo $row_dep[1];?>'
        },
        subtitle: {
...
$sql.= "  AND referencia_hc.iddepartamento = '$iddepartamento' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
?>
        ...
        series: [
{
name: 'DIAGNÓSTICOS PRESUNTIVOS PARA REFERENCIA ',
data: [
...
$sql3.= "  AND referencia_hc.iddepartamento = '$iddepartamento' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<div id="pantalla-carga">
    ...
    <div class="texto-loader">Procesando DIAGNÓSTICOS PRESUNTIVOS DE REFERENCIA, por favor espere...</div>
</div>
...
<h4 align="center" style="font-family: Arial;">DIAGNÓSTICOS PRESUNTIVOS PARA REFERENCIA - DEPARTAMENTO : <?php echo $row_dep[1];?> = 
                <?php
                ...
                $sql_dgto.= " AND referencia_hc.iddepartamento='$iddepartamento' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<table width="1400" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="50" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">CIE</span></td>
            <?php
            $sql_m = " SELECT referencia_hc.idmunicipio, municipios.municipio FROM referencia_hc, municipios, diagnostico_presuntivo, patologia ";
            $sql_m.= " WHERE referencia_hc.idmunicipio=municipios.idmunicipio AND diagnostico_presuntivo.idreferencia_hc=referencia_hc.idreferencia_hc ";
            $sql_m.= " AND diagnostico_presuntivo.idpatologia=patologia.idpatologia  ";
            $sql_m.= " AND referencia_hc.iddepartamento='$iddepartamento' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY referencia_hc.idmunicipio ORDER BY municipios.municipio ";
            ...
            while ($field_m = mysqli_fetch_field($result_m)){
                ...
                <a href="reporte_referencias_mun_fechas.php?idmunicipio=<?php echo $row_m[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1420,height=820,scrollbars=YES,top=50,left=200'); return false;"><?php echo $row_m[1];?></a>
                </span></td>
            <?php                  
           ...
           ?>
            ...
            while ($field_m = mysqli_fetch_field($result_m)){
                ...
                $sql_dg = " SELECT count(diagnostico_presuntivo.iddiagnostico_presuntivo) FROM diagnostico_presuntivo, referencia_hc ";
                $sql_dg.= " WHERE diagnostico_presuntivo.idreferencia_hc=referencia_hc.idreferencia_hc AND referencia_hc.idmunicipio='$row_m[0]' ";
                $sql_dg.= " AND diagnostico_presuntivo.idpatologia = '$row[0]' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
                ...
                ?>
                    ...
                    <a href="patologias_diario_mun_ref_fechas.php?idpatologia=<?php echo $row[0];?>&idmunicipio=<?php echo $row_m[0];?>&inicio=<?php echo $inicio;?>&finalizacion=<?php echo $finalizacion;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1420,height=820,scrollbars=YES,top=50,left=200'); return false;">
                        <?php 
                        if ($diagnosticos == '0') {
            ...
            <td bgcolor="#FFFFFF" align="center" style="font-family: Arial; font-size: 12px;">
                <?php
                $sql_dgt = " SELECT count(diagnostico_presuntivo.iddiagnostico_presuntivo) FROM diagnostico_presuntivo, referencia_hc ";
                $sql_dgt.= " WHERE diagnostico_presuntivo.idreferencia_hc=referencia_hc.idreferencia_hc AND referencia_hc.iddepartamento='$iddepartamento' ";
                $sql_dgt.= " AND diagnostico_presuntivo.idpatologia = '$row[0]' AND diagnostico_presuntivo.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
