...
<html>
	<head>
		...
		<title>REPORTE DIAGNOSTICOS PRESUNTIVOS</title>
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'DIAGNÓSTICOS PRESUNTIVOS PARA REFERENCIA - MUNICIPIO : <?php echo mb_strtoupper($row_mun[1]);?>'
        },
        subtitle: {
...
?>
        ...
        yAxis: {
            min: 0,
            title: {
                text: ' DIAGNÓSTICOS PARA REFERENCIA ',
                align: 'high'
            },
            labels: {
                overflow: 'justify'
...
<table width="1400" border="1" align="center" bordercolor="#009999">
    <tr>
        ...
        <td width="400" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">DIAGNÓSTICOS PARA REFERENCIA</span></td>
        <td width="50" bgcolor="#FFFFFF" style="font-family: Arial; font-size: 12px;"><span class="Estilo8 Estilo1 Estilo2">CIE</span></td>
           ...
           ?>
            ...
            while ($field_est = mysqli_fetch_field($result_est)){
                ...
                $sql_dg.= " WHERE diagnostico_presuntivo.idreferencia_hc=referencia_hc.idreferencia_hc AND referencia_hc.idestablecimiento_salud='$row_est[0]' ";
            ...
            <td bgcolor="#FFFFFF" align="center" style="font-family: Arial; font-size: 12px;">
                ...
                $sql_dgt.= " WHERE diagnostico_presuntivo.idreferencia_hc=referencia_hc.idreferencia_hc AND referencia_hc.idmunicipio='$idmunicipio' ";
