        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">ENTRADA DE REFERENCIAS </h1>
                    <p class="mb-4">En esta sección se puede encontrar la bandeja de REFERENCIAS POR ADMITIR en el Establecimiento de Salud.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">REFERENCIAS POR ADMITIR</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $sql.=" AND referencia_hc.idespecialidad_medica=especialidad_medica.idespecialidad_medica AND deriva_referencia_hc.idestablecimiento_salud_o=establecimiento_salud.idestablecimiento_salud ";
                                ...
                                $sql.=" AND deriva_referencia_hc.idestablecimiento_salud_r='$idestablecimiento_salud' AND deriva_referencia_hc.referido='SI' AND deriva_referencia_hc.admitido='NO' ORDER BY deriva_referencia_hc.idderiva_referencia_hc DESC ";
                                ...
                                ?>
                                        ...
                                        <td>
                                        <form name="ATENCION-PSAFCI" action="valida_deriva_referencia.php" method="post">
