...
$sql_int    = " SELECT fecha_nac, idgenero FROM nombre WHERE idnombre ='$idnombre_paciente_ss' ";
...
$codigo = "MSYD/APS-REF-".$correlativo."/".$gestion;
    ...
    $sql0.= " VALUES ('$iddepartamento','$idred_salud','$idmunicipio','$idestablecimiento_salud_ss','$idatencion_psafci_ss','$correlativo','$codigo','$idnombre_paciente_ss',";
    $sql0.= " '$discapacidad','$nombre_acompanante','$idparentesco_acomp','$celular_acompanante','$tel_establecimiento','$estuvo_internado','$dias_internacion','$resumen_anamnesis','$especificacion_hallazgos','$tratamiento_ref',";
    ...
    $_SESSION['idestablecimiento_salud_r_ss'] = $idestablecimiento_salud_r;
        ...
        $result_dr = mysqli_query($link,$sql_dr);   
            ...
            $sql_sg.= " VALUES ('$idatencion_psafci_ss','$idnombre_paciente_ss','$edad','$frec_cardiaca','$peso','$talla','$frec_respiratoria','$presion_arterial','$presion_arterial_d','$temperatura','$saturacion','$imc','$glascow','$alergia','$descripcion_alergia','$fecha','$hora','$idusuario_ss') ";
            ...
            $sql_f.= " VALUES ('$idreferencia_hc','$idnombre_paciente_ss','$idexamen_complementario_i','$fecha','$hora','$idusuario_ss') ";
    ...
    foreach($_POST['diagnostico_presuntivo'] as $clave => $diagnostico_presuntivo_i) {
            ...
            $sql_dg.= " VALUES ('$idreferencia_hc','$idnombre_paciente_ss','$diagnostico_presuntivo_i','$idpatologia[$clave]','$fecha','$hora','$idusuario_ss') ";
...
/*********** se llenan otras tablas con relacion al CONTROL PERINATAL ***********/
    ...
    if ($discapacidad == 'SI') {
            ...
            $sql_dis.= " VALUES ('$idreferencia_hc','$idnombre_paciente_ss','$idtipo_discapacidad','$idnivel_discapacidad','$fecha','$hora','$idusuario_ss') ";
...
header("Location:mensaje_referencia_nhc.php");
