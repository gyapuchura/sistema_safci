        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">CONTRARREFERENCIAS DEL ESTABLECIMIENTO DE SALUD </h1>
                    <p class="mb-4">En esta sección se puede encontrar el registro de CONTRARREFERENCIAS REALIZADAS en el Establecimiento de Salud.</p>
