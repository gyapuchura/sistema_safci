            ...
            <div class="container">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                            ...
                            <h6 class="text-info"><a onclick="history.back();"><- VOLVER</a></h6>
                            <hr>  
                        <div class="text-center">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">  
                                    ...
                                    <div class="col-sm-6">
                                    <h6 class="text-primary">DESCRIPCIÓN DE LA ALÉRGIA</h6>
                                    <textarea class="form-control" rows="3" name="descripcion_alergia" id="descripcion_alergia" disabled></textarea>
                                    <button type="button" class="btn-mic" onclick="iniciarDictado('descripcion_alergia')"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3z"/><path d="M17 11c0 2.76-2.24 5-5 5s-5-2.24-5-5H5c0 3.53 2.61 6.43 6 6.92V21h2v-3.08c3.39-.49 6-3.39 6-6.92h-2z"/></svg></button>                            
                                    </div>
                                </div>
...
<!-------------- ANTECDENTES OBSTETRICOS - END --------------->
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group row">                               
                                    ...
                                    <textarea class="form-control" rows="3" name="resumen_anamnesis" disabled><?php echo $row_ref[15];?></textarea>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">  
                                    ...
                                    <textarea class="form-control" rows="3" name="especificacion_hallazgos"  disabled><?php echo $row_ref[16];?></textarea>
                        ...
                        <?php } ?>
                        <?php 
                        $archivo_contra_mostrar = "";
                        $sql_adj_con_mostrar = "SELECT file_contra_ref FROM referencia_hc WHERE idreferencia_hc = '$idreferencia_hc_ss'";
                        $res_adj_con_mostrar = mysqli_query($link, $sql_adj_con_mostrar);
                        if ($res_adj_con_mostrar && mysqli_num_rows($res_adj_con_mostrar) > 0) {
                            $row_adj_con_mostrar = mysqli_fetch_assoc($res_adj_con_mostrar);
                            $archivo_contra_mostrar = $row_adj_con_mostrar['file_contra_ref'];
                        }
                        
                        // Solo mostramos el banner azul si existe un archivo de contrarreferencia guardado físicamente
                        if (!empty($archivo_contra_mostrar) && file_exists("../files_ref/" . $archivo_contra_mostrar)) { 
                        ?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                <i class="fas fa-file-medical"></i> ADJUNTOS DE LA CONTRARREFERENCIA
                                            </div>
                                            <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                El personal de salud que valoró el caso adjuntó documentos.
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <button class="btn btn-sm btn-outline-info shadow-sm mr-2" type="button" data-toggle="collapse" data-target="#visorContraMostrar" aria-expanded="false" aria-controls="visorContraMostrar">
                                                <i class="fas fa-eye"></i> VER / OCULTAR
                                            </button>
                                            <a href="../files_ref/<?php echo $archivo_contra_mostrar; ?>" target="_blank" class="btn btn-sm btn-info shadow-sm">
                                                <i class="fas fa-expand-arrows-alt"></i> PANTALLA COMPLETA
                                            </a>
                                        </div>
                                    </div>
                                    <div class="collapse mt-3" id="visorContraMostrar">
                                        <div class="embed-responsive" style="height: 500px; border: 1px solid #d1d3e2; border-radius: 8px; overflow: hidden; background-color: #eaecf4;">
                                            <iframe src="../files_ref/<?php echo $archivo_contra_mostrar; ?>" style="width: 100%; height: 100%; border: none;" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
