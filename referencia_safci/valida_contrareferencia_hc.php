...
$idderiva_referencia_hc  = $_POST['idderiva_referencia_hc'];
...
$_SESSION['idderiva_referencia_hc_ss']  = $idderiva_referencia_hc;
...
header("Location:formulario_contrareferencia_hc.php");    
