...
<html>
	<head>
		...
		<title>MEDI-APS CONTRARREFERENCIA - PATOLOGIA</title>
...
$sql.= " AND diagnostico_egreso.idpatologia='$idpatologia' AND referencia_hc.idmunicipio='$idmunicipio' AND diagnostico_egreso.fecha_registro BETWEEN '$inicio' AND '$finalizacion' GROUP BY referencia_hc.fecha_registro ORDER BY referencia_hc.fecha_registro ";
...
?>
        ...
        yAxis: {
            title: {
                text: 'CONTRARREFERENCIA DIARIAS'
            }
        },
        tooltip: {
            shared: true,
...
$sql7.= " AND diagnostico_egreso.idpatologia='$idpatologia' AND referencia_hc.idmunicipio='$idmunicipio' AND diagnostico_egreso.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ";
...
<table width="1000" border="1" align="center" cellspacing="0">
    ...
    $sql.=" FROM referencia_hc, nombre, estado_referencia, especialidad_medica, departamento, municipios, establecimiento_salud, diagnostico_egreso ";
    $sql.=" WHERE referencia_hc.idnombre=nombre.idnombre AND diagnostico_egreso.idreferencia_hc=referencia_hc.idreferencia_hc ";
    ...
    $sql.=" AND referencia_hc.idespecialidad_medica=especialidad_medica.idespecialidad_medica AND diagnostico_egreso.idpatologia='$idpatologia' AND referencia_hc.idmunicipio='$idmunicipio' AND diagnostico_egreso.fecha_registro BETWEEN '$inicio' AND '$finalizacion' ORDER BY referencia_hc.idreferencia_hc DESC ";
    $result = mysqli_query($link,$sql);
    if ($row = mysqli_fetch_array($result)){
    mysqli_field_seek($result,0);           
    while ($field = mysqli_fetch_field($result)){
