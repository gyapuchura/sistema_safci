...
?>
        <div class="form-group row">
            <div class="col-sm-6">
            <a class="btn btn-primary btn-icon-split" href="detalle_personal_departamento.php?iddepartamento_rep=<?php echo $iddepartamento_rep;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1600,height=700,scrollbars=YES,top=50,left=200'); return false;">
