...
<div class="form-group row">
                                ...
                                <hr>
                            <form name="FORMREG" action="guarda_personal_safci_mun.php" method="post">  
                                <div class="form-group row">
       ...
       <!-- Begin datos laborales -->
                ...
                <div class="form-group row">
                    ...
                    <select name="iddepartamento"  id="iddepartamento" class="form-control" required>
                        <option value="">-SELECCIONE-</option>
                        <?php
                        $sql1 = "SELECT iddepartamento, departamento FROM departamento WHERE iddepartamento = '$iddepartamento'";
                        $result1 = mysqli_query($link,$sql1);
                        if ($row1 = mysqli_fetch_array($result1)){
                        mysqli_field_seek($result1,0);
                        while ($field1 = mysqli_fetch_field($result1)){
