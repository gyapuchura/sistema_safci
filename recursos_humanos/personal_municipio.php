...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">RECURSOS HUMANOS SAFCI - MUNICIPIO</h1>
                    <p class="mb-4">En esta seccion se puede encontrar el registro de Recursos Humanos por MUNICIPIO del PROGRAMA NACIONAL SAFCI - MI SALUD.</p>

                    <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">PERSONAL SAFCI POR MUNICIPIO</h6>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card-body" id="personal_municipio_salud">                    
                    </div>
                </div>
    ...
    <script language="javascript">
        ...
        $("#idmunicipio_salud").change(function () {
                    ...
                    $.post("tabla_personal_municipio.php", {municipio_salud:municipio_salud}, function(data){
                    $("#personal_municipio_salud").html(data);
                    });
                });
        })
        });
