	...
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" AND nombre_datos.idespecialidad_medica=especialidad_medica.idespecialidad_medica AND usuarios.condicion='ACTIVO' AND establecimiento_salud.idmunicipio='$idmunicipio_salud' ORDER BY personal.idpersonal ";
