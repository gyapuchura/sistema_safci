...
<head>
  ...
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">Departamento: <?php echo $rowd[1];?></h3>
	<table width="664" border="1" align="center">
	  <tbody>
        <tr>
        <td width="37" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>N°</strong></td>
            ...
            <td width="300" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>CORREO ELECTRONICO</strong></td>		
            ...
            <td width="82" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>PERFIL</strong></td>
