...
if ($latitud == '' || $longitud == ''  || $iddepartamento_ss == '' ) {
    
    header("Location:mensaje_sin_coordenadas_mun.php");
}  
else {
        ...
        $sql8.= " VALUES ('$iddepartamento_ss','$idred_salud_ss','$idmunicipio_ss','$codigo_establecimiento','$establecimiento_salud','$idtipo_establecimiento','$idnivel_establecimiento', ";
        ...
        header("Location:mostrar_establecimiento_salud_mun.php");
    }
