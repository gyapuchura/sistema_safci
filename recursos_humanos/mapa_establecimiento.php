...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>                     
                    <h4 class="text-primary">UBICACIÓN ESTABLECIMIENTO DE SALUD</h4>
                    <h6><?php echo "PARA LOCALIZAR LA UBICACION DEL ESTABLECIMIENTO DE SALUD EN UNA MAPA"?></h6>
                    </div>
...
<!-- BEGIN aqui va el comntenido de la pagina ---->
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                    <div id="safci" style="width: 660px; height: 250px;">
                    </div>
                    <div class="col-sm-6">
