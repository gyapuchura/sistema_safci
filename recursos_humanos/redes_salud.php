        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">REDES DE SALUD</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">REDES DE SALUD</h6>
                        </div>
                        <div class="card-body">
                        ...
                        <?php
                        $numero=1;
                        $sql =" SELECT red_salud.idred_salud, red_salud.red_salud, departamento.departamento FROM red_salud, departamento ";
                        $sql.=" WHERE red_salud.iddepartamento=departamento.iddepartamento ORDER BY departamento.departamento  ";
