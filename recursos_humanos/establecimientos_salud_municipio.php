        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">ESTABLECIMIENTOS DE SALUD A NIVEL NACIONAL  <?php echo $idmunicipio_ss; ?></h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        $sql.=" AND establecimiento_salud.idred_salud=red_salud.idred_salud AND establecimiento_salud.idmunicipio='$idmunicipio_ss' ORDER BY establecimiento_salud.idestablecimiento_salud ";
