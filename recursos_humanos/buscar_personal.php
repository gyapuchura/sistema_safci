            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h4 class="text-primary">BUSCAR REGISTRO SAFCI</h4>
                        </div>
...
<!-- BEGIN aqui va el comntenido de la pagina ---->
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <h5 class="text-primary">1.- BUSQUEDA DE REGISTRO EN SISTEMA:</h5>                                 
                                </div>
                            </div>
                            <hr>
                            <form name="SEARCH" action="busca_personal_safci.php" method="post">  
