...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                <div class="row">
                    ...
                    <hr>                     
                    <h4 class="text-primary">REPORTES SISTEMA MEDI-SAFCI</h4>
                    </div>
...
<hr> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                    <a href="../carpetas_familiares/carpetas_departamento.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1000,height=800,scrollbars=YES'); return false;">
                    <h6 class="text-info"><i class="far fa-chart-bar"></i>MOSTRAR REPORTE</h6></a>
                    </div>
                </div> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <h6 class="text-primary">8.- CARPETAS FAMILIARES DIARIAS A NIVEL NACIONAL</h6>
                    </div>
                    <div class="col-sm-4">
                    <a href="carpetas_familiares_medi_safci.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1200,height=1000,scrollbars=YES'); return false;">
                    <h6 class="text-info"><i class="far fa-chart-bar"></i>MOSTRAR REPORTE</h6></a>
                    </div>
                </div> 
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <h6 class="text-primary">9.- ATENCIONES MÉDICAS PSAFCI</h6>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-6">
                        <h6 class="text-primary">10.- VISITAS FAMILIARES REALIZADAS DIARIAMENTE</h6>
                    </div>
                    <div class="col-sm-4">
                    <a href="../seguimiento_familiar/visitas_safci_diarias.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1200,height=1000,scrollbars=YES'); return false;">
                    <h6 class="text-info"><i class="far fa-chart-bar"></i>MOSTRAR REPORTE</h6></a>
                    </div>
                </div> 
