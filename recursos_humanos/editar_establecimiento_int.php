...
<!-- BEGIN aqui va el TITULO de la pagina ---->
                ...
                <a href="registro_establecimiento_int.php"><h6 class="text-info"><i class="fas fa-fw fa-arrow-left"></i>VOLVER</h6></a>                   
                    <hr>   
...
<form name="ESTABLECIMIENTO" action="guarda_establecimiento_mod_int.php" method="post">  
                <div class="col-lg-12">  
                    <div class="p-5"> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number"  name="longitud" class="form-control" id="lng" placeholder="Seleccione LONGITUD en el mapa" value="<?php echo $row[12];?>" min="-57.452675" max="-69.626293" title="Debe ingresar Longitud correspondiente a Bolivia" readonly required>
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                    <h6>Arrastre el marcador azul para seleccionar la ubicación del ESTABLECIMIENTO DE SALUD</h6>
                    </div>
                </div> 
                <div class="form-group row">
