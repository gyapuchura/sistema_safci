	...
	<table width="664" border="1" cellspacing="0" align="center">
	  <tbody>
        ...
        <td width="17" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>N°</strong></td>
            ...
            <td width="92" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>CARGO MEMORÁNDUM</strong></td>
            ...
            <td width="51" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>TIPO DE ESTABLECIMIENTO </strong></td>	
            <td width="51" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>ESTABLECIMIENTO DE SALUD</strong></td>	
            <td width="51" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>LATITUD</strong></td>	
            <td width="51" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>LONGITUD</strong></td>	
            ...
            <td width="42" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>FECHA DE REGISTRO</strong></td>
        ...
        <?php 
            ...
            $sql_e.=" WHERE establecimiento_salud.idtipo_establecimiento=tipo_establecimiento.idtipo_establecimiento AND establecimiento_salud.idestablecimiento_salud='$row[12]' ";
            $result_e = mysqli_query($link,$sql_e);
            $row_e = mysqli_fetch_array($result_e);
            echo $row_e[1];?></td>
            <td style="font-family: Arial; font-size: 12px;"><?php echo $row_e[2];?></td>
            <td style="font-family: Arial; font-size: 12px;"><?php echo $row[18];?></td>
            <td style="font-family: Arial; font-size: 12px;"><?php echo $row[19];?></td>
            ...
            <?php 
              ...
              $sqla.=" AND carpeta_familiar.idusuario='$row[20]' AND carpeta_familiar.estado='CONSOLIDADO' GROUP BY carpeta_familiar.idarea_influencia ";
            ...
            <td style="font-family: Arial; font-size: 12px;">
            <?php 
            $sql_cf =" SELECT count(idcarpeta_familiar) FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND idusuario='$row[20]' ";
            ...
            $sql_hf.=" AND carpeta_familiar.estado='CONSOLIDADO' AND integrante_cf.estado='CONSOLIDADO' AND carpeta_familiar.idusuario='$row[20]' ";
            ...
            <td style="font-family: Arial; font-size: 12px;">
          <?php 
              $fecha_r = explode('-',$row[21]);
              $f_registro = $fecha_r[2].'/'.$fecha_r[1].'/'.$fecha_r[0];?>
          <?php echo $f_registro;?>
        </td>
            <td style="font-family: Arial; font-size: 12px;"><?php echo $row[22];?></td>
        </tr>
        <?php
            $numero=$numero+1;  
            }
