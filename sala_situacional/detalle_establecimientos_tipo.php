...
$idtipo_establecimiento = $_GET['idtipo_establecimiento'];

$sqld =" SELECT idtipo_establecimiento, tipo_establecimiento FROM tipo_establecimiento WHERE idtipo_establecimiento='$idtipo_establecimiento' ";
...
<head>
  ...
  <title>ESTABLECIMIENTOS-SUBSECTOR-SALUD</title>
</head>
	<body>
  <h3 style="font-family: Arial; text-align: center;">ESTABLECIMIENTOS DE SALUD</h3>
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">TIPO: <?php echo $rowd[1];?></h3>
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" AND establecimiento_salud.idtipo_establecimiento='$idtipo_establecimiento' ORDER BY establecimiento_salud.idestablecimiento_salud ";
