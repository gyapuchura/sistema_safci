            ...
            <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="card bg-info text-white shadow">
                            <div class="card-body">
                                AVANCE - CARPETAS FAMILIARES DEL MUNICIPIO : <?php echo mb_strtoupper($row_mun[1]);?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            $sql_f.=" AND establecimiento_salud.idmunicipio='$idmunicipio' ";
                            ...
                            $sql_h.=" AND establecimiento_salud.idmunicipio='$idmunicipio' ";
                            ...
                            <div class="col-sm-4">
                            <a class="btn btn-info btn-icon-split" href="../carpetas_familiares/informe_operativo_mun.php?idmunicipio=<?php echo $idmunicipio;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=950,height=900,scrollbars=YES,top=50,left=300'); return false;">
                            <span class="icon text-white-50">
                                <i class="fas fa-book"></i>
                            </span>
                            <span class="text">INFORME SITUACIONAL - MUNICIPIO </span></a>

                            <hr>

                            <a class="btn btn-warning btn-icon-split" href="../carpetas_familiares/municipio_a_cf_sala.php?idmunicipio=<?php echo $idmunicipio;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=950,height=900,scrollbars=YES,top=50,left=300'); return false;">
                            <span class="icon text-white-50">
                                <i class="fas fa-book"></i>
                            </span>
