...
<div id="pantalla-carga">
    ...
    <div class="texto-loader">Procesando SALA SITUACIONAL MUNICIPAL, por favor espere...</div>
</div>
                        ...
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="../implementacion_safci/mapa_desastres_safci_mun.php?idmunicipio=<?php echo $idmunicipio;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=1000,height=850,scrollbars=YES,top=50,left=400'); return false;">
