...
$idsubsector_salud = $_GET['idsubsector_salud'];

$sqld =" SELECT idsubsector_salud, subsector_salud FROM subsector_salud WHERE idsubsector_salud='$idsubsector_salud' ";
...
<head>
  ...
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">SUBSECTOR SALUD: <?php echo $rowd[1];?></h3>
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" AND establecimiento_salud.idsubsector_salud='$idsubsector_salud' ORDER BY establecimiento_salud.idestablecimiento_salud ";
