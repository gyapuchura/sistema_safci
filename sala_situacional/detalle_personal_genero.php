...
$sqlh =" SELECT idgenero, genero FROM genero WHERE idgenero='$idgenero' ";
...
<head>
  ...
  <title>PERSONAL POR GENERO</title>
</head>
	<body>
  <h3 style="font-family: Arial; text-align: center;">PERSONAL DE SALUD - SAFCI MI SALUD</h3>
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">GÉNERO: <?php echo $rowh[1];?></h3>
	...
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" AND nombre_datos.idespecialidad_medica=especialidad_medica.idespecialidad_medica AND nombre_datos.iddepartamento='$iddepartamento' AND nombre.idgenero='$idgenero' ORDER BY personal.idpersonal ";
