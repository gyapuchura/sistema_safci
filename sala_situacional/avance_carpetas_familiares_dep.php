            ...
            <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="card bg-info text-white shadow">
                            <div class="card-body">
                                AVANCE - CARPETAS FAMILIARES DEL DEPARTAMENTO : <?php echo mb_strtoupper($row_mun[1]);?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <?php
                            $sql_f =" SELECT sum(area_influencia.familias) FROM area_influencia, establecimiento_salud WHERE area_influencia.idestablecimiento_salud=establecimiento_salud.idestablecimiento_salud  ";
                            $sql_f.=" AND establecimiento_salud.iddepartamento='$iddepartamento' ";
                            ...
                            <?php
                            $sql_h =" SELECT sum(area_influencia.habitantes) FROM area_influencia, establecimiento_salud WHERE area_influencia.idestablecimiento_salud=establecimiento_salud.idestablecimiento_salud ";   
                            $sql_h.=" AND establecimiento_salud.iddepartamento='$iddepartamento' ";
                            ...
                            <?php
                                $numero = 1;
                                $sql =" SELECT idusuario FROM carpeta_familiar WHERE estado='CONSOLIDADO' AND iddepartamento='$iddepartamento' GROUP BY idusuario ";   
                            ...
                            <div class="col-sm-4">
                            <a class="btn btn-info btn-icon-split" href="../carpetas_familiares/informe_operativo_dep.php?iddepartamento=<?php echo $iddepartamento;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=950,height=900,scrollbars=YES,top=50,left=300'); return false;">
                            <span class="icon text-white-50">
                                <i class="fas fa-book"></i>
                            </span>
                            <span class="text">INFORME SITUACIONAL - DEPARTAMENTO </span></a>

                            <hr>

                            <a class="btn btn-warning btn-icon-split" href="../carpetas_familiares/departamento_a_cf_sala.php?iddepartamento=<?php echo $iddepartamento;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=950,height=900,scrollbars=YES,top=50,left=300'); return false;">
                            <span class="icon text-white-50">
                                <i class="fas fa-book"></i>
                            </span>
