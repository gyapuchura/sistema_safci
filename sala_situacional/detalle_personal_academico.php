...
$idformacion_academica = $_GET['idformacion_academica'];

$sqld =" SELECT idformacion_academica, formacion_academica FROM formacion_academica WHERE idformacion_academica='$idformacion_academica' ";
...
<head>
  ...
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">FORMACIÓN ACADÉMICA: <?php echo $rowd[1];?></h3>
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" AND nombre_datos.idespecialidad_medica=especialidad_medica.idespecialidad_medica AND nombre_datos.idformacion_academica ='$idformacion_academica' ORDER BY personal.idpersonal ";
