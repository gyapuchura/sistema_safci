...
$idespecialidad_medica = $_GET['idespecialidad_medica'];

$sqld =" SELECT idespecialidad_medica, especialidad_medica FROM especialidad_medica WHERE idespecialidad_medica='$idespecialidad_medica' ";
...
<head>
  ...
  <h3 style="font-family: Arial; text-align: center; font-size: 18px;">ESPECIALIDAD MÉDICA: <?php echo $rowd[1];?></h3>
	<table width="664" border="1" align="center">
	  <tbody>
        <tr>
            ...
            <td width="47" style="font-family: Arial; font-size: 12px; text-align: center;"><strong>DEPTO</strong></td>
        ...
        <?php
            ...
            $sql.=" FROM personal, nombre, nacionalidad, genero, nombre_datos, profesion, especialidad_medica, departamento, dato_laboral ";
            ...
            $sql.=" AND personal.idnombre_datos=nombre_datos.idnombre_datos AND nombre_datos.idespecialidad_medica=especialidad_medica.idespecialidad_medica ";
            ...
            $sql.=" AND nombre_datos.idespecialidad_medica ='$idespecialidad_medica' ORDER BY personal.idpersonal ";
