...
<html>
	<head>
		...
		<title>NATALIDAD A NIVEL DEPARTAMENTAL</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'NACIMIENTOS POR GESTIONES - DEPARTAMENTO DE <?php echo $row_dep[1]?>'
        },
        subtitle: {
...
?>
        ...
        yAxis: {
            min: 0,
            title: {
                text: 'NACIMIENTOS EN EL DEPARTAMENTO '
            }
        },
        tooltip: {
            headerFormat: '<span style="font-size:10px">{point.key}</span><table>',
            pointFormat: '<tr><td style="color:{series.color};padding:0">{series.name}: </td>' +
                '<td style="padding:0"><b>{point.y:.1f} NACIDOS </b></td></tr>',
            footerFormat: '</table>',
            shared: true,
            useHTML: true
        },
