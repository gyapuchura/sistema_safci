	...
	<table width="664" border="1" align="center">
	  <tbody>
        ...
        <?php
            ...
            $sql.=" establecimiento_salud.idred_salud=red_salud.idred_salud AND establecimiento_salud.idnivel_establecimiento='$idnivel_establecimiento' AND establecimiento_salud.iddepartamento='$iddepartamento' ";
        ...
        <a href="detalle_personal_eess.php?idestablecimiento_salud=<?php echo $row[0];?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=700,scrollbars=YES,top=50,left=200'); return false;">VER PERSONAL</a>  
