...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">SALA SITUACIONAL DE SALUD - ESTABLECIMIENTO DE SALUD</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">SALA SITUACIONAL EN SALUD A NIVEL DE ESTABLECIMIENTO</h6>
                    </div>
    ...
    <script language="javascript">
        ...
        $("#idmunicipio_salud").change(function () {
                    ...
                    $.post("../carpetas_familiares/establecimientos_cf.php", {municipio_salud:municipio_salud}, function(data){
